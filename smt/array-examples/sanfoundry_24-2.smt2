(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-TLv994/sanfoundry_24-2.pp.ms.o.bc")
...
(rule (=> (and (printEven@_call printEven@arg.0_0)
         ...
         (__VERIFIER_assert true false false printEven@%_call1_0)
...
(rule (let ((a!1 (and (printOdd@_call printOdd@arg.0_0)
                ...
                (__VERIFIER_assert true false false printOdd@%_call1_0)
...
(let ((a!3 (and (main@_bb4 main@%_0_0
                ...
                (=> (and main@__VERIFIER_assert_0 main@precall5_0)
                    (= main@%.0_1 main@%.0_0))
                (=> main@__VERIFIER_assert_0 (= main@%_37_0 (= main@%.0_1 0)))
...
(let ((a!4 (and (main@_bb9 main@%_0_0
                ...
                (=> main@__VERIFIER_assert_0
                    (and main@__VERIFIER_assert_0 main@precall7_0))
                (=> (and main@__VERIFIER_assert_0 main@precall7_0)
                    (= main@%.0_0 main@%_45_0))
                (=> (and main@__VERIFIER_assert_0 main@precall7_0)
                    (= main@%.0_1 main@%.0_0))
