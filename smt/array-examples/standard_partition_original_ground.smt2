(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-VhiByn/standard_partition_original_ground.pp.ms.o.bc")
...
(rule (=> (and (main@_bb @__VERIFIER_nondet_int_0
         ...
         (=> (and main@_bb8_0 main@_bb6_0)
             (= main@%shadow.mem.8.0_0 main@%sm3_0))
...
(rule (=> (and (main@_bb8 main@%_0_0
         ...
         main@_bb14_0)
    (main@_bb14 main@%shadow.mem.4.0_0
                main@%shadow.mem.8.0_0
                main@%.04.i_0
                main@%.02.i_0
                main@%_1_0
...
(let ((a!2 (and (main@_bb14 main@%shadow.mem.4.0_0
  ...
  (=> a!2
      (main@_bb14 main@%shadow.mem.4.0_0
                  ...
                  main@%_2_0
                  main@%.0.i_2)))))
(rule (=> (and (main@_bb14 main@%shadow.mem.4.0_0
                     main@%shadow.mem.8.0_0
                     main@%.04.i_0
                     main@%.02.i_0
                     main@%_1_0
