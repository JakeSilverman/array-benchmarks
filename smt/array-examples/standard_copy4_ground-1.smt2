(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-JAdAvb/standard_copy4_ground-1.pp.ms.o.bc")
...
(declare-rel main@_bb (Int Int Int (Array Int Int) Int Int Int Int (Array Int Int) (Array Int Int) (Array Int Int) (Array Int Int) ))
(declare-rel main@_bb12 (Int (Array Int Int) Int Int (Array Int Int) Int Int Int (Array Int Int) (Array Int Int) (Array Int Int) ))
(declare-rel main@_bb15 (Int (Array Int Int) Int (Array Int Int) Int Int (Array Int Int) Int Int (Array Int Int) (Array Int Int) ))
(declare-rel main@_bb18 (Int (Array Int Int) Int (Array Int Int) Int Int (Array Int Int) Int (Array Int Int) ))
(declare-rel main@_bb21 (Int (Array Int Int) Int (Array Int Int) Int Int (Array Int Int) ))
(declare-rel main@_bb24 (Int (Array Int Int) Int (Array Int Int) Int ))
...
(let ((a!2 (and (main@_bb @__VERIFIER_nondet_int_0
                ...
                (=> (and main@_bb10_0 main@_bb_0) main@%_11_0)
                (=> main@_bb10_0 (= main@%_13_0 @__VERIFIER_nondet_int_0))
                a!1
...
(rule (let ((a!1 (=> main@_bb13_0
               (= main@%_21_0 (+ main@%_0_0 (* 0 400000) (* main@%.02.i_0 4)))))
      (a!2 (=> main@_bb13_0
               (= main@%_23_0 (+ main@%_1_0 (* 0 400000) (* main@%.02.i_0 4))))))
...
(rule (let ((a!1 (=> main@_bb16_0
               (= main@%_29_0 (+ main@%_1_0 (* 0 400000) (* main@%.1.i_0 4)))))
      (a!2 (=> main@_bb16_0
               (= main@%_31_0 (+ main@%_2_0 (* 0 400000) (* main@%.1.i_0 4))))))
...
(rule (=> (and (main@_bb15 main@%_0_0
         ...
         (=> (and main@_bb17_0 main@_bb15_0) (not main@%_27_0))
         (=> main@_bb18_0 (and main@_bb18_0 main@_bb17_0))
         (=> (and main@_bb18_0 main@_bb17_0)
             (= main@%shadow.mem.12.0_0 main@%sm5_0))
         (=> (and main@_bb18_0 main@_bb17_0) (= main@%.2.i_0 0))
         (=> (and main@_bb18_0 main@_bb17_0)
             (= main@%shadow.mem.12.0_1 main@%shadow.mem.12.0_0))
         (=> (and main@_bb18_0 main@_bb17_0) (= main@%.2.i_1 main@%.2.i_0))
         main@_bb18_0)
...
(rule (let ((a!1 (=> main@_bb19_0
               (= main@%_37_0 (+ main@%_2_0 (* 0 400000) (* main@%.2.i_0 4)))))
      (a!2 (=> main@_bb19_0
               (= main@%_39_0 (+ main@%_3_0 (* 0 400000) (* main@%.2.i_0 4))))))
(let ((a!3 (and (main@_bb18 main@%_0_0
                ...
                a!2
                (=> main@_bb19_0 (or (<= main@%_3_0 0) (> main@%_39_0 0)))
                (=> main@_bb19_0 (> main@%_3_0 0))
                (=> main@_bb19_0
                    (= main@%sm3_0
                       (store main@%shadow.mem.12.0_0 main@%_39_0 main@%_38_0)))
                (=> main@_bb19_0 (= main@%_40_0 (+ main@%.2.i_0 1)))
                (=> main@_bb18_1 (and main@_bb18_1 main@_bb19_0))
                (=> (and main@_bb18_1 main@_bb19_0)
                    (= main@%shadow.mem.12.0_1 main@%sm3_0))
                (=> (and main@_bb18_1 main@_bb19_0)
                    (= main@%.2.i_1 main@%_40_0))
                (=> (and main@_bb18_1 main@_bb19_0)
...
(rule (=> (and (main@_bb18 main@%_0_0
         ...
         (=> (and main@_bb20_0 main@_bb18_0) (not main@%_35_0))
         ...
         (=> (and main@_bb21_0 main@_bb20_0) (= main@%.3.i_1 main@%.3.i_0))
         main@_bb21_0)
...
(rule (let ((a!1 (=> main@_bb22_0
               (= main@%_45_0 (+ main@%_3_0 (* 0 400000) (* main@%.3.i_0 4)))))
      (a!2 (=> main@_bb22_0
               (= main@%_47_0 (+ main@%_4_0 (* 0 400000) (* main@%.3.i_0 4))))))
(let ((a!3 (and (main@_bb21 main@%_0_0
                ...
                true
                (= main@%_43_0 (< main@%.3.i_0 100000))
                (=> main@_bb22_0 (and main@_bb22_0 main@_bb21_0))
                (=> (and main@_bb22_0 main@_bb21_0) main@%_43_0)
                a!1
                (=> main@_bb22_0 (or (<= main@%_3_0 0) (> main@%_45_0 0)))
                (=> main@_bb22_0 (> main@%_3_0 0))
                (=> main@_bb22_0
                    (= main@%_46_0 (select main@%shadow.mem.12.0_0 main@%_45_0)))
                a!2
                (=> main@_bb22_0 (or (<= main@%_4_0 0) (> main@%_47_0 0)))
                (=> main@_bb22_0 (> main@%_4_0 0))
                (=> main@_bb22_0
                    (= main@%sm4_0
                       (store main@%shadow.mem.16.0_0 main@%_47_0 main@%_46_0)))
                (=> main@_bb22_0 (= main@%_48_0 (+ main@%.3.i_0 1)))
                (=> main@_bb21_1 (and main@_bb21_1 main@_bb22_0))
                (=> (and main@_bb21_1 main@_bb22_0)
                    (= main@%shadow.mem.16.0_1 main@%sm4_0))
                (=> (and main@_bb21_1 main@_bb22_0)
                    (= main@%.3.i_1 main@%_48_0))
                (=> (and main@_bb21_1 main@_bb22_0)
...
(rule (=> (and (main@_bb21 main@%_0_0
         ...
         (=> (and main@_bb23_0 main@_bb21_0) (not main@%_43_0))
         (=> main@_bb24_0 (and main@_bb24_0 main@_bb23_0))
         (=> (and main@_bb24_0 main@_bb23_0) (= main@%.0.i_0 0))
         (=> (and main@_bb24_0 main@_bb23_0) (= main@%.0.i_1 main@%.0.i_0))
         main@_bb24_0)
...
(rule (let ((a!1 (=> main@_bb25_0
      ...
      (a!2 (=> main@_bb25_0
               (= main@%_55_0 (+ main@%_4_0 (* 0 400000) (* main@%.0.i_0 4))))))
(let ((a!3 (and (main@_bb24 main@%_0_0
                ...
                a!1
                (=> main@_bb25_0 (or (<= main@%_0_0 0) (> main@%_53_0 0)))
                (=> main@_bb25_0 (> main@%_0_0 0))
                (=> main@_bb25_0
                    (= main@%_54_0 (select main@%shadow.mem.0.0_0 main@%_53_0)))
                a!2
                (=> main@_bb25_0 (or (<= main@%_4_0 0) (> main@%_55_0 0)))
                (=> main@_bb25_0 (> main@%_4_0 0))
                (=> main@_bb25_0
                    (= main@%_56_0 (select main@%shadow.mem.16.0_0 main@%_55_0)))
                (=> main@_bb25_0 (= main@%_57_0 (= main@%_54_0 main@%_56_0)))
                (=> main@_bb25_0 (= main@%_58_0 (ite main@%_57_0 1 0)))
                (=> main@postcall_0 (and main@postcall_0 main@_bb25_0))
                (=> (and main@postcall_0 main@_bb25_0) main@%_59_0)
                (__VERIFIER_assert main@postcall_0 false false main@%_58_0)
                (=> main@postcall_0 (= main@%_60_0 (+ main@%.0.i_0 1)))
                (=> main@_bb24_1 (and main@_bb24_1 main@postcall_0))
                (=> (and main@_bb24_1 main@postcall_0)
                    (= main@%.0.i_1 main@%_60_0))
                (=> (and main@_bb24_1 main@postcall_0)
...
(let ((a!3 (and (main@_bb24 main@%_0_0
                ...
                (=> main@_bb25_0 (= main@%_57_0 (= main@%_54_0 main@%_56_0)))
                (=> main@_bb25_0 (= main@%_58_0 (ite main@%_57_0 1 0)))
                (=> main@precall_0 (and main@precall_0 main@_bb25_0))
                (=> (and main@precall_0 main@_bb25_0) (not main@%_59_0))
                (=> main@__VERIFIER_assert_0
                    (and main@__VERIFIER_assert_0 main@precall_0))
                (=> main@__VERIFIER_assert_0 (= main@%_61_0 (= main@%_58_0 0)))
