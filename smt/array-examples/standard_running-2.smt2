(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-QiTmFn/standard_running-2.pp.ms.o.bc")
...
(let ((a!5 (and (main@_bb9 main@%_0_0
                ...
                (=> main@_bb13_0
                    (= main@%.1..i_0 (ite main@%_38_0 main@%.1.i_2 0)))
...
(rule (let ((a!1 (and (main@_bb9 main@%_0_0
                ...
                (=> main@__JVERIFIER_assert_0 (= main@%_42_0 (= main@%.0.i_0 0)))
