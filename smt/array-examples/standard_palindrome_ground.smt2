(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-joE_vU/standard_palindrome_ground.pp.ms.o.bc")
...
(declare-rel main@_bb8 (Int (Array Int Int) Int ))
...
(let ((a!2 (and (main@_bb @__VERIFIER_nondet_int_0
                ...
                (=> main@_bb3_0 (= main@%_5_0 @__VERIFIER_nondet_int_0))
                a!1
                (=> main@_bb3_0 (or (<= main@%_0_0 0) (> main@%_7_0 0)))
                ...
                (=> (and main@_bb_1 main@_bb3_0) (= main@%.01.i_1 main@%_8_0))
                (=> (and main@_bb_1 main@_bb3_0)
...
(rule (let ((a!1 (= main@%_15_0 (+ (+ main@%_0_0 (* 0 400000)) (* main@%_14_0 4))))
      (a!2 (= main@%_17_0 (+ (+ main@%_0_0 (* 0 400000)) (* main@%.1.i_0 4)))))
(let ((a!3 (and (main@_bb5 main@%_0_0 main@%.1.i_0 main@%shadow.mem.0.1_0)
                true
                (= main@%_11_0 (< main@%.1.i_0 50000))
                (=> main@_bb6_0 (and main@_bb6_0 main@_bb5_0))
                (=> (and main@_bb6_0 main@_bb5_0) main@%_11_0)
                (=> main@_bb6_0 (= main@%_13_0 (- 100000 main@%.1.i_0)))
                (=> main@_bb6_0 (= main@%_14_0 (+ main@%_13_0 (- 1))))
                (=> main@_bb6_0 a!1)
                ...
                (=> main@_bb6_0
                    (= main@%sm1_0
                       (store main@%shadow.mem.0.1_0 main@%_17_0 main@%_16_0)))
                (=> main@_bb6_0 (= main@%_18_0 (+ main@%.1.i_0 1)))
                (=> main@_bb5_1 (and main@_bb5_1 main@_bb6_0))
                (=> (and main@_bb5_1 main@_bb6_0)
                    (= main@%shadow.mem.0.1_1 main@%sm1_0))
                (=> (and main@_bb5_1 main@_bb6_0) (= main@%.1.i_1 main@%_18_0))
                (=> (and main@_bb5_1 main@_bb6_0)
...
(rule (=> (and (main@_bb5 main@%_0_0 main@%.1.i_0 main@%shadow.mem.0.1_0)
         true
         (= main@%_11_0 (< main@%.1.i_0 50000))
         ...
         main@_bb8_0)
    (main@_bb8 main@%_0_0 main@%shadow.mem.0.1_0 main@%.0.i_1)))
(rule (let ((a!1 (= main@%_23_0 (+ (+ main@%_0_0 (* 0 400000)) (* main@%.0.i_0 4))))
      (a!2 (= main@%_27_0 (+ (+ main@%_0_0 (* 0 400000)) (* main@%_26_0 4)))))
(let ((a!3 (and (main@_bb8 main@%_0_0 main@%shadow.mem.0.1_0 main@%.0.i_0)
                true
                (= main@%_21_0 (< main@%.0.i_0 50000))
                main@%_21_0
                ...
                (=> main@_bb9_0
                    (= main@%_24_0 (select main@%shadow.mem.0.1_0 main@%_23_0)))
                (=> main@_bb9_0 (= main@%_25_0 (- 100000 main@%.0.i_0)))
                (=> main@_bb9_0 (= main@%_26_0 (+ main@%_25_0 (- 1))))
                (=> main@_bb9_0 a!2)
                (=> main@_bb9_0 (or (<= main@%_0_0 0) (> main@%_27_0 0)))
                (=> main@_bb9_0 (> main@%_0_0 0))
                (=> main@_bb9_0
                    (= main@%_28_0 (select main@%shadow.mem.0.1_0 main@%_27_0)))
                (=> main@_bb9_0 (= main@%_29_0 (= main@%_24_0 main@%_28_0)))
                (=> main@_bb9_0 (= main@%_30_0 (ite main@%_29_0 1 0)))
                (=> main@postcall_0 (and main@postcall_0 main@_bb9_0))
                (=> (and main@postcall_0 main@_bb9_0) main@%_31_0)
                ...
                main@_bb8_1)))
  (=> a!3 (main@_bb8 main@%_0_0 main@%shadow.mem.0.1_0 main@%.0.i_2)))))
(rule (let ((a!1 (= main@%_23_0 (+ (+ main@%_0_0 (* 0 400000)) (* main@%.0.i_0 4))))
      (a!2 (= main@%_27_0 (+ (+ main@%_0_0 (* 0 400000)) (* main@%_26_0 4)))))
(let ((a!3 (and (main@_bb8 main@%_0_0 main@%shadow.mem.0.1_0 main@%.0.i_0)
                true
                ...
                (=> (and main@precall_0 main@_bb9_0) (not main@%_31_0))
