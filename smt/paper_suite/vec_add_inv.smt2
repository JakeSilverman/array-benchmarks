(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-6NT9xC/vec_add_inv.pp.ms.o.bc")
...
(declare-rel main@_bb12 (Int (Array Int Int) Int Int ))
...
(declare-var main@vec_neg.exit.i_0 Bool )
...
(rule (=> (and (main@_bb6 @__VERIFIER_nondet_int_0
    ...
    (main@_bb8 main@%_4_0
               ...
               main@%_1_0
               main@%sm5_0)))
(rule (let ((a!1 (=> main@_bb9_0 (= main@%_17_0 (+ main@%_4_0 (* main@%.0.i2.i_0 4)))))
      (a!2 (=> main@_bb9_0 (= main@%_20_0 (+ main@%_5_0 (* main@%.0.i2.i_0 4))))))
(let ((a!3 (and (main@_bb8 main@%_4_0
                ...
                a!1
                (=> main@_bb9_0 (or (<= main@%_4_0 0) (> main@%_17_0 0)))
                (=> main@_bb9_0 (> main@%_4_0 0))
                (=> main@_bb9_0
                    (= main@%_18_0 (select main@%shadow.mem.0.0_0 main@%_17_0)))
                (=> main@_bb9_0 (= main@%_19_0 (- 0 main@%_18_0)))
                a!2
                (=> main@_bb9_0 (or (<= main@%_5_0 0) (> main@%_20_0 0)))
                (=> main@_bb9_0 (> main@%_5_0 0))
                (=> main@_bb9_0
                    (= main@%sm1_0
                       (store main@%shadow.mem.4.0_0 main@%_20_0 main@%_19_0)))
                (=> main@_bb9_0 (= main@%_21_0 (+ main@%.0.i2.i_0 1)))
...
(rule (=> (and (main@_bb8 main@%_4_0
         ...
         true
         (= main@%_15_0 (< main@%.0.i2.i_0 main@%_1_0))
         (=> main@vec_neg.exit.i_0 (and main@vec_neg.exit.i_0 main@_bb8_0))
         (=> (and main@vec_neg.exit.i_0 main@_bb8_0) (not main@%_15_0))
         (=> main@_bb10_0 (and main@_bb10_0 main@vec_neg.exit.i_0))
         (=> (and main@_bb10_0 main@vec_neg.exit.i_0)
             (= main@%shadow.mem.8.0_0 main@%sm5_0))
         (=> (and main@_bb10_0 main@vec_neg.exit.i_0) (= main@%.0.i3.i_0 0))
         (=> (and main@_bb10_0 main@vec_neg.exit.i_0)
...
(rule (let ((a!1 (=> main@_bb11_0
               (= main@%_25_0 (+ main@%_4_0 (* main@%.0.i3.i_0 4)))))
      (a!2 (=> main@_bb11_0
               (= main@%_27_0 (+ main@%_5_0 (* main@%.0.i3.i_0 4)))))
      (a!3 (=> main@_bb11_0
               (= main@%_30_0 (+ main@%_6_0 (* main@%.0.i3.i_0 4))))))
(let ((a!4 (and (main@_bb10 main@%_4_0
                            ...
                            main@%_1_0)
                true
                (= main@%_23_0 (< main@%.0.i3.i_0 main@%_1_0))
                (=> main@_bb11_0 (and main@_bb11_0 main@_bb10_0))
                (=> (and main@_bb11_0 main@_bb10_0) main@%_23_0)
                a!1
...
(rule (=> (and (main@_bb10 main@%_4_0
         ...
         (=> (and main@vec_add.exit.i_0 main@_bb10_0) (not main@%_23_0))
         ...
         main@_bb12_0)
    (main@_bb12 main@%_6_0 main@%shadow.mem.8.0_0 main@%.01.i_1 main@%_1_0)))
(rule (let ((a!1 (=> main@_bb13_0 (= main@%_35_0 (+ main@%_6_0 (* main@%.01.i_0 4))))))
(let ((a!2 (and (main@_bb12 main@%_6_0
                            main@%shadow.mem.8.0_0
                            main@%.01.i_0
                            main@%_1_0)
                true
                ...
                a!1
                (=> main@_bb13_0 (or (<= main@%_6_0 0) (> main@%_35_0 0)))
                (=> main@_bb13_0 (> main@%_6_0 0))
                (=> main@_bb13_0
                    (= main@%_36_0 (select main@%shadow.mem.8.0_0 main@%_35_0)))
                (=> main@_bb13_0 (= main@%_37_0 (= main@%_36_0 0)))
                (=> main@_bb13_0 (= main@%_38_0 (ite main@%_37_0 1 0)))
                (=> main@_bb13_0 (= main@%_39_0 (= main@%_38_0 0)))
                (=> main@__VERIFIER_assert.exit.i_0
                    (and main@__VERIFIER_assert.exit.i_0 main@_bb13_0))
                (=> (and main@__VERIFIER_assert.exit.i_0 main@_bb13_0)
                    (not main@%_39_0))
                (=> main@__VERIFIER_assert.exit.i_0
                    (= main@%_41_0 (+ main@%.01.i_0 1)))
                (=> main@_bb12_1
                    (and main@_bb12_1 main@__VERIFIER_assert.exit.i_0))
                (=> (and main@_bb12_1 main@__VERIFIER_assert.exit.i_0)
                ...
                main@_bb12_1)))
  (=> a!2
      (main@_bb12 main@%_6_0 main@%shadow.mem.8.0_0 main@%.01.i_2 main@%_1_0)))))
(rule (let ((a!1 (=> main@_bb13_0 (= main@%_35_0 (+ main@%_6_0 (* main@%.01.i_0 4))))))
(let ((a!2 (and (main@_bb12 main@%_6_0
                            main@%shadow.mem.8.0_0
                            main@%.01.i_0
