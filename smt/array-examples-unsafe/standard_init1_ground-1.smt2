(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-PRk2xt/standard_init1_ground-1.pp.ms.o.bc")
...
(rule (=> (and (main@_bb main@%_0_0 main@%.01.i_0 main@%shadow.mem.0.0_0)
         ...
         main@_bb4_0)
    (main@_bb4 main@%_0_0 main@%shadow.mem.0.0_0 main@%.0.i_1)))
(rule (let ((a!1 (=> main@_bb5_0
               (= main@%_11_0 (+ main@%_0_0 (* 0 400000) (* main@%.0.i_0 4))))))
(let ((a!2 (and (main@_bb4 main@%_0_0 main@%shadow.mem.0.0_0 main@%.0.i_0)
                true
                (= main@%_9_0 (< main@%.0.i_0 100000))
                main@%_9_0
                (=> main@_bb5_0 (and main@_bb5_0 main@_bb4_0))
                a!1
                (=> main@_bb5_0 (or (<= main@%_0_0 0) (> main@%_11_0 0)))
                (=> main@_bb5_0 (> main@%_0_0 0))
                (=> main@_bb5_0
                    (= main@%_12_0 (select main@%shadow.mem.0.0_0 main@%_11_0)))
                (=> main@_bb5_0 (= main@%_13_0 (= main@%_12_0 43)))
                (=> main@_bb5_0 (= main@%_14_0 (ite main@%_13_0 1 0)))
                (=> main@postcall_0 (and main@postcall_0 main@_bb5_0))
                (=> (and main@postcall_0 main@_bb5_0) main@%_15_0)
                (__JVERIFIER_assert main@postcall_0 false false main@%_14_0)
                (=> main@postcall_0 (= main@%_16_0 (+ main@%.0.i_0 1)))
                ...
                main@_bb4_1)))
  (=> a!2 (main@_bb4 main@%_0_0 main@%shadow.mem.0.0_0 main@%.0.i_2)))))
(rule (let ((a!1 (=> main@_bb5_0
               (= main@%_11_0 (+ main@%_0_0 (* 0 400000) (* main@%.0.i_0 4))))))
(let ((a!2 (and (main@_bb4 main@%_0_0 main@%shadow.mem.0.0_0 main@%.0.i_0)
                true
                ...
                (=> (and main@precall_0 main@_bb5_0) (not main@%_15_0))
                (=> main@__JVERIFIER_assert_0
                    (and main@__JVERIFIER_assert_0 main@precall_0))
                (=> main@__JVERIFIER_assert_0 (= main@%_17_0 (= main@%_14_0 0)))
                (=> main@__JVERIFIER_assert_0 main@%_17_0)
