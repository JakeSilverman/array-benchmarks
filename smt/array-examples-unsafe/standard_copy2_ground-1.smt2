(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-IVqiOZ/standard_copy2_ground-1.pp.ms.o.bc")
...
(declare-rel main@_bb9 (Int (Array Int Int) Int (Array Int Int) Int Int (Array Int Int) ))
(declare-rel main@_bb12 (Int (Array Int Int) Int (Array Int Int) Int Int (Array Int Int) ))
...
(let ((a!3 (and (main@_bb @__VERIFIER_nondet_int_0
                ...
                (=> main@_bb7_0 (= main@%_9_0 @__VERIFIER_nondet_int_0))
                a!1
                ...
                (=> main@_bb7_0 (= main@%_12_0 @__VERIFIER_nondet_int_0))
                a!2
                (=> main@_bb7_0 (or (<= main@%_1_0 0) (> main@%_14_0 0)))
                (=> main@_bb7_0 (> main@%_1_0 0))
                (=> main@_bb7_0
                    (= main@%sm1_0
                       (store main@%shadow.mem.4.0_0 main@%_14_0 main@%_13_0)))
                (=> main@_bb7_0 (= main@%_15_0 (+ main@%.01.i_0 1)))
                ...
                (=> (and main@_bb_1 main@_bb7_0) (= main@%.01.i_1 main@%_15_0))
                (=> (and main@_bb_1 main@_bb7_0)
...
(rule (let ((a!1 (=> main@_bb10_0
               (= main@%_20_0 (+ main@%_0_0 (* 0 400000) (* main@%.02.i_0 4)))))
      (a!2 (=> main@_bb10_0
               (= main@%_22_0 (+ main@%_2_0 (* 0 400000) (* main@%.02.i_0 4))))))
(let ((a!3 (and (main@_bb9 main@%_0_0
                ...
                a!2
                (=> main@_bb10_0 (or (<= main@%_2_0 0) (> main@%_22_0 0)))
                (=> main@_bb10_0 (> main@%_2_0 0))
                (=> main@_bb10_0
                    (= main@%sm2_0
                       (store main@%shadow.mem.8.0_0 main@%_22_0 main@%_21_0)))
                (=> main@_bb10_0 (= main@%_23_0 (+ main@%.02.i_0 1)))
...
(rule (=> (and (main@_bb9 main@%_0_0
         ...
         (=> (and main@_bb11_0 main@_bb9_0) (not main@%_18_0))
...
(rule (let ((a!1 (=> main@_bb13_0
               (= main@%_28_0 (+ main@%_1_0 (* 0 400000) (* main@%.1.i_0 4)))))
      (a!2 (=> main@_bb13_0
               (= main@%_30_0 (+ main@%_2_0 (* 0 400000) (* main@%.1.i_0 4))))))
(let ((a!3 (and (main@_bb12 main@%_0_0
                ...
                true
                (= main@%_26_0 (< main@%.1.i_0 100000))
                (=> main@_bb13_0 (and main@_bb13_0 main@_bb12_0))
                (=> (and main@_bb13_0 main@_bb12_0) main@%_26_0)
                a!1
                (=> main@_bb13_0 (or (<= main@%_1_0 0) (> main@%_28_0 0)))
                (=> main@_bb13_0 (> main@%_1_0 0))
                (=> main@_bb13_0
                    (= main@%_29_0 (select main@%shadow.mem.4.0_0 main@%_28_0)))
                a!2
                (=> main@_bb13_0 (or (<= main@%_2_0 0) (> main@%_30_0 0)))
                (=> main@_bb13_0 (> main@%_2_0 0))
                (=> main@_bb13_0
                    (= main@%sm3_0
                       (store main@%shadow.mem.8.1_0 main@%_30_0 main@%_29_0)))
                (=> main@_bb13_0 (= main@%_31_0 (+ main@%.1.i_0 1)))
...
(rule (=> (and (main@_bb12 main@%_0_0
         ...
         (=> (and main@_bb14_0 main@_bb12_0) (not main@%_26_0))
...
(rule (let ((a!1 (=> main@_bb16_0
               (= main@%_36_0 (+ main@%_0_0 (* 0 400000) (* main@%.0.i_0 4)))))
      (a!2 (=> main@_bb16_0
               (= main@%_38_0 (+ main@%_2_0 (* 0 400000) (* main@%.0.i_0 4))))))
(let ((a!3 (and (main@_bb15 main@%_0_0
                            ...
                            main@%.0.i_0)
                true
                (= main@%_34_0 (< main@%.0.i_0 100000))
                main@%_34_0
                (=> main@_bb16_0 (and main@_bb16_0 main@_bb15_0))
                a!1
                (=> main@_bb16_0 (or (<= main@%_0_0 0) (> main@%_36_0 0)))
                (=> main@_bb16_0 (> main@%_0_0 0))
                (=> main@_bb16_0
                    (= main@%_37_0 (select main@%shadow.mem.0.0_0 main@%_36_0)))
                a!2
                (=> main@_bb16_0 (or (<= main@%_2_0 0) (> main@%_38_0 0)))
                (=> main@_bb16_0 (> main@%_2_0 0))
                (=> main@_bb16_0
                    (= main@%_39_0 (select main@%shadow.mem.8.1_0 main@%_38_0)))
                (=> main@_bb16_0 (= main@%_40_0 (= main@%_37_0 main@%_39_0)))
                (=> main@_bb16_0 (= main@%_41_0 (ite main@%_40_0 1 0)))
                (=> main@postcall_0 (and main@postcall_0 main@_bb16_0))
                (=> (and main@postcall_0 main@_bb16_0) main@%_42_0)
                (__VERIFIER_assert main@postcall_0 false false main@%_41_0)
                (=> main@postcall_0 (= main@%_43_0 (+ main@%.0.i_0 1)))
...
(let ((a!3 (and (main@_bb15 main@%_0_0
                ...
                (=> (and main@precall_0 main@_bb16_0) (not main@%_42_0))
                (=> main@__VERIFIER_assert_0
                    (and main@__VERIFIER_assert_0 main@precall_0))
                (=> main@__VERIFIER_assert_0 (= main@%_44_0 (= main@%_41_0 0)))
