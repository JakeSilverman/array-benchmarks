(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-brYneQ/standard_partition_ground-1.pp.ms.o.bc")
...
(declare-rel main@_bb (Int (Array Int Int) (Array Int Int) Int Int Int Int (Array Int Int) ))
(declare-rel main@_bb10 ((Array Int Int) (Array Int Int) Int Int Int Int (Array Int Int) Int Int ))
(declare-rel main@_bb15 ((Array Int Int) Int Int (Array Int Int) Int Int Int ))
(declare-rel main@_bb18 ((Array Int Int) Int Int Int ))
...
(rule (let ((a!1 (=> main@_bb6_0
      ...
      (a!2 (=> main@_bb7_0
               (= main@%_13_0 (+ main@%_0_0 (* 0 400000) (* main@%.01.i_0 4)))))
      (a!3 (=> main@_bb7_0
               (= main@%_15_0 (+ main@%_1_0 (* 0 400000) (* main@%.03.i_0 4))))))
(let ((a!4 (and (main@_bb main@%.01.i_0
                ...
                (=> main@_bb6_0 (= main@%_11_0 (> main@%_9_0 (- 1))))
                (=> main@_bb7_0 (and main@_bb7_0 main@_bb6_0))
                (=> (and main@_bb7_0 main@_bb6_0) main@%_11_0)
                a!2
                (=> main@_bb7_0 (or (<= main@%_0_0 0) (> main@%_13_0 0)))
                (=> main@_bb7_0 (> main@%_0_0 0))
                (=> main@_bb7_0 (= main@%_14_0 (select main@%sm_0 main@%_13_0)))
                a!3
                ...
                (=> main@_bb7_0 (= main@%_16_0 (+ main@%.03.i_0 1)))
                ...
                (=> (and main@_bb8_0 main@_bb7_0) (= main@%.14.i_0 main@%_16_0))
                (=> |tuple(main@_bb6_0, main@_bb8_0)|
                    (= main@%shadow.mem.4.1_1 main@%shadow.mem.4.0_0))
                (=> |tuple(main@_bb6_0, main@_bb8_0)|
                    (= main@%.14.i_1 main@%.03.i_0))
                (=> (and main@_bb8_0 main@_bb7_0)
                    (= main@%shadow.mem.4.1_2 main@%shadow.mem.4.1_0))
                (=> (and main@_bb8_0 main@_bb7_0)
                    (= main@%.14.i_2 main@%.14.i_0))
                (=> |tuple(main@_bb6_0, main@_bb8_0)|
                    (= main@%shadow.mem.4.1_2 main@%shadow.mem.4.1_1))
                (=> |tuple(main@_bb6_0, main@_bb8_0)|
                    (= main@%.14.i_2 main@%.14.i_1))
                (=> main@_bb8_0 (= main@%_18_0 (+ main@%.01.i_0 1)))
                (=> main@_bb_1 (and main@_bb_1 main@_bb8_0))
                (=> (and main@_bb_1 main@_bb8_0)
                    (= main@%shadow.mem.0.0_1 main@%sm_0))
                (=> (and main@_bb_1 main@_bb8_0)
                    (= main@%shadow.mem.4.0_1 main@%shadow.mem.4.1_2))
                (=> (and main@_bb_1 main@_bb8_0)
                    (= main@%.03.i_1 main@%.14.i_2))
                (=> (and main@_bb_1 main@_bb8_0) (= main@%.01.i_1 main@%_18_0))
                (=> (and main@_bb_1 main@_bb8_0)
...
(rule (=> (and (main@_bb main@%.01.i_0
         ...
         (=> (and main@_bb9_0 main@_bb_0) (not main@%_7_0))
         (=> main@_bb10_0 (and main@_bb10_0 main@_bb9_0))
         (=> (and main@_bb10_0 main@_bb9_0)
             (= main@%shadow.mem.8.0_0 main@%sm5_0))
         (=> (and main@_bb10_0 main@_bb9_0) (= main@%.05.i_0 0))
         (=> (and main@_bb10_0 main@_bb9_0) (= main@%.12.i_0 0))
         (=> (and main@_bb10_0 main@_bb9_0)
             (= main@%shadow.mem.8.0_1 main@%shadow.mem.8.0_0))
         (=> (and main@_bb10_0 main@_bb9_0) (= main@%.05.i_1 main@%.05.i_0))
         (=> (and main@_bb10_0 main@_bb9_0) (= main@%.12.i_1 main@%.12.i_0))
         main@_bb10_0)
    (main@_bb10 main@%shadow.mem.0.0_0
                main@%shadow.mem.4.0_0
                main@%.03.i_0
                main@%_0_0
                main@%_1_0
...
(rule (let ((a!1 (=> main@_bb11_0
               (= main@%_23_0 (+ main@%_0_0 (* 0 400000) (* main@%.12.i_0 4)))))
      (a!2 (=> main@_bb12_0
               (= main@%_27_0 (+ main@%_0_0 (* 0 400000) (* main@%.12.i_0 4)))))
      (a!3 (=> main@_bb12_0
               (= main@%_29_0 (+ main@%_2_0 (* 0 400000) (* main@%.05.i_0 4))))))
(let ((a!4 (and (main@_bb10 main@%shadow.mem.0.0_0
                            main@%shadow.mem.4.0_0
                            main@%.03.i_0
                            main@%_0_0
                            main@%_1_0
                            ...
                            main@%_2_0)
                true
                (= main@%_21_0 (< main@%.12.i_0 100000))
                (=> main@_bb11_0 (and main@_bb11_0 main@_bb10_0))
                (=> (and main@_bb11_0 main@_bb10_0) main@%_21_0)
                a!1
                (=> main@_bb11_0 (or (<= main@%_0_0 0) (> main@%_23_0 0)))
                (=> main@_bb11_0 (> main@%_0_0 0))
                (=> main@_bb11_0
                    (= main@%_24_0 (select main@%shadow.mem.0.0_0 main@%_23_0)))
                (=> main@_bb11_0 (= main@%_25_0 (> main@%_24_0 (- 1))))
                (=> main@_bb12_0 (and main@_bb12_0 main@_bb11_0))
                (=> (and main@_bb12_0 main@_bb11_0) main@%_25_0)
                a!2
                (=> main@_bb12_0 (or (<= main@%_0_0 0) (> main@%_27_0 0)))
                (=> main@_bb12_0 (> main@%_0_0 0))
                (=> main@_bb12_0
                    (= main@%_28_0 (select main@%shadow.mem.0.0_0 main@%_27_0)))
                a!3
                (=> main@_bb12_0 (or (<= main@%_2_0 0) (> main@%_29_0 0)))
                (=> main@_bb12_0 (> main@%_2_0 0))
                (=> main@_bb12_0
                    (= main@%sm2_0
                       (store main@%shadow.mem.8.0_0 main@%_29_0 main@%_28_0)))
                (=> main@_bb12_0 (= main@%_30_0 (+ main@%.05.i_0 1)))
                (=> |tuple(main@_bb11_0, main@_bb13_0)| main@_bb11_0)
                (=> main@_bb13_0
                    (or (and main@_bb13_0 main@_bb12_0)
                        |tuple(main@_bb11_0, main@_bb13_0)|))
                (=> |tuple(main@_bb11_0, main@_bb13_0)| (not main@%_25_0))
                (=> (and main@_bb13_0 main@_bb12_0)
                    (= main@%shadow.mem.8.1_0 main@%sm2_0))
                (=> (and main@_bb13_0 main@_bb12_0)
                    (= main@%.16.i_0 main@%_30_0))
                (=> |tuple(main@_bb11_0, main@_bb13_0)|
                    (= main@%shadow.mem.8.1_1 main@%shadow.mem.8.0_0))
                (=> |tuple(main@_bb11_0, main@_bb13_0)|
                    (= main@%.16.i_1 main@%.05.i_0))
                (=> (and main@_bb13_0 main@_bb12_0)
                    (= main@%shadow.mem.8.1_2 main@%shadow.mem.8.1_0))
                (=> (and main@_bb13_0 main@_bb12_0)
                    (= main@%.16.i_2 main@%.16.i_0))
                (=> |tuple(main@_bb11_0, main@_bb13_0)|
                    (= main@%shadow.mem.8.1_2 main@%shadow.mem.8.1_1))
                (=> |tuple(main@_bb11_0, main@_bb13_0)|
                    (= main@%.16.i_2 main@%.16.i_1))
                (=> main@_bb13_0 (= main@%_32_0 (+ main@%.12.i_0 1)))
                (=> main@_bb10_1 (and main@_bb10_1 main@_bb13_0))
                (=> (and main@_bb10_1 main@_bb13_0)
                    (= main@%shadow.mem.8.0_1 main@%shadow.mem.8.1_2))
                (=> (and main@_bb10_1 main@_bb13_0)
                    (= main@%.05.i_1 main@%.16.i_2))
                (=> (and main@_bb10_1 main@_bb13_0)
  ...
  (=> a!4
      (main@_bb10 main@%shadow.mem.0.0_0
                  ...
                  main@%.05.i_2
                  main@%_2_0)))))
(rule (=> (and (main@_bb10 main@%shadow.mem.0.0_0
                     main@%shadow.mem.4.0_0
                     main@%.03.i_0
                     main@%_0_0
                     main@%_1_0
         ...
         (=> (and main@_bb14_0 main@_bb10_0) (not main@%_21_0))
         (=> main@_bb15_0 (and main@_bb15_0 main@_bb14_0))
         (=> (and main@_bb15_0 main@_bb14_0) (= main@%.0.i_0 0))
         (=> (and main@_bb15_0 main@_bb14_0) (= main@%.0.i_1 main@%.0.i_0))
         main@_bb15_0)
    (main@_bb15 main@%shadow.mem.4.0_0
                main@%.03.i_0
                main@%_1_0
                main@%shadow.mem.8.0_0
                main@%.05.i_0
...
(rule (let ((a!1 (=> main@_bb16_0
               (= main@%_37_0 (+ main@%_1_0 (* 0 400000) (* main@%.0.i_0 4))))))
(let ((a!2 (and (main@_bb15 main@%shadow.mem.4.0_0
                            main@%.03.i_0
                            main@%_1_0
                            main@%shadow.mem.8.0_0
                            main@%.05.i_0
  ...
  (=> a!2
      (main@_bb15 main@%shadow.mem.4.0_0
                  ...
                  main@%_2_0
                  main@%.0.i_2)))))
(rule (=> (and (main@_bb15 main@%shadow.mem.4.0_0
                     main@%.03.i_0
                     main@%_1_0
                     main@%shadow.mem.8.0_0
                     main@%.05.i_0
         ...
         main@_bb18_0)
    (main@_bb18 main@%shadow.mem.8.0_0 main@%.05.i_0 main@%_2_0 main@%.1.i_1)))
(rule (let ((a!1 (=> main@_bb16_0
               (= main@%_37_0 (+ main@%_1_0 (* 0 400000) (* main@%.0.i_0 4))))))
(let ((a!2 (and (main@_bb15 main@%shadow.mem.4.0_0
                            main@%.03.i_0
                ...
                (=> (and main@precall_0 main@_bb16_0) (not main@%_41_0))
                ...
                (=> (and main@__JVERIFIER_assert_0 main@precall_0)
                    (= main@%.0_1 main@%.0_0))
                (=> main@__JVERIFIER_assert_0 (= main@%_53_0 (= main@%.0_1 0)))
                (=> main@__JVERIFIER_assert_0 main@%_53_0)
...
(rule (let ((a!1 (=> main@_bb19_0
               (= main@%_47_0 (+ main@%_2_0 (* 0 400000) (* main@%.1.i_0 4))))))
(let ((a!2 (and (main@_bb18 main@%shadow.mem.8.0_0
                            main@%.05.i_0
                            main@%_2_0
                            main@%.1.i_0)
                true
                (= main@%_45_0 (< main@%.1.i_0 main@%.05.i_0))
                main@%_45_0
                (=> main@_bb19_0 (and main@_bb19_0 main@_bb18_0))
                a!1
                (=> main@_bb19_0 (or (<= main@%_2_0 0) (> main@%_47_0 0)))
                (=> main@_bb19_0 (> main@%_2_0 0))
                (=> main@_bb19_0
                    (= main@%_48_0 (select main@%shadow.mem.8.0_0 main@%_47_0)))
                (=> main@_bb19_0 (= main@%_49_0 (< main@%_48_0 0)))
                (=> main@_bb19_0 (= main@%_50_0 (ite main@%_49_0 1 0)))
                (=> main@postcall1_0 (and main@postcall1_0 main@_bb19_0))
                (=> (and main@postcall1_0 main@_bb19_0) main@%_51_0)
                (__JVERIFIER_assert main@postcall1_0 false false main@%_50_0)
                (=> main@postcall1_0 (= main@%_52_0 (+ main@%.1.i_0 1)))
                (=> main@_bb18_1 (and main@_bb18_1 main@postcall1_0))
                (=> (and main@_bb18_1 main@postcall1_0)
                    (= main@%.1.i_1 main@%_52_0))
                (=> (and main@_bb18_1 main@postcall1_0)
                    (= main@%.1.i_2 main@%.1.i_1))
                main@_bb18_1)))
  (=> a!2
      (main@_bb18 main@%shadow.mem.8.0_0 main@%.05.i_0 main@%_2_0 main@%.1.i_2)))))
(rule (let ((a!1 (=> main@_bb19_0
               (= main@%_47_0 (+ main@%_2_0 (* 0 400000) (* main@%.1.i_0 4))))))
(let ((a!2 (and (main@_bb18 main@%shadow.mem.8.0_0
                            main@%.05.i_0
                ...
                (=> main@_bb19_0 (= main@%_49_0 (< main@%_48_0 0)))
                (=> main@_bb19_0 (= main@%_50_0 (ite main@%_49_0 1 0)))
                (=> main@precall2_0 (and main@precall2_0 main@_bb19_0))
                (=> (and main@precall2_0 main@_bb19_0) (not main@%_51_0))
                (=> main@__JVERIFIER_assert_0
