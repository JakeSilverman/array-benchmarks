(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-YORND6/standard_minInArray_ground-2.pp.ms.o.bc")
...
(rule (=> (and main@entry
         ...
         main@_bb_0)
    (main@_bb main@%_0_0 main@%.02.i_1 main@%shadow.mem.0.0_1)))
(rule (let ((a!1 (=> main@_bb2_0
               (= main@%_6_0 (+ main@%_0_0 (* 0 400000) (* main@%.02.i_0 4))))))
(let ((a!2 (and (main@_bb main@%_0_0 main@%.02.i_0 main@%shadow.mem.0.0_0)
                true
                (= main@%_3_0 (< main@%.02.i_0 100000))
                (=> main@_bb2_0 (and main@_bb2_0 main@_bb_0))
                (=> (and main@_bb2_0 main@_bb_0) main@%_3_0)
                a!1
                (=> main@_bb2_0 (or (<= main@%_0_0 0) (> main@%_6_0 0)))
                (=> main@_bb2_0 (> main@%_0_0 0))
                (=> main@_bb2_0
                    (= main@%sm_0
                       (store main@%shadow.mem.0.0_0 main@%_6_0 main@%_5_0)))
                (=> main@_bb2_0 (= main@%_7_0 (+ main@%.02.i_0 1)))
                (=> main@_bb_1 (and main@_bb_1 main@_bb2_0))
                (=> (and main@_bb_1 main@_bb2_0)
                    (= main@%shadow.mem.0.0_1 main@%sm_0))
                (=> (and main@_bb_1 main@_bb2_0) (= main@%.02.i_1 main@%_7_0))
                (=> (and main@_bb_1 main@_bb2_0)
                    (= main@%shadow.mem.0.0_2 main@%shadow.mem.0.0_1))
                (=> (and main@_bb_1 main@_bb2_0)
                    (= main@%.02.i_2 main@%.02.i_1))
                main@_bb_1)))
  (=> a!2 (main@_bb main@%_0_0 main@%.02.i_2 main@%shadow.mem.0.0_2)))))
(rule (=> (and (main@_bb main@%_0_0 main@%.02.i_0 main@%shadow.mem.0.0_0)
         true
         (= main@%_3_0 (< main@%.02.i_0 100000))
         (=> main@_bb3_0 (and main@_bb3_0 main@_bb_0))
         (=> (and main@_bb3_0 main@_bb_0) (not main@%_3_0))
         (=> main@_bb4_0 (and main@_bb4_0 main@_bb3_0))
         (=> (and main@_bb4_0 main@_bb3_0) (= main@%.13.i_0 0))
         (=> (and main@_bb4_0 main@_bb3_0) (= main@%.01.i_0 0))
         (=> (and main@_bb4_0 main@_bb3_0) (= main@%.13.i_1 main@%.13.i_0))
         (=> (and main@_bb4_0 main@_bb3_0) (= main@%.01.i_1 main@%.01.i_0))
         main@_bb4_0)
    (main@_bb4 main@%_0_0 main@%shadow.mem.0.0_0 main@%.13.i_1 main@%.01.i_1)))
(rule (let ((a!1 (=> main@_bb5_0
               (= main@%_12_0 (+ main@%_0_0 (* 0 400000) (* main@%.13.i_0 4)))))
      (a!2 (=> main@_bb6_0
               (= main@%_16_0 (+ main@%_0_0 (* 0 400000) (* main@%.13.i_0 4))))))
(let ((a!3 (and (main@_bb4 main@%_0_0
                           main@%shadow.mem.0.0_0
                           main@%.13.i_0
                           main@%.01.i_0)
                true
                (= main@%_10_0 (< main@%.13.i_0 100000))
                (=> main@_bb5_0 (and main@_bb5_0 main@_bb4_0))
                (=> (and main@_bb5_0 main@_bb4_0) main@%_10_0)
                a!1
                (=> main@_bb5_0 (or (<= main@%_0_0 0) (> main@%_12_0 0)))
                (=> main@_bb5_0 (> main@%_0_0 0))
                (=> main@_bb5_0
                    (= main@%_13_0 (select main@%shadow.mem.0.0_0 main@%_12_0)))
                (=> main@_bb5_0 (= main@%_14_0 (< main@%_13_0 main@%.01.i_0)))
                ...
                (=> |tuple(main@_bb5_0, main@_bb7_0)| (not main@%_14_0))
                (=> (and main@_bb7_0 main@_bb6_0) (= main@%.1.i_0 main@%_17_0))
                (=> |tuple(main@_bb5_0, main@_bb7_0)|
                    (= main@%.1.i_1 main@%.01.i_0))
                (=> (and main@_bb7_0 main@_bb6_0) (= main@%.1.i_2 main@%.1.i_0))
                (=> |tuple(main@_bb5_0, main@_bb7_0)|
                    (= main@%.1.i_2 main@%.1.i_1))
                (=> main@_bb7_0 (= main@%_19_0 (+ main@%.13.i_0 1)))
                (=> main@_bb4_1 (and main@_bb4_1 main@_bb7_0))
                (=> (and main@_bb4_1 main@_bb7_0) (= main@%.13.i_1 main@%_19_0))
                ...
                main@_bb4_1)))
  (=> a!3
      (main@_bb4 main@%_0_0 main@%shadow.mem.0.0_0 main@%.13.i_2 main@%.01.i_2)))))
(rule (=> (and (main@_bb4 main@%_0_0
         ...
         (=> (and main@_bb8_0 main@_bb4_0) (not main@%_10_0))
...
(rule (let ((a!1 (=> main@_bb10_0
               (= main@%_24_0 (+ main@%_0_0 (* 0 400000) (* main@%.0.i_0 4))))))
(let ((a!2 (and (main@_bb9 main@%_0_0
                ...
                (=> main@_bb10_0 (= main@%_26_0 (>= main@%_25_0 main@%.01.i_0)))
                (=> main@_bb10_0 (= main@%_27_0 (ite main@%_26_0 1 0)))
                (=> main@postcall_0 (and main@postcall_0 main@_bb10_0))
                (=> (and main@postcall_0 main@_bb10_0) main@%_28_0)
                (__JVERIFIER_assert main@postcall_0 false false main@%_27_0)
                (=> main@postcall_0 (= main@%_29_0 (+ main@%.0.i_0 1)))
                (=> main@_bb9_1 (and main@_bb9_1 main@postcall_0))
                (=> (and main@_bb9_1 main@postcall_0)
                    (= main@%.0.i_1 main@%_29_0))
                (=> (and main@_bb9_1 main@postcall_0)
...
(let ((a!2 (and (main@_bb9 main@%_0_0
                ...
                (=> (and main@precall_0 main@_bb10_0) (not main@%_28_0))
                (=> main@__JVERIFIER_assert_0
                    (and main@__JVERIFIER_assert_0 main@precall_0))
                (=> main@__JVERIFIER_assert_0 (= main@%_30_0 (= main@%_27_0 0)))
