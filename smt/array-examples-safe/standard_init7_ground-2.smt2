(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-leQzg8/standard_init7_ground-2.pp.ms.o.bc")
...
(declare-rel main@_bb16 (Int Int (Array Int Int) ))
(declare-rel main@_bb19 (Int Int (Array Int Int) ))
(declare-rel main@_bb22 (Int Int (Array Int Int) ))
(declare-rel main@_bb25 (Int Int (Array Int Int) ))
(declare-rel main@_bb28 (Int (Array Int Int) Int ))
...
(rule (=> (and (main@_bb main@%_0_0 main@%.01.i_0 main@%shadow.mem.0.0_0)
         ...
         main@_bb10_0)
    (main@_bb10 main@%_0_0 main@%.1.i_1 main@%shadow.mem.0.1_1)))
(rule (let ((a!1 (=> main@_bb11_0
               (= main@%_11_0 (+ main@%_0_0 (* 0 400000) (* main@%.1.i_0 4))))))
(let ((a!2 (and (main@_bb10 main@%_0_0 main@%.1.i_0 main@%shadow.mem.0.1_0)
                true
                (= main@%_9_0 (< main@%.1.i_0 100000))
                (=> main@_bb11_0 (and main@_bb11_0 main@_bb10_0))
                (=> (and main@_bb11_0 main@_bb10_0) main@%_9_0)
                a!1
                (=> main@_bb11_0 (or (<= main@%_0_0 0) (> main@%_11_0 0)))
                (=> main@_bb11_0 (> main@%_0_0 0))
                (=> main@_bb11_0
                    (= main@%sm1_0
                       (store main@%shadow.mem.0.1_0 main@%_11_0 43)))
                (=> main@_bb11_0 (= main@%_12_0 (+ main@%.1.i_0 1)))
                ...
                main@_bb10_1)))
  (=> a!2 (main@_bb10 main@%_0_0 main@%.1.i_2 main@%shadow.mem.0.1_2)))))
(rule (=> (and (main@_bb10 main@%_0_0 main@%.1.i_0 main@%shadow.mem.0.1_0)
         true
         (= main@%_9_0 (< main@%.1.i_0 100000))
         (=> main@_bb12_0 (and main@_bb12_0 main@_bb10_0))
         (=> (and main@_bb12_0 main@_bb10_0) (not main@%_9_0))
         ...
         main@_bb13_0)
    (main@_bb13 main@%_0_0 main@%.2.i_1 main@%shadow.mem.0.2_1)))
(rule (let ((a!1 (=> main@_bb14_0
               (= main@%_17_0 (+ main@%_0_0 (* 0 400000) (* main@%.2.i_0 4))))))
(let ((a!2 (and (main@_bb13 main@%_0_0 main@%.2.i_0 main@%shadow.mem.0.2_0)
                true
                (= main@%_15_0 (< main@%.2.i_0 100000))
                (=> main@_bb14_0 (and main@_bb14_0 main@_bb13_0))
                (=> (and main@_bb14_0 main@_bb13_0) main@%_15_0)
                a!1
                (=> main@_bb14_0 (or (<= main@%_0_0 0) (> main@%_17_0 0)))
                (=> main@_bb14_0 (> main@%_0_0 0))
                (=> main@_bb14_0
                    (= main@%sm2_0
                       (store main@%shadow.mem.0.2_0 main@%_17_0 44)))
                (=> main@_bb14_0 (= main@%_18_0 (+ main@%.2.i_0 1)))
                ...
                main@_bb13_1)))
  (=> a!2 (main@_bb13 main@%_0_0 main@%.2.i_2 main@%shadow.mem.0.2_2)))))
(rule (=> (and (main@_bb13 main@%_0_0 main@%.2.i_0 main@%shadow.mem.0.2_0)
         true
         (= main@%_15_0 (< main@%.2.i_0 100000))
         (=> main@_bb15_0 (and main@_bb15_0 main@_bb13_0))
         (=> (and main@_bb15_0 main@_bb13_0) (not main@%_15_0))
         (=> main@_bb16_0 (and main@_bb16_0 main@_bb15_0))
         (=> (and main@_bb16_0 main@_bb15_0)
             (= main@%shadow.mem.0.3_0 main@%shadow.mem.0.2_0))
         (=> (and main@_bb16_0 main@_bb15_0) (= main@%.3.i_0 0))
         (=> (and main@_bb16_0 main@_bb15_0)
             (= main@%shadow.mem.0.3_1 main@%shadow.mem.0.3_0))
         (=> (and main@_bb16_0 main@_bb15_0) (= main@%.3.i_1 main@%.3.i_0))
         main@_bb16_0)
    (main@_bb16 main@%_0_0 main@%.3.i_1 main@%shadow.mem.0.3_1)))
(rule (let ((a!1 (=> main@_bb17_0
               (= main@%_23_0 (+ main@%_0_0 (* 0 400000) (* main@%.3.i_0 4))))))
(let ((a!2 (and (main@_bb16 main@%_0_0 main@%.3.i_0 main@%shadow.mem.0.3_0)
                true
                (= main@%_21_0 (< main@%.3.i_0 100000))
                (=> main@_bb17_0 (and main@_bb17_0 main@_bb16_0))
                (=> (and main@_bb17_0 main@_bb16_0) main@%_21_0)
                a!1
                (=> main@_bb17_0 (or (<= main@%_0_0 0) (> main@%_23_0 0)))
                (=> main@_bb17_0 (> main@%_0_0 0))
                (=> main@_bb17_0
                    (= main@%sm3_0
                       (store main@%shadow.mem.0.3_0 main@%_23_0 45)))
                (=> main@_bb17_0 (= main@%_24_0 (+ main@%.3.i_0 1)))
                ...
                main@_bb16_1)))
  (=> a!2 (main@_bb16 main@%_0_0 main@%.3.i_2 main@%shadow.mem.0.3_2)))))
(rule (=> (and (main@_bb16 main@%_0_0 main@%.3.i_0 main@%shadow.mem.0.3_0)
         true
         (= main@%_21_0 (< main@%.3.i_0 100000))
         (=> main@_bb18_0 (and main@_bb18_0 main@_bb16_0))
         (=> (and main@_bb18_0 main@_bb16_0) (not main@%_21_0))
         (=> main@_bb19_0 (and main@_bb19_0 main@_bb18_0))
         (=> (and main@_bb19_0 main@_bb18_0)
             (= main@%shadow.mem.0.4_0 main@%shadow.mem.0.3_0))
         (=> (and main@_bb19_0 main@_bb18_0) (= main@%.4.i_0 0))
         (=> (and main@_bb19_0 main@_bb18_0)
             (= main@%shadow.mem.0.4_1 main@%shadow.mem.0.4_0))
         (=> (and main@_bb19_0 main@_bb18_0) (= main@%.4.i_1 main@%.4.i_0))
         main@_bb19_0)
    (main@_bb19 main@%_0_0 main@%.4.i_1 main@%shadow.mem.0.4_1)))
(rule (let ((a!1 (=> main@_bb20_0
               (= main@%_29_0 (+ main@%_0_0 (* 0 400000) (* main@%.4.i_0 4))))))
(let ((a!2 (and (main@_bb19 main@%_0_0 main@%.4.i_0 main@%shadow.mem.0.4_0)
                true
                (= main@%_27_0 (< main@%.4.i_0 100000))
                (=> main@_bb20_0 (and main@_bb20_0 main@_bb19_0))
                (=> (and main@_bb20_0 main@_bb19_0) main@%_27_0)
                a!1
                (=> main@_bb20_0 (or (<= main@%_0_0 0) (> main@%_29_0 0)))
                (=> main@_bb20_0 (> main@%_0_0 0))
                (=> main@_bb20_0
                    (= main@%sm4_0
                       (store main@%shadow.mem.0.4_0 main@%_29_0 46)))
                (=> main@_bb20_0 (= main@%_30_0 (+ main@%.4.i_0 1)))
                ...
                main@_bb19_1)))
  (=> a!2 (main@_bb19 main@%_0_0 main@%.4.i_2 main@%shadow.mem.0.4_2)))))
(rule (=> (and (main@_bb19 main@%_0_0 main@%.4.i_0 main@%shadow.mem.0.4_0)
         true
         (= main@%_27_0 (< main@%.4.i_0 100000))
         (=> main@_bb21_0 (and main@_bb21_0 main@_bb19_0))
         (=> (and main@_bb21_0 main@_bb19_0) (not main@%_27_0))
         (=> main@_bb22_0 (and main@_bb22_0 main@_bb21_0))
         (=> (and main@_bb22_0 main@_bb21_0)
             (= main@%shadow.mem.0.5_0 main@%shadow.mem.0.4_0))
         (=> (and main@_bb22_0 main@_bb21_0) (= main@%.5.i_0 0))
         (=> (and main@_bb22_0 main@_bb21_0)
             (= main@%shadow.mem.0.5_1 main@%shadow.mem.0.5_0))
         (=> (and main@_bb22_0 main@_bb21_0) (= main@%.5.i_1 main@%.5.i_0))
         main@_bb22_0)
    (main@_bb22 main@%_0_0 main@%.5.i_1 main@%shadow.mem.0.5_1)))
(rule (let ((a!1 (=> main@_bb23_0
               (= main@%_35_0 (+ main@%_0_0 (* 0 400000) (* main@%.5.i_0 4))))))
(let ((a!2 (and (main@_bb22 main@%_0_0 main@%.5.i_0 main@%shadow.mem.0.5_0)
                true
                (= main@%_33_0 (< main@%.5.i_0 100000))
                (=> main@_bb23_0 (and main@_bb23_0 main@_bb22_0))
                (=> (and main@_bb23_0 main@_bb22_0) main@%_33_0)
                a!1
                (=> main@_bb23_0 (or (<= main@%_0_0 0) (> main@%_35_0 0)))
                (=> main@_bb23_0 (> main@%_0_0 0))
                (=> main@_bb23_0
                    (= main@%sm5_0
                       (store main@%shadow.mem.0.5_0 main@%_35_0 47)))
                (=> main@_bb23_0 (= main@%_36_0 (+ main@%.5.i_0 1)))
                ...
                main@_bb22_1)))
  (=> a!2 (main@_bb22 main@%_0_0 main@%.5.i_2 main@%shadow.mem.0.5_2)))))
(rule (=> (and (main@_bb22 main@%_0_0 main@%.5.i_0 main@%shadow.mem.0.5_0)
         true
         (= main@%_33_0 (< main@%.5.i_0 100000))
         (=> main@_bb24_0 (and main@_bb24_0 main@_bb22_0))
         (=> (and main@_bb24_0 main@_bb22_0) (not main@%_33_0))
         (=> main@_bb25_0 (and main@_bb25_0 main@_bb24_0))
         (=> (and main@_bb25_0 main@_bb24_0)
             (= main@%shadow.mem.0.6_0 main@%shadow.mem.0.5_0))
         (=> (and main@_bb25_0 main@_bb24_0) (= main@%.6.i_0 0))
         (=> (and main@_bb25_0 main@_bb24_0)
             (= main@%shadow.mem.0.6_1 main@%shadow.mem.0.6_0))
         (=> (and main@_bb25_0 main@_bb24_0) (= main@%.6.i_1 main@%.6.i_0))
         main@_bb25_0)
    (main@_bb25 main@%_0_0 main@%.6.i_1 main@%shadow.mem.0.6_1)))
(rule (let ((a!1 (=> main@_bb26_0
               (= main@%_41_0 (+ main@%_0_0 (* 0 400000) (* main@%.6.i_0 4))))))
(let ((a!2 (and (main@_bb25 main@%_0_0 main@%.6.i_0 main@%shadow.mem.0.6_0)
                true
                (= main@%_39_0 (< main@%.6.i_0 100000))
                (=> main@_bb26_0 (and main@_bb26_0 main@_bb25_0))
                (=> (and main@_bb26_0 main@_bb25_0) main@%_39_0)
                a!1
                (=> main@_bb26_0 (or (<= main@%_0_0 0) (> main@%_41_0 0)))
                (=> main@_bb26_0 (> main@%_0_0 0))
                (=> main@_bb26_0
                    (= main@%sm6_0
                       (store main@%shadow.mem.0.6_0 main@%_41_0 48)))
                (=> main@_bb26_0 (= main@%_42_0 (+ main@%.6.i_0 1)))
                ...
                main@_bb25_1)))
  (=> a!2 (main@_bb25 main@%_0_0 main@%.6.i_2 main@%shadow.mem.0.6_2)))))
(rule (=> (and (main@_bb25 main@%_0_0 main@%.6.i_0 main@%shadow.mem.0.6_0)
         true
         (= main@%_39_0 (< main@%.6.i_0 100000))
         (=> main@_bb27_0 (and main@_bb27_0 main@_bb25_0))
         (=> (and main@_bb27_0 main@_bb25_0) (not main@%_39_0))
         (=> main@_bb28_0 (and main@_bb28_0 main@_bb27_0))
         (=> (and main@_bb28_0 main@_bb27_0) (= main@%.0.i_0 0))
         (=> (and main@_bb28_0 main@_bb27_0) (= main@%.0.i_1 main@%.0.i_0))
         main@_bb28_0)
    (main@_bb28 main@%_0_0 main@%shadow.mem.0.6_0 main@%.0.i_1)))
(rule (let ((a!1 (=> main@_bb29_0
               (= main@%_47_0 (+ main@%_0_0 (* 0 400000) (* main@%.0.i_0 4))))))
(let ((a!2 (and (main@_bb28 main@%_0_0 main@%shadow.mem.0.6_0 main@%.0.i_0)
                true
                (= main@%_45_0 (< main@%.0.i_0 100000))
                main@%_45_0
                (=> main@_bb29_0 (and main@_bb29_0 main@_bb28_0))
                a!1
                (=> main@_bb29_0 (or (<= main@%_0_0 0) (> main@%_47_0 0)))
                (=> main@_bb29_0 (> main@%_0_0 0))
                (=> main@_bb29_0
                    (= main@%_48_0 (select main@%shadow.mem.0.6_0 main@%_47_0)))
                (=> main@_bb29_0 (= main@%_49_0 (= main@%_48_0 48)))
                (=> main@_bb29_0 (= main@%_50_0 (ite main@%_49_0 1 0)))
                (=> main@postcall_0 (and main@postcall_0 main@_bb29_0))
                (=> (and main@postcall_0 main@_bb29_0) main@%_51_0)
                (__JVERIFIER_assert main@postcall_0 false false main@%_50_0)
                (=> main@postcall_0 (= main@%_52_0 (+ main@%.0.i_0 1)))
                (=> main@_bb28_1 (and main@_bb28_1 main@postcall_0))
                (=> (and main@_bb28_1 main@postcall_0)
                    (= main@%.0.i_1 main@%_52_0))
                (=> (and main@_bb28_1 main@postcall_0)
                    (= main@%.0.i_2 main@%.0.i_1))
                main@_bb28_1)))
  (=> a!2 (main@_bb28 main@%_0_0 main@%shadow.mem.0.6_0 main@%.0.i_2)))))
(rule (let ((a!1 (=> main@_bb29_0
               (= main@%_47_0 (+ main@%_0_0 (* 0 400000) (* main@%.0.i_0 4))))))
(let ((a!2 (and (main@_bb28 main@%_0_0 main@%shadow.mem.0.6_0 main@%.0.i_0)
                true
                ...
                (=> main@_bb29_0 (= main@%_49_0 (= main@%_48_0 48)))
                (=> main@_bb29_0 (= main@%_50_0 (ite main@%_49_0 1 0)))
                (=> main@precall_0 (and main@precall_0 main@_bb29_0))
                (=> (and main@precall_0 main@_bb29_0) (not main@%_51_0))
                (=> main@__JVERIFIER_assert_0
                    (and main@__JVERIFIER_assert_0 main@precall_0))
                (=> main@__JVERIFIER_assert_0 (= main@%_53_0 (= main@%_50_0 0)))
