(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-gMHrVX/standard_copyInitSum3_ground.pp.ms.o.bc")
...
(declare-rel main@_bb8 (Int (Array Int Int) Int Int (Array Int Int) ))
(declare-rel main@_bb11 (Int (Array Int Int) Int Int (Array Int Int) ))
(declare-rel main@_bb14 (Int (Array Int Int) Int Int (Array Int Int) ))
(declare-rel main@_bb17 (Int (Array Int Int) Int ))
...
(rule (=> (and (main@_bb main@%_0_0
         ...
         (=> (and main@_bb7_0 main@_bb_0) (not main@%_5_0))
...
(rule (=> (and (main@_bb8 main@%_0_0
         ...
         (=> (and main@_bb11_0 main@_bb10_0) (= main@%.2.i_0 0))
         (=> (and main@_bb11_0 main@_bb10_0)
...
(let ((a!3 (and (main@_bb11 main@%_0_0
                ...
                (=> (and main@_bb12_0 main@_bb11_0) main@%_19_0)
                a!1
                (=> main@_bb12_0 (or (<= main@%_1_0 0) (> main@%_21_0 0)))
                (=> main@_bb12_0 (> main@%_1_0 0))
                (=> main@_bb12_0
                    (= main@%_22_0 (select main@%shadow.mem.4.1_0 main@%_21_0)))
                (=> main@_bb12_0 (= main@%_23_0 (+ main@%_22_0 main@%.2.i_0)))
                a!2
                ...
                (=> main@_bb12_0 (= main@%_25_0 (+ main@%.2.i_0 1)))
...
(rule (let ((a!1 (=> main@_bb15_0
               (= main@%_30_0 (+ main@%_1_0 (* 0 400000) (* main@%.3.i_0 4)))))
      (a!2 (=> main@_bb15_0
               (= main@%_32_0 (+ main@%_0_0 (* 0 400000) (* main@%.3.i_0 4)))))
      (a!3 (=> main@_bb15_0
               (= main@%_35_0 (+ main@%_1_0 (* 0 400000) (* main@%.3.i_0 4))))))
(let ((a!4 (and (main@_bb14 main@%_0_0
                ...
                (=> main@_bb15_0
                    (= main@%_31_0 (select main@%shadow.mem.4.2_0 main@%_30_0)))
                a!2
                (=> main@_bb15_0 (or (<= main@%_0_0 0) (> main@%_32_0 0)))
                (=> main@_bb15_0 (> main@%_0_0 0))
                (=> main@_bb15_0
                    (= main@%_33_0 (select main@%shadow.mem.0.0_0 main@%_32_0)))
                (=> main@_bb15_0 (= main@%_34_0 (- main@%_31_0 main@%_33_0)))
                a!3
                (=> main@_bb15_0 (or (<= main@%_1_0 0) (> main@%_35_0 0)))
                (=> main@_bb15_0 (> main@%_1_0 0))
                (=> main@_bb15_0
                    (= main@%sm3_0
                       (store main@%shadow.mem.4.2_0 main@%_35_0 main@%_34_0)))
                (=> main@_bb15_0 (= main@%_36_0 (+ main@%.3.i_0 1)))
                (=> main@_bb14_1 (and main@_bb14_1 main@_bb15_0))
                (=> (and main@_bb14_1 main@_bb15_0)
                    (= main@%shadow.mem.4.2_1 main@%sm3_0))
                (=> (and main@_bb14_1 main@_bb15_0)
                    (= main@%.3.i_1 main@%_36_0))
                (=> (and main@_bb14_1 main@_bb15_0)
...
(rule (=> (and (main@_bb14 main@%_0_0
         ...
         (=> (and main@_bb17_0 main@_bb16_0) (= main@%.0.i_1 main@%.0.i_0))
         main@_bb17_0)
    (main@_bb17 main@%_1_0 main@%shadow.mem.4.2_0 main@%.0.i_1)))
(rule (let ((a!1 (=> main@_bb18_0
               (= main@%_41_0 (+ main@%_1_0 (* 0 400000) (* main@%.0.i_0 4))))))
(let ((a!2 (and (main@_bb17 main@%_1_0 main@%shadow.mem.4.2_0 main@%.0.i_0)
                true
                (= main@%_39_0 (< main@%.0.i_0 100000))
                main@%_39_0
                (=> main@_bb18_0 (and main@_bb18_0 main@_bb17_0))
                a!1
                (=> main@_bb18_0 (or (<= main@%_1_0 0) (> main@%_41_0 0)))
                (=> main@_bb18_0 (> main@%_1_0 0))
                (=> main@_bb18_0
                    (= main@%_42_0 (select main@%shadow.mem.4.2_0 main@%_41_0)))
                (=> main@_bb18_0 (= main@%_43_0 (= main@%_42_0 main@%.0.i_0)))
                (=> main@_bb18_0 (= main@%_44_0 (ite main@%_43_0 1 0)))
                (=> main@postcall_0 (and main@postcall_0 main@_bb18_0))
                (=> (and main@postcall_0 main@_bb18_0) main@%_45_0)
                (__JVERIFIER_assert main@postcall_0 false false main@%_44_0)
                (=> main@postcall_0 (= main@%_46_0 (+ main@%.0.i_0 1)))
                (=> main@_bb17_1 (and main@_bb17_1 main@postcall_0))
                (=> (and main@_bb17_1 main@postcall_0)
                    (= main@%.0.i_1 main@%_46_0))
                (=> (and main@_bb17_1 main@postcall_0)
                    (= main@%.0.i_2 main@%.0.i_1))
                main@_bb17_1)))
  (=> a!2 (main@_bb17 main@%_1_0 main@%shadow.mem.4.2_0 main@%.0.i_2)))))
(rule (let ((a!1 (=> main@_bb18_0
               (= main@%_41_0 (+ main@%_1_0 (* 0 400000) (* main@%.0.i_0 4))))))
(let ((a!2 (and (main@_bb17 main@%_1_0 main@%shadow.mem.4.2_0 main@%.0.i_0)
                true
                ...
                (=> (and main@precall_0 main@_bb18_0) (not main@%_45_0))
                (=> main@__JVERIFIER_assert_0
                    (and main@__JVERIFIER_assert_0 main@precall_0))
                (=> main@__JVERIFIER_assert_0 (= main@%_47_0 (= main@%_44_0 0)))
                (=> main@__JVERIFIER_assert_0 main@%_47_0)
