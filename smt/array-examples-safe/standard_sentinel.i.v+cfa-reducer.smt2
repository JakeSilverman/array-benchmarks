(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-CR_6nD/standard_sentinel.i.v+cfa-reducer.pp.ms.o.bc")
...
(let ((a!3 (and (main@_bb @__VERIFIER_nondet_int_0
                ...
                main@_bb6_0)))
  (=> a!3
      (main@_bb6 main@%_0_0 main@%.01.i_1 main@%_5_0 main@%sm1_0 main@%_3_0)))))
(rule (let ((a!1 (and (main@_bb6 main@%_0_0
                ...
                (=> main@_bb7_0 (= main@%_22_0 (+ main@%.01.i_0 1)))
                (=> main@_bb6_1 (and main@_bb6_1 main@_bb7_0))
                (=> (and main@_bb6_1 main@_bb7_0) (= main@%.01.i_1 main@%_22_0))
                (=> (and main@_bb6_1 main@_bb7_0)
                    (= main@%.01.i_2 main@%.01.i_1))
                main@_bb6_1)))
  (=> a!1
      (main@_bb6 main@%_0_0 main@%.01.i_2 main@%_5_0 main@%sm1_0 main@%_3_0))))
(rule (let ((a!1 (and (main@_bb6 main@%_0_0
                           main@%.01.i_0
                           main@%_5_0
                           main@%sm1_0
                ...
                (=> main@_bb8_0 (= main@%_24_0 (> main@%.01.i_0 main@%_5_0)))
                (=> main@_bb8_0 main@%_24_0)
