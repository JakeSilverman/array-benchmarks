(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-MO6CWm/standard_seq_init_ground.pp.ms.o.bc")
...
(rule (let ((a!1 (and main@entry
                ...
                (= main@%sm_0 (store main@%sm2_0 main@%_2_0 7))
                (=> main@_bb_0 (and main@_bb_0 main@entry_0))
                (=> (and main@_bb_0 main@entry_0)
                    (= main@%shadow.mem.0.0_0 main@%sm_0))
                (=> (and main@_bb_0 main@entry_0) (= main@%.01.i_0 1))
                (=> (and main@_bb_0 main@entry_0)
                    (= main@%shadow.mem.0.0_1 main@%shadow.mem.0.0_0))
                (=> (and main@_bb_0 main@entry_0)
                    (= main@%.01.i_1 main@%.01.i_0))
                main@_bb_0)))
  (=> a!1 (main@_bb main@%.01.i_1 main@%_0_0 main@%shadow.mem.0.0_1))))
(rule (let ((a!1 (= main@%_7_0 (+ (+ main@%_0_0 (* 0 400000)) (* main@%_6_0 4))))
      (a!2 (= main@%_10_0 (+ (+ main@%_0_0 (* 0 400000)) (* main@%.01.i_0 4)))))
(let ((a!3 (and (main@_bb main@%.01.i_0 main@%_0_0 main@%shadow.mem.0.0_0)
                true
                (= main@%_4_0 (< main@%.01.i_0 100000))
                (=> main@_bb3_0 (and main@_bb3_0 main@_bb_0))
                (=> (and main@_bb3_0 main@_bb_0) main@%_4_0)
                (=> main@_bb3_0 (= main@%_6_0 (+ main@%.01.i_0 (- 1))))
                (=> main@_bb3_0 a!1)
                (=> main@_bb3_0 (or (<= main@%_0_0 0) (> main@%_7_0 0)))
                (=> main@_bb3_0 (> main@%_0_0 0))
                (=> main@_bb3_0
                    (= main@%_8_0 (select main@%shadow.mem.0.0_0 main@%_7_0)))
                (=> main@_bb3_0 (= main@%_9_0 (+ main@%_8_0 1)))
                (=> main@_bb3_0 a!2)
                ...
                (=> main@_bb3_0 (= main@%_11_0 (+ main@%.01.i_0 1)))
                (=> main@_bb_1 (and main@_bb_1 main@_bb3_0))
                (=> (and main@_bb_1 main@_bb3_0)
                    (= main@%shadow.mem.0.0_1 main@%sm1_0))
                (=> (and main@_bb_1 main@_bb3_0) (= main@%.01.i_1 main@%_11_0))
                (=> (and main@_bb_1 main@_bb3_0)
                    (= main@%shadow.mem.0.0_2 main@%shadow.mem.0.0_1))
                (=> (and main@_bb_1 main@_bb3_0)
                    (= main@%.01.i_2 main@%.01.i_1))
                main@_bb_1)))
  (=> a!3 (main@_bb main@%.01.i_2 main@%_0_0 main@%shadow.mem.0.0_2)))))
(rule (=> (and (main@_bb main@%.01.i_0 main@%_0_0 main@%shadow.mem.0.0_0)
         true
         (= main@%_4_0 (< main@%.01.i_0 100000))
         (=> main@_bb4_0 (and main@_bb4_0 main@_bb_0))
         (=> (and main@_bb4_0 main@_bb_0) (not main@%_4_0))
         (=> main@_bb5_0 (and main@_bb5_0 main@_bb4_0))
         (=> (and main@_bb5_0 main@_bb4_0) (= main@%.0.i_0 1))
         (=> (and main@_bb5_0 main@_bb4_0) (= main@%.0.i_1 main@%.0.i_0))
         main@_bb5_0)
    (main@_bb5 main@%_0_0 main@%shadow.mem.0.0_0 main@%.0.i_1)))
(rule (let ((a!1 (= main@%_16_0 (+ (+ main@%_0_0 (* 0 400000)) (* main@%.0.i_0 4))))
      (a!2 (= main@%_19_0 (+ (+ main@%_0_0 (* 0 400000)) (* main@%_18_0 4)))))
(let ((a!3 (and (main@_bb5 main@%_0_0 main@%shadow.mem.0.0_0 main@%.0.i_0)
                true
                (= main@%_14_0 (< main@%.0.i_0 100000))
                main@%_14_0
                ...
                (=> main@_bb6_0 (= main@%_21_0 (>= main@%_17_0 main@%_20_0)))
                (=> main@_bb6_0 (= main@%_22_0 (ite main@%_21_0 1 0)))
                (=> main@postcall_0 (and main@postcall_0 main@_bb6_0))
                (=> (and main@postcall_0 main@_bb6_0) main@%_23_0)
                (__JVERIFIER_assert main@postcall_0 false false main@%_22_0)
                (=> main@postcall_0 (= main@%_24_0 (+ main@%.0.i_0 1)))
                ...
                main@_bb5_1)))
  (=> a!3 (main@_bb5 main@%_0_0 main@%shadow.mem.0.0_0 main@%.0.i_2)))))
(rule (let ((a!1 (= main@%_16_0 (+ (+ main@%_0_0 (* 0 400000)) (* main@%.0.i_0 4))))
      (a!2 (= main@%_19_0 (+ (+ main@%_0_0 (* 0 400000)) (* main@%_18_0 4)))))
(let ((a!3 (and (main@_bb5 main@%_0_0 main@%shadow.mem.0.0_0 main@%.0.i_0)
                true
                ...
                (=> (and main@precall_0 main@_bb6_0) (not main@%_23_0))
