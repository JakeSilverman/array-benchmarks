(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-Pcq4lS/break-2.pp.ms.o.bc")
...
(rule (=> (and (main@entry main@%sm2_0)
         ...
         main@_bb_0)
    (main@_bb @s_0 main@%shadow.mem.0.0_1 main@%.0.i_1)))
(rule (let ((a!1 (=> main@_bb3_0
               (= main@%_3_0 (+ @s_0 (* 0 4000000) (* main@%.0.i_0 4) 0)))))
(let ((a!2 (and (main@_bb @s_0 main@%shadow.mem.0.0_0 main@%.0.i_0)
                true
                (= main@%_1_0 (> main@%.0.i_0 500000))
                (=> main@_bb3_0 (and main@_bb3_0 main@_bb_0))
                (=> (and main@_bb3_0 main@_bb_0) (not main@%_1_0))
                a!1
                (=> main@_bb3_0 (or (<= @s_0 0) (> main@%_3_0 0)))
                (=> main@_bb3_0 (> @s_0 0))
                (=> main@_bb3_0
                ...
                main@_bb_1)))
  (=> a!2 (main@_bb @s_0 main@%shadow.mem.0.0_2 main@%.0.i_2)))))
(rule (=> (and (main@_bb @s_0 main@%shadow.mem.0.0_0 main@%.0.i_0)
         true
         (= main@%_1_0 (> main@%.0.i_0 500000))
         ...
         main@_bb5_0)
    (main@_bb5 main@%.1.i_1 main@%shadow.mem.0.1_1 @s_0)))
(rule (let ((a!1 (=> main@_bb7_0
               (= main@%_11_0 (+ @s_0 (* 0 4000000) (* main@%.1.i_0 4) 0)))))
(let ((a!2 (and (main@_bb5 main@%.1.i_0 main@%shadow.mem.0.1_0 @s_0)
                true
                (= main@%_7_0 (< main@%.1.i_0 1000000))
                main@%_7_0
                (=> main@_bb6_0 (and main@_bb6_0 main@_bb5_0))
                (=> main@_bb6_0 (= main@%_9_0 (< main@%.1.i_0 500001)))
                (=> main@_bb7_0 (and main@_bb7_0 main@_bb6_0))
                (=> (and main@_bb7_0 main@_bb6_0) main@%_9_0)
                a!1
                (=> main@_bb7_0 (or (<= @s_0 0) (> main@%_11_0 0)))
                (=> main@_bb7_0 (> @s_0 0))
                (=> main@_bb7_0
                    (= main@%_12_0 (select main@%shadow.mem.0.1_0 main@%_11_0)))
                (=> main@_bb7_0 (= main@%_13_0 (= main@%_12_0 10)))
                (=> main@_bb7_0 (= main@%_14_0 (ite main@%_13_0 1 0)))
                (=> main@postcall_0 (and main@postcall_0 main@_bb7_0))
                (=> (and main@postcall_0 main@_bb7_0) main@%_15_0)
                (__JVERIFIER_assert
                  main@postcall_0
                  false
                  false
                ...
                (=> |tuple(main@_bb6_0, main@_bb8_0)| (not main@%_9_0))
                ...
                (=> (and main@_bb5_1 main@_bb8_0) (= main@%.1.i_1 main@%_17_0))
                (=> (and main@_bb5_1 main@_bb8_0)
                    (= main@%shadow.mem.0.1_2 main@%shadow.mem.0.1_1))
                (=> (and main@_bb5_1 main@_bb8_0) (= main@%.1.i_2 main@%.1.i_1))
                main@_bb5_1)))
  (=> a!2 (main@_bb5 main@%.1.i_2 main@%shadow.mem.0.1_2 @s_0)))))
(rule (let ((a!1 (=> main@_bb7_0
               (= main@%_11_0 (+ @s_0 (* 0 4000000) (* main@%.1.i_0 4) 0)))))
(let ((a!2 (and (main@_bb5 main@%.1.i_0 main@%shadow.mem.0.1_0 @s_0)
                true
                ...
                (=> (and main@precall_0 main@_bb7_0) (not main@%_15_0))
                (=> main@__JVERIFIER_assert_0
                    (and main@__JVERIFIER_assert_0 main@precall_0))
                (=> main@__JVERIFIER_assert_0 (= main@%_18_0 (= main@%_14_0 0)))
                (=> main@__JVERIFIER_assert_0 main@%_18_0)
