(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-l_3ceD/break-1.pp.ms.o.bc")
...
(declare-rel main@_bb (Int Int (Array Int Int) (Array Int Int) Int ))
...
(rule (=> (__VERIFIER_assert@_call1 __VERIFIER_assert@%sm_0 __VERIFIER_assert@arg.0_0)
    (__VERIFIER_assert
      ...
      __VERIFIER_assert@%sm_0
      __VERIFIER_assert@arg.0_0)))
(rule (main@entry main@%sm2_0 main@%sm3_0))
(rule (=> (and (main@entry main@%sm2_0 main@%sm3_0)
         true
         ...
         main@_bb_0)
    (main@_bb @s_0 main@%_0_0 main@%shadow.mem.0.0_1 main@%sm2_0 main@%.0.i_1)))
(rule (let ((a!1 (=> main@_bb4_0
               (= main@%_5_0 (+ @s_0 (* 0 4000000) (* main@%.0.i_0 4) 0)))))
(let ((a!2 (and (main@_bb @s_0
                          main@%_0_0
                          main@%shadow.mem.0.0_0
                          main@%sm2_0
                          main@%.0.i_0)
                true
                (= main@%_2_0 (> main@%.0.i_0 999999))
                (= main@%_3_0 (> main@%_0_0 5))
                (= main@%or.cond.i_0 (or main@%_2_0 main@%_3_0))
                (=> main@_bb4_0 (and main@_bb4_0 main@_bb_0))
                (=> (and main@_bb4_0 main@_bb_0) (not main@%or.cond.i_0))
                (=> main@_bb4_0 (> main@%malloc2.i_0 0))
                a!1
                (=> main@_bb4_0 (or (<= @s_0 0) (> main@%_5_0 0)))
                (=> main@_bb4_0 (> @s_0 0))
                (=> main@_bb4_0
                    (= main@%sm1_0
                       (store main@%shadow.mem.0.0_0
                              main@%_5_0
                              main@%malloc2.i_0)))
                (=> main@_bb4_0 (= main@%_6_0 (+ main@%.0.i_0 1)))
                (=> main@_bb_1 (and main@_bb_1 main@_bb4_0))
                (=> (and main@_bb_1 main@_bb4_0)
                    (= main@%shadow.mem.0.0_1 main@%sm1_0))
                (=> (and main@_bb_1 main@_bb4_0) (= main@%.0.i_1 main@%_6_0))
                (=> (and main@_bb_1 main@_bb4_0)
                    (= main@%shadow.mem.0.0_2 main@%shadow.mem.0.0_1))
                (=> (and main@_bb_1 main@_bb4_0) (= main@%.0.i_2 main@%.0.i_1))
                main@_bb_1)))
  (=> a!2
      (main@_bb @s_0 main@%_0_0 main@%shadow.mem.0.0_2 main@%sm2_0 main@%.0.i_2)))))
(rule (=> (and (main@_bb @s_0
                   main@%_0_0
                   main@%shadow.mem.0.0_0
                   main@%sm2_0
                   main@%.0.i_0)
         ...
         (=> (and main@_bb5_0 main@_bb_0) main@%or.cond.i_0)
         ...
         main@_bb6_0)
    (main@_bb6 main@%.1.i_1 main@%shadow.mem.0.1_1 @s_0 main@%_0_0)))
(rule (let ((a!1 (=> main@_bb8_0
               (= main@%_13_0 (+ @s_0 (* 0 4000000) (* main@%.1.i_0 4) 0))))
      (a!2 (=> main@_bb8_0 (= main@%_15_0 (not (= main@%_14_0 0))))))
(let ((a!3 (and (main@_bb6 main@%.1.i_0 main@%shadow.mem.0.1_0 @s_0 main@%_0_0)
                true
                (= main@%_9_0 (< main@%.1.i_0 1000000))
                main@%_9_0
                (=> main@_bb7_0 (and main@_bb7_0 main@_bb6_0))
                (=> main@_bb7_0 (= main@%_11_0 (< main@%_0_0 6)))
                (=> main@_bb8_0 (and main@_bb8_0 main@_bb7_0))
                (=> (and main@_bb8_0 main@_bb7_0) main@%_11_0)
                a!1
                (=> main@_bb8_0 (or (<= @s_0 0) (> main@%_13_0 0)))
                (=> main@_bb8_0 (> @s_0 0))
                (=> main@_bb8_0
                    (= main@%_14_0 (select main@%shadow.mem.0.1_0 main@%_13_0)))
                a!2
                (=> main@_bb8_0 (= main@%_16_0 (ite main@%_15_0 1 0)))
                (=> main@postcall_0 (and main@postcall_0 main@_bb8_0))
                (=> (and main@postcall_0 main@_bb8_0) main@%_17_0)
                (__VERIFIER_assert
                  main@postcall_0
                  false
                  false
                ...
                (=> main@_bb9_0
                    (or (and main@_bb9_0 main@postcall_0)
                        |tuple(main@_bb7_0, main@_bb9_0)|))
                (=> |tuple(main@_bb7_0, main@_bb9_0)| (not main@%_11_0))
                (=> (and main@_bb9_0 main@postcall_0)
                ...
                main@_bb6_1)))
  (=> a!3 (main@_bb6 main@%.1.i_2 main@%shadow.mem.0.1_2 @s_0 main@%_0_0)))))
(rule (let ((a!1 (=> main@_bb8_0
               (= main@%_13_0 (+ @s_0 (* 0 4000000) (* main@%.1.i_0 4) 0))))
      (a!2 (=> main@_bb8_0 (= main@%_15_0 (not (= main@%_14_0 0))))))
(let ((a!3 (and (main@_bb6 main@%.1.i_0 main@%shadow.mem.0.1_0 @s_0 main@%_0_0)
                ...
                (=> (and main@precall_0 main@_bb8_0) (not main@%_17_0))
                (=> main@__VERIFIER_assert_0
                    (and main@__VERIFIER_assert_0 main@precall_0))
                (=> main@__VERIFIER_assert_0 (= main@%_20_0 (= main@%_16_0 0)))
