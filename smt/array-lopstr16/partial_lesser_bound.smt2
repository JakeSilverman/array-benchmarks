(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-3bHEFL/partial_lesser_bound.pp.ms.o.bc")
...
(rule (=> (__JVERIFIER_assert@_call1 __JVERIFIER_assert@%sm_0 __JVERIFIER_assert@arg.0_0)
    (__JVERIFIER_assert
      ...
      __JVERIFIER_assert@%sm_0
      __JVERIFIER_assert@arg.0_0)))
(rule (main@entry main@%sm3_0 main@%sm4_0))
(rule (=> (and (main@entry main@%sm3_0 main@%sm4_0)
         true
         (= main@%sm_0 main@%sm4_0)
         ...
         main@_bb_0)
    (main@_bb @a_0 main@%i.0.i_1 main@%shadow.mem.0.0_1 main@%sm3_0)))
(rule (let ((a!1 (=> main@_bb5_0
               (= main@%_3_0 (+ @a_0 (* 0 4000000) (* main@%i.0.i_0 4))))))
(let ((a!2 (and (main@_bb @a_0 main@%i.0.i_0 main@%shadow.mem.0.0_0 main@%sm3_0)
                true
                (= main@%_1_0 (< main@%i.0.i_0 1000000))
                ...
                main@_bb_1)))
  (=> a!2 (main@_bb @a_0 main@%i.0.i_2 main@%shadow.mem.0.0_2 main@%sm3_0)))))
(rule (=> (and (main@_bb @a_0 main@%i.0.i_0 main@%shadow.mem.0.0_0 main@%sm3_0)
         true
         (= main@%_1_0 (< main@%i.0.i_0 1000000))
         ...
         main@_bb7_0)
    (main@_bb7 @a_0 main@%sm3_0 main@%i.1.i_1 main@%shadow.mem.0.1_1)))
(rule (let ((a!1 (=> main@_bb8_0
               (= main@%_9_0 (+ @a_0 (* 0 4000000) (* main@%i.1.i_0 4))))))
(let ((a!2 (and (main@_bb7 @a_0
                           main@%sm3_0
                           main@%i.1.i_0
                           main@%shadow.mem.0.1_0)
                true
                (= main@%_7_0 (< main@%i.1.i_0 500000))
                ...
                main@_bb7_1)))
  (=> a!2 (main@_bb7 @a_0 main@%sm3_0 main@%i.1.i_2 main@%shadow.mem.0.1_2)))))
(rule (=> (and (main@_bb7 @a_0 main@%sm3_0 main@%i.1.i_0 main@%shadow.mem.0.1_0)
         true
         (= main@%_7_0 (< main@%i.1.i_0 500000))
