(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-q_syNi/array_of_struct_ptr_mul_init.pp.ms.o.bc")
...
(let ((a!3 (and (main@_bb13 @a_0 main@%shadow.mem.0.3_0 main@%.2.i_0)
                ...
                (=> main@__JVERIFIER_assert_0 (= main@%_50_0 (= main@%_47_0 0)))
                (=> main@__JVERIFIER_assert_0 main@%_50_0)
