(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-jaPtGv/array_ptr_single_elem_init-1.pp.ms.o.bc")
...
(rule (=> (__JVERIFIER_assert@_call2
    ...
    (__JVERIFIER_assert
      ...
      __JVERIFIER_assert@%sm1_0
      __JVERIFIER_assert@arg.0_0)))
(rule (main@entry main@%sm8_0 main@%sm9_0 main@%sm7_0))
(rule (=> (and (main@entry main@%sm8_0 main@%sm9_0 main@%sm7_0)
         true
    ...
    (main@_bb @a_0
              ...
              main@%sm8_0)))
(rule (let ((a!1 (=> main@_bb11_0 (= main@%_7_0 (+ main@%malloc7.i_0 (* 0 8) 4))))
      (a!2 (= main@%_11_0 (+ (+ main@%.0.i_2 (* 0 8)) 4)))
      (a!3 (= main@%_17_0 (+ (+ main@%.0.i_2 (* 0 8)) 0)))
      (a!4 (= main@%_15_0 (+ (+ main@%.0.i_2 (* 0 8)) 0)))
      (a!5 (=> main@_bb16_0
               (= main@%_19_0 (+ @a_0 (* 0 400000) (* main@%.04.i_0 4))))))
(let ((a!6 (and (main@_bb @a_0
                          ...
                          main@%sm8_0)
                true
                (= main@%_1_0 (< main@%.04.i_0 100000))
                (=> main@_bb10_0 (and main@_bb10_0 main@_bb_0))
                (=> (and main@_bb10_0 main@_bb_0) main@%_1_0)
                (=> main@_bb10_0 (= main@%_4_0 (= main@%_3_0 0)))
                (=> main@_bb11_0 (and main@_bb11_0 main@_bb10_0))
                (=> (and main@_bb11_0 main@_bb10_0) main@%_4_0)
                (=> main@_bb11_0 (> main@%malloc7.i_0 0))
                (=> main@_bb11_0 (= main@%_6_0 (rem main@%_3_0 2)))
                a!1
                (=> main@_bb11_0 (or (<= main@%malloc7.i_0 0) (> main@%_7_0 0)))
                (=> main@_bb11_0 (> main@%malloc7.i_0 0))
                (=> main@_bb11_0
                    (= main@%sm1_0
                ...
                (=> |tuple(main@_bb10_0, main@_bb12_0)| (not main@%_4_0))
                ...
                (=> main@_bb12_0 (= main@%_9_0 (= main@%.0.i_2 0)))
                (=> main@_bb13_0 (and main@_bb13_0 main@_bb12_0))
                (=> (and main@_bb13_0 main@_bb12_0) (not main@%_9_0))
                (=> main@_bb13_0 a!2)
                (=> main@_bb13_0 (or (<= main@%.0.i_2 0) (> main@%_11_0 0)))
                (=> main@_bb13_0 (> main@%.0.i_2 0))
                (=> main@_bb13_0
                    (= main@%_12_0 (select main@%shadow.mem.0.1_2 main@%_11_0)))
                (=> main@_bb13_0 (= main@%_13_0 (= main@%_12_0 0)))
                (=> main@_bb15_0 (and main@_bb15_0 main@_bb13_0))
                (=> (and main@_bb15_0 main@_bb13_0) (not main@%_13_0))
                (=> main@_bb15_0 a!3)
                (=> main@_bb15_0 (or (<= main@%.0.i_2 0) (> main@%_17_0 0)))
                (=> main@_bb15_0
                    (= main@%sm3_0 (store main@%shadow.mem.0.1_2 main@%_17_0 0)))
                (=> main@_bb14_0 (and main@_bb14_0 main@_bb13_0))
                (=> (and main@_bb14_0 main@_bb13_0) main@%_13_0)
                (=> main@_bb14_0 (> main@%malloc16.i_0 0))
                (=> main@_bb14_0 a!4)
                (=> main@_bb14_0 (or (<= main@%.0.i_2 0) (> main@%_15_0 0)))
                (=> main@_bb14_0
                    (= main@%sm2_0
                ...
                (=> |tuple(main@_bb12_0, main@_bb16_0)| main@%_9_0)
                ...
                a!5
                (=> main@_bb16_0 (or (<= @a_0 0) (> main@%_19_0 0)))
                (=> main@_bb16_0 (> @a_0 0))
                (=> main@_bb16_0
                    (= main@%sm4_0
                       (store main@%shadow.mem.8.0_0 main@%_19_0 main@%.0.i_2)))
                (=> main@_bb16_0 (= main@%_20_0 (+ main@%.04.i_0 1)))
                ...
                (=> (and main@_bb_1 main@_bb16_0) (= main@%.04.i_1 main@%_20_0))
                (=> (and main@_bb_1 main@_bb16_0)
  ...
  (=> a!6
      (main@_bb @a_0
                ...
                main@%sm8_0)))))
(rule (let ((a!1 (=> main@_bb17_0 (= main@%_22_0 (+ @a_0 (* 0 400000) (* 3 4))))))
(let ((a!2 (and (main@_bb @a_0
                ...
                a!1
                (=> main@_bb17_0 (or (<= @a_0 0) (> main@%_22_0 0)))
                (=> main@_bb17_0 (> @a_0 0))
                (=> main@_bb17_0
                    (= main@%sm5_0
...
(rule (let ((a!1 (=> main@_bb19_0
               (= main@%_26_0 (+ @a_0 (* 0 400000) (* main@%.1.i_0 4)))))
      (a!2 (=> main@_bb19_0 (= main@%_28_0 (not (= main@%.1.i_0 3)))))
      (a!3 (=> main@_bb19_0 (= main@%_29_0 (not (= main@%_27_0 0)))))
      (a!4 (= main@%_31_0 (+ (+ main@%_27_0 (* 0 8)) 4)))
      (a!5 (= main@%_35_0 (+ (+ main@%_27_0 (* 0 8)) 0)))
      (a!6 (=> main@_bb21_0 (= main@%_37_0 (not (= main@%_36_0 0))))))
(let ((a!7 (and (main@_bb18 @a_0
                            main@%.1.i_0
                            main@%shadow.mem.8.1_0
                            main@%shadow.mem.0.3_0)
                true
                (= main@%_24_0 (< main@%.1.i_0 100000))
                main@%_24_0
                (=> main@_bb19_0 (and main@_bb19_0 main@_bb18_0))
                a!1
                (=> main@_bb19_0 (or (<= @a_0 0) (> main@%_26_0 0)))
                (=> main@_bb19_0 (> @a_0 0))
                (=> main@_bb19_0
                    (= main@%_27_0 (select main@%shadow.mem.8.1_0 main@%_26_0)))
                a!2
                a!3
                (=> main@_bb19_0
                ...
                (=> |tuple(main@_bb20_0, main@_bb22_0)| (not main@%_33_0))
                ...
                (=> main@_bb22_0 (= main@%_41_0 (+ main@%.1.i_0 1)))
...
(let ((a!7 (and (main@_bb18 @a_0
                ...
                (=> (and main@precall_0 main@_bb21_0) (not main@%_39_0))
                (=> main@__JVERIFIER_assert_0
                    (and main@__JVERIFIER_assert_0 main@precall_0))
                (=> main@__JVERIFIER_assert_0 (= main@%_42_0 (= main@%_38_0 0)))
                (=> main@__JVERIFIER_assert_0 main@%_42_0)
