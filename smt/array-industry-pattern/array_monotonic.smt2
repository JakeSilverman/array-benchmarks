(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-p0t1to/array_monotonic.pp.ms.o.bc")
...
(declare-rel main@_bb (Int (Array Int Int) (Array Int Int) Int Int Int ))
(declare-rel main@_bb8 ((Array Int Int) (Array Int Int) Int Int Int ))
...
(rule (let ((a!1 (=> main@_bb4_0
      ...
      (a!2 (=> main@_bb5_0
               (= main@%_12_0 (+ main@%_1_0 (* 0 400000) (* main@%.0.i_0 4))))))
(let ((a!3 (and (main@_bb main@%.0.i_0
                ...
                (=> main@_bb6_0 (= main@%_14_0 (+ main@%.0.i_0 2)))
                ...
                (=> (and main@_bb_1 main@_bb6_0) (= main@%.0.i_1 main@%_14_0))
                (=> (and main@_bb_1 main@_bb6_0)
...
(rule (=> (and (main@_bb main@%.0.i_0
         ...
         main@_bb8_0)
    (main@_bb8 main@%shadow.mem.4.0_0
               main@%shadow.mem.0.0_0
               main@%_1_0
               main@%_0_0
               main@%.1.i_1)))
(rule (let ((a!1 (=> main@_bb9_0
               (= main@%_19_0 (+ main@%_0_0 (* 0 400000) (* main@%.1.i_0 4)))))
      (a!2 (=> main@_bb10_0
               (= main@%_23_0 (+ main@%_1_0 (* 0 400000) (* main@%.1.i_0 4))))))
(let ((a!3 (and (main@_bb8 main@%shadow.mem.4.0_0
                           main@%shadow.mem.0.0_0
                           main@%_1_0
                           main@%_0_0
                           main@%.1.i_0)
                ...
                (=> main@_bb9_0 (= main@%_21_0 (= main@%_20_0 10)))
                ...
                (=> main@_bb10_0
                    (= main@%_24_0 (select main@%shadow.mem.4.0_0 main@%_23_0)))
                (=> main@_bb10_0 (= main@%_25_0 (= main@%_24_0 20)))
                (=> main@_bb10_0 (= main@%_26_0 (ite main@%_25_0 1 0)))
                (=> main@postcall_0 (and main@postcall_0 main@_bb10_0))
                (=> (and main@postcall_0 main@_bb10_0) main@%_27_0)
                (__VERIFIER_assert main@postcall_0 false false main@%_26_0)
                ...
                (=> main@_bb11_0 (= main@%_29_0 (+ main@%.1.i_0 2)))
                (=> main@_bb8_1 (and main@_bb8_1 main@_bb11_0))
                (=> (and main@_bb8_1 main@_bb11_0) (= main@%.1.i_1 main@%_29_0))
...
(let ((a!3 (and (main@_bb8 main@%shadow.mem.4.0_0
                ...
                (=> (and main@precall_0 main@_bb10_0) (not main@%_27_0))
