(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-Tb_rnB/rev-2-n-u.pp.ms.o.bc")
...
(declare-rel main@_bb9 (Int (Array Int Int) Int Int (Array Int Int) ))
(declare-rel main@_bb15 (Int (Array Int Int) Int (Array Int Int) Int ))
(declare-rel main@_bb17 (Int (Array Int Int) Int (Array Int Int) Int Int ))
(declare-rel main@verifier.error.split ())
(declare-rel main@_bb11 (Int (Array Int Int) Int Int Int (Array Int Int) ))
...
(rule (=> (and (main@_bb @__VERIFIER_nondet_int_0
    ...
    (main@_bb5 @__VERIFIER_nondet_int_0
               ...
               main@%_0_0
               main@%sm3_0)))
(rule (=> (and (main@_bb9 main@%_1_0
                    main@%shadow.mem.4.0_0
                    main@%.1.i_0
                    main@%_0_0
                    main@%shadow.mem.0.0_0)
         true
         (= main@%_20_0 (< main@%.1.i_0 1000))
         (=> main@_bb14_0 (and main@_bb14_0 main@_bb9_0))
         (=> (and main@_bb14_0 main@_bb9_0) (not main@%_20_0))
...
(rule (=> (and (main@_bb9 main@%_1_0
         ...
         (=> (and main@_bb10_0 main@_bb9_0) main@%_20_0)
...
(rule (let ((a!1 (=> main@_bb18_0
               (= main@%_47_0 (+ main@%_0_0 (* 0 6000000) (* main@%_46_0 4)))))
      (a!2 (=> main@_bb18_0 (= main@%_48_0 (+ main@%_47_0 (* main@%.23.i_0 4)))))
      (a!3 (=> main@_bb18_0
               (= main@%_53_0 (+ main@%_1_0 (* 0 6000000) (* main@%_52_0 4)))))
      (a!4 (=> main@_bb18_0 (= main@%_56_0 (+ main@%_53_0 (* main@%_55_0 4))))))
(let ((a!5 (and (main@_bb17 main@%_1_0
                            main@%shadow.mem.4.0_0
                            main@%_0_0
                            main@%shadow.mem.0.0_0
                            main@%.23.i_0
                ...
                (=> main@_bb18_0 (= main@%_46_0 (* main@%.2.i_0 1500)))
                a!1
                (=> main@_bb18_0 (or (<= main@%_0_0 0) (> main@%_47_0 0)))
                a!2
                (=> main@_bb18_0 (or (<= main@%_47_0 0) (> main@%_48_0 0)))
                (=> main@_bb18_0 (> main@%_47_0 0))
                (=> main@_bb18_0
                    (= main@%_49_0 (select main@%shadow.mem.0.0_0 main@%_48_0)))
                (=> main@_bb18_0 (= main@%_50_0 (- 1000 main@%.2.i_0)))
                (=> main@_bb18_0 (= main@%_51_0 (* main@%_50_0 1500)))
                (=> main@_bb18_0 (= main@%_52_0 (+ main@%_51_0 (- 1500))))
                a!3
                (=> main@_bb18_0 (or (<= main@%_1_0 0) (> main@%_53_0 0)))
                (=> main@_bb18_0 (= main@%_54_0 (- 1500 main@%.23.i_0)))
                (=> main@_bb18_0 (= main@%_55_0 (+ main@%_54_0 (- 1))))
                a!4
                (=> main@_bb18_0 (or (<= main@%_53_0 0) (> main@%_56_0 0)))
                (=> main@_bb18_0 (> main@%_53_0 0))
                (=> main@_bb18_0
                    (= main@%_57_0 (select main@%shadow.mem.4.0_0 main@%_56_0)))
                (=> main@_bb18_0 (= main@%_58_0 (= main@%_49_0 main@%_57_0)))
                (=> main@_bb18_0 (= main@%_59_0 (ite main@%_58_0 1 0)))
                (=> main@postcall_0 (and main@postcall_0 main@_bb18_0))
                (=> (and main@postcall_0 main@_bb18_0) main@%_60_0)
                (__JVERIFIER_assert main@postcall_0 false false main@%_59_0)
                (=> main@postcall_0 (= main@%_61_0 (+ main@%.23.i_0 1)))
                (=> main@_bb17_1 (and main@_bb17_1 main@postcall_0))
                (=> (and main@_bb17_1 main@postcall_0)
                    (= main@%.23.i_1 main@%_61_0))
                (=> (and main@_bb17_1 main@postcall_0)
...
(let ((a!5 (and (main@_bb17 main@%_1_0
                ...
                (=> (and main@precall_0 main@_bb18_0) (not main@%_60_0))
                (=> main@__JVERIFIER_assert_0
                    (and main@__JVERIFIER_assert_0 main@precall_0))
                (=> main@__JVERIFIER_assert_0 (= main@%_64_0 (= main@%_59_0 0)))
...
(rule (let ((a!1 (and (main@_bb11 main@%_1_0
                            main@%shadow.mem.4.0_0
                            main@%.1.i_0
                            main@%.12.i_0
                            main@%_0_0
                ...
                true
                (= main@%_23_0 (< main@%.12.i_0 1500))
                (=> main@_bb13_0 (and main@_bb13_0 main@_bb11_0))
                (=> (and main@_bb13_0 main@_bb11_0) (not main@%_23_0))
                (=> main@_bb13_0 (= main@%_38_0 (+ main@%.1.i_0 1)))
                (=> main@_bb9_0 (and main@_bb9_0 main@_bb13_0))
                (=> (and main@_bb9_0 main@_bb13_0)
                    (= main@%shadow.mem.0.0_0 main@%shadow.mem.0.1_0))
                (=> (and main@_bb9_0 main@_bb13_0) (= main@%.1.i_1 main@%_38_0))
                (=> (and main@_bb9_0 main@_bb13_0)
                    (= main@%shadow.mem.0.0_1 main@%shadow.mem.0.0_0))
                (=> (and main@_bb9_0 main@_bb13_0)
...
(rule (let ((a!1 (=> main@_bb12_0
               (= main@%_28_0 (+ main@%_1_0 (* 0 6000000) (* main@%_27_0 4)))))
      (a!2 (=> main@_bb12_0 (= main@%_31_0 (+ main@%_28_0 (* main@%_30_0 4)))))
      (a!3 (=> main@_bb12_0
               (= main@%_34_0 (+ main@%_0_0 (* 0 6000000) (* main@%_33_0 4)))))
      (a!4 (=> main@_bb12_0 (= main@%_35_0 (+ main@%_34_0 (* main@%.12.i_0 4))))))
(let ((a!5 (and (main@_bb11 main@%_1_0
                            main@%shadow.mem.4.0_0
                            main@%.1.i_0
                            main@%.12.i_0
                            main@%_0_0
                ...
                (=> (and main@_bb12_0 main@_bb11_0) main@%_23_0)
                (=> main@_bb12_0 (= main@%_25_0 (- 1000 main@%.1.i_0)))
                (=> main@_bb12_0 (= main@%_26_0 (* main@%_25_0 1500)))
                (=> main@_bb12_0 (= main@%_27_0 (+ main@%_26_0 (- 1500))))
                a!1
                (=> main@_bb12_0 (or (<= main@%_1_0 0) (> main@%_28_0 0)))
                (=> main@_bb12_0 (= main@%_29_0 (- 1500 main@%.12.i_0)))
                (=> main@_bb12_0 (= main@%_30_0 (+ main@%_29_0 (- 1))))
                a!2
                (=> main@_bb12_0 (or (<= main@%_28_0 0) (> main@%_31_0 0)))
                (=> main@_bb12_0 (> main@%_28_0 0))
                (=> main@_bb12_0
                    (= main@%_32_0 (select main@%shadow.mem.4.0_0 main@%_31_0)))
                (=> main@_bb12_0 (= main@%_33_0 (* main@%.1.i_0 1500)))
                a!3
                (=> main@_bb12_0 (or (<= main@%_0_0 0) (> main@%_34_0 0)))
                a!4
                (=> main@_bb12_0 (or (<= main@%_34_0 0) (> main@%_35_0 0)))
                (=> main@_bb12_0 (> main@%_34_0 0))
                (=> main@_bb12_0
                    (= main@%sm1_0
                       (store main@%shadow.mem.0.1_0 main@%_35_0 main@%_32_0)))
                (=> main@_bb12_0 (= main@%_36_0 (+ main@%.12.i_0 1)))
                (=> main@_bb11_1 (and main@_bb11_1 main@_bb12_0))
                (=> (and main@_bb11_1 main@_bb12_0)
                    (= main@%shadow.mem.0.1_1 main@%sm1_0))
                (=> (and main@_bb11_1 main@_bb12_0)
                    (= main@%.12.i_1 main@%_36_0))
                (=> (and main@_bb11_1 main@_bb12_0)
...
(rule (let ((a!1 (and (main@_bb5 @__VERIFIER_nondet_int_0
                ...
                (=> (and main@_bb7_0 main@_bb5_0) (not main@%_8_0))
                (=> main@_bb7_0 (= main@%_17_0 (+ main@%.0.i_0 1)))
                (=> main@_bb_0 (and main@_bb_0 main@_bb7_0))
                (=> (and main@_bb_0 main@_bb7_0)
                    (= main@%shadow.mem.4.0_0 main@%shadow.mem.4.1_0))
                (=> (and main@_bb_0 main@_bb7_0) (= main@%.0.i_1 main@%_17_0))
                (=> (and main@_bb_0 main@_bb7_0)
                    (= main@%shadow.mem.4.0_1 main@%shadow.mem.4.0_0))
                (=> (and main@_bb_0 main@_bb7_0) (= main@%.0.i_2 main@%.0.i_1))
                main@_bb_0)))
  (=> a!1
      (main@_bb @__VERIFIER_nondet_int_0
                main@%.0.i_2
...
(rule (let ((a!1 (=> main@_bb6_0
               (= main@%_13_0 (+ main@%_1_0 (* 0 6000000) (* main@%_12_0 4)))))
      (a!2 (=> main@_bb6_0 (= main@%_14_0 (+ main@%_13_0 (* main@%.01.i_0 4))))))
(let ((a!3 (and (main@_bb5 @__VERIFIER_nondet_int_0
                           main@%.0.i_0
                           main@%_1_0
                           main@%.01.i_0
                           main@%shadow.mem.4.1_0
                ...
                (=> main@_bb6_0 (= main@%_10_0 @__VERIFIER_nondet_int_0))
                (=> main@_bb6_0 (= main@%_12_0 (* main@%.0.i_0 1500)))
                a!1
                (=> main@_bb6_0 (or (<= main@%_1_0 0) (> main@%_13_0 0)))
                a!2
                (=> main@_bb6_0 (or (<= main@%_13_0 0) (> main@%_14_0 0)))
                (=> main@_bb6_0 (> main@%_13_0 0))
                (=> main@_bb6_0
                    (= main@%sm_0
                       (store main@%shadow.mem.4.1_0 main@%_14_0 main@%_11_0)))
                (=> main@_bb6_0 (= main@%_15_0 (+ main@%.01.i_0 1)))
                (=> main@_bb5_1 (and main@_bb5_1 main@_bb6_0))
                (=> (and main@_bb5_1 main@_bb6_0)
                    (= main@%shadow.mem.4.1_1 main@%sm_0))
                (=> (and main@_bb5_1 main@_bb6_0) (= main@%.01.i_1 main@%_15_0))
                (=> (and main@_bb5_1 main@_bb6_0)
