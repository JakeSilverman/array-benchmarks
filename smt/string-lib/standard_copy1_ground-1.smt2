(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-0IKgQM/standard_copy1_ground-1.pp.ms.o.bc")
...
(let ((a!3 (and (main@_bb9 main@%_0_0
                ...
                (=> main@__VERIFIER_assert.exit.i_0
                    (and main@__VERIFIER_assert.exit.i_0 main@_bb10_0))
                (=> (and main@__VERIFIER_assert.exit.i_0 main@_bb10_0)
                    (not main@%_31_0))
                (=> main@__VERIFIER_assert.exit.i_0
                    (= main@%_33_0 (+ main@%.0.i_0 1)))
                (=> main@_bb9_1
                    (and main@_bb9_1 main@__VERIFIER_assert.exit.i_0))
                (=> (and main@_bb9_1 main@__VERIFIER_assert.exit.i_0)
