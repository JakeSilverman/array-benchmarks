(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-TaMNtW/z3test.pp.ms.o.bc")
...
(rule (=> (and (main@entry @__VERIFIER_nondet_int_0)
         ...
         (=> (and main@_bb_0 main@entry_0) (= main@%.01.i_0 3))
         ...
         main@_bb_0)
    (main@_bb main@%.01.i_1 main@%.0.i_1 main@%_1_0)))
(rule (let ((a!1 (and (main@_bb main@%.01.i_0 main@%.0.i_0 main@%_1_0)
                true
                (= main@%_3_0 (< main@%.0.i_0 main@%_1_0))
                (=> main@_bb3_0 (and main@_bb3_0 main@_bb_0))
                (=> (and main@_bb3_0 main@_bb_0) main@%_3_0)
                (=> main@_bb3_0 (= main@%_10_0 (+ main@%.01.i_0 1)))
                (=> main@_bb3_0 (= main@%_11_0 (+ main@%.0.i_0 1)))
                (=> main@_bb_1 (and main@_bb_1 main@_bb3_0))
                (=> (and main@_bb_1 main@_bb3_0) (= main@%.01.i_1 main@%_10_0))
                ...
                main@_bb_1)))
  (=> a!1 (main@_bb main@%.01.i_2 main@%.0.i_2 main@%_1_0))))
(rule (let ((a!1 (and (main@_bb main@%.01.i_0 main@%.0.i_0 main@%_1_0)
                true
                (= main@%_3_0 (< main@%.0.i_0 main@%_1_0))
                (=> main@_bb1_0 (and main@_bb1_0 main@_bb_0))
                (=> (and main@_bb1_0 main@_bb_0) (not main@%_3_0))
                (=> main@_bb1_0 (= main@%_5_0 (= main@%.01.i_0 3)))
                (=> main@_bb1_0 (= main@%_6_0 (ite main@%_5_0 1 0)))
                (=> main@_bb1_0 (= main@%_7_0 (= main@%_6_0 0)))
                (=> main@_bb1_0 main@%_7_0)
