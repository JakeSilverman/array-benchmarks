(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-G7kjlO/standard_sentinel-2.pp.ms.o.bc")
...
(let ((a!3 (and (main@_bb5 main@%_0_0 main@%.0.i_0 main@%sm_0)
                ...
                (=> main@__JVERIFIER_assert.exit.i_0
                    (and main@__JVERIFIER_assert.exit.i_0 main@_bb7_0))
                (=> (and main@__JVERIFIER_assert.exit.i_0 main@_bb7_0)
                    (not main@%_22_0))
                (=> main@__JVERIFIER_assert.exit.i_0
                ...
                (=> main@__JVERIFIER_assert.exit.i_0 main@%_26_0)
                (=> main@_bb9_0
                    (and main@_bb9_0 main@__JVERIFIER_assert.exit.i_0))
