(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-DmUtKR/cmp_ant.pp.ms.o.bc")
...
(let ((a!2 (and (main@_bb8 @__VERIFIER_nondet_char_0
                ...
                (=> main@_bb10_0
                    (= main@%_27_0 (select main@%sm3_0 main@%.sub4.i_0)))
                (=> main@_bb10_0 (= main@%_28_0 (< main@%_26_0 main@%_27_0)))
                (=> main@_bb10_0 (= main@%..i.i_0 (ite main@%_28_0 (- 1) 1)))
                ...
                (=> |tuple(main@init.exit6.i_0, main@cmp.exit.i_0)|
                    (= main@%.0.i7.i_1 0))
                (=> (and main@cmp.exit.i_0 main@_bb10_0)
                    (= main@%.0.i7.i_2 main@%.0.i7.i_0))
                (=> |tuple(main@init.exit6.i_0, main@cmp.exit.i_0)|
                    (= main@%.0.i7.i_2 main@%.0.i7.i_1))
                (=> main@cmp.exit.i_0
                    (= main@%_29_0 (select main@%sm3_0 main@%.sub4.i_0)))
                (=> main@cmp.exit.i_0
                    (= main@%_30_0 (select main@%sm1_0 main@%.sub.i_0)))
                (=> main@cmp.exit.i_0
                    (= main@%_31_0 (= main@%_29_0 main@%_30_0)))
                (=> main@_bb11_0 (and main@_bb11_0 main@cmp.exit.i_0))
                (=> (and main@_bb11_0 main@cmp.exit.i_0) (not main@%_31_0))
                (=> main@_bb11_0
                    (= main@%_33_0 (select main@%sm3_0 main@%.sub4.i_0)))
                (=> main@_bb11_0
                    (= main@%_34_0 (select main@%sm1_0 main@%.sub.i_0)))
                (=> main@_bb11_0 (= main@%_35_0 (< main@%_33_0 main@%_34_0)))
                (=> main@_bb11_0 (= main@%..i8.i_0 (ite main@%_35_0 (- 1) 1)))
                (=> |tuple(main@cmp.exit.i_0, main@cmp.exit10.i_0)|
                    main@cmp.exit.i_0)
                (=> main@cmp.exit10.i_0
                    (or (and main@cmp.exit10.i_0 main@_bb11_0)
                        |tuple(main@cmp.exit.i_0, main@cmp.exit10.i_0)|))
                (=> |tuple(main@cmp.exit.i_0, main@cmp.exit10.i_0)| main@%_31_0)
                (=> (and main@cmp.exit10.i_0 main@_bb11_0)
                    (= main@%.0.i9.i_0 main@%..i8.i_0))
                (=> |tuple(main@cmp.exit.i_0, main@cmp.exit10.i_0)|
                    (= main@%.0.i9.i_1 0))
                (=> (and main@cmp.exit10.i_0 main@_bb11_0)
                    (= main@%.0.i9.i_2 main@%.0.i9.i_0))
                (=> |tuple(main@cmp.exit.i_0, main@cmp.exit10.i_0)|
                    (= main@%.0.i9.i_2 main@%.0.i9.i_1))
                (=> main@cmp.exit10.i_0 (= main@%_36_0 (< main@%.0.i7.i_2 1)))
                (=> main@cmp.exit10.i_0 (= main@%_37_0 (< main@%.0.i9.i_2 1)))
                (=> main@cmp.exit10.i_0
                    (= main@%or.cond3.i_0 (and main@%_36_0 main@%_37_0)))
                (=> main@cmp.exit10.i_0 main@%or.cond3.i_0)
                (=> main@_bb12_0 (and main@_bb12_0 main@cmp.exit10.i_0))
                (=> main@_bb12_0
                    (= main@%_39_0 (select main@%sm1_0 main@%.sub.i_0)))
                (=> main@_bb12_0
                    (= main@%_40_0 (select main@%sm3_0 main@%.sub4.i_0)))
                (=> main@_bb12_0 (= main@%_41_0 (= main@%_39_0 main@%_40_0)))
                (=> main@_bb12_0 (= main@%_42_0 (ite main@%_41_0 1 0)))
                (=> main@_bb12_0 (= main@%_43_0 (= main@%_42_0 0)))
                (=> main@_bb12_0 main@%_43_0)
