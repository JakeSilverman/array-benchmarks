(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-U15qls/standard_partition_ground-2.pp.ms.o.bc")
...
(rule (let ((a!1 (=> main@_bb5_0
               (= main@%_10_0 (+ main@%_0_0 (* 0 400000) (* main@%.03.i_0 4))))))
...
(let ((a!4 (and (main@_bb6 main@%_0_0
                ...
                (=> (and main@_bb9_0 main@_bb8_0) (= main@%.1.i_0 main@%_22_0))
                (=> |tuple(main@_bb7_0, main@_bb9_0)|
                    (= main@%shadow.mem.4.1_1 main@%shadow.mem.4.0_0))
                (=> |tuple(main@_bb7_0, main@_bb9_0)|
                    (= main@%.1.i_1 main@%.02.i_0))
                (=> (and main@_bb9_0 main@_bb8_0)
                    (= main@%shadow.mem.4.1_2 main@%shadow.mem.4.1_0))
                (=> (and main@_bb9_0 main@_bb8_0) (= main@%.1.i_2 main@%.1.i_0))
                (=> |tuple(main@_bb7_0, main@_bb9_0)|
...
(rule (=> (and (main@_bb6 main@%_0_0
         ...
         main@_bb11_0)
    (main@_bb11 main@%shadow.mem.4.0_0 main@%.02.i_0 main@%_1_0 main@%.0.i_1)))
(rule (let ((a!1 (=> main@_bb12_0
               (= main@%_29_0 (+ main@%_1_0 (* 0 400000) (* main@%.0.i_0 4))))))
(let ((a!2 (and (main@_bb11 main@%shadow.mem.4.0_0
                            main@%.02.i_0
                            main@%_1_0
                            main@%.0.i_0)
                true
                (= main@%_27_0 (< main@%.0.i_0 main@%.02.i_0))
                main@%_27_0
                (=> main@_bb12_0 (and main@_bb12_0 main@_bb11_0))
                a!1
                (=> main@_bb12_0 (or (<= main@%_1_0 0) (> main@%_29_0 0)))
                (=> main@_bb12_0 (> main@%_1_0 0))
                (=> main@_bb12_0
                    (= main@%_30_0 (select main@%shadow.mem.4.0_0 main@%_29_0)))
                (=> main@_bb12_0 (= main@%_31_0 (> main@%_30_0 (- 1))))
                (=> main@_bb12_0 (= main@%_32_0 (ite main@%_31_0 1 0)))
                (=> main@_bb12_0 (= main@%_33_0 (= main@%_32_0 0)))
                (=> main@__JVERIFIER_assert.exit.i_0
                    (and main@__JVERIFIER_assert.exit.i_0 main@_bb12_0))
                (=> (and main@__JVERIFIER_assert.exit.i_0 main@_bb12_0)
                    (not main@%_33_0))
                (=> main@__JVERIFIER_assert.exit.i_0
                    (= main@%_35_0 (+ main@%.0.i_0 1)))
                (=> main@_bb11_1
                    (and main@_bb11_1 main@__JVERIFIER_assert.exit.i_0))
                (=> (and main@_bb11_1 main@__JVERIFIER_assert.exit.i_0)
                    (= main@%.0.i_1 main@%_35_0))
                (=> (and main@_bb11_1 main@__JVERIFIER_assert.exit.i_0)
                    (= main@%.0.i_2 main@%.0.i_1))
                main@_bb11_1)))
  (=> a!2
      (main@_bb11 main@%shadow.mem.4.0_0 main@%.02.i_0 main@%_1_0 main@%.0.i_2)))))
(rule (let ((a!1 (=> main@_bb12_0
               (= main@%_29_0 (+ main@%_1_0 (* 0 400000) (* main@%.0.i_0 4))))))
(let ((a!2 (and (main@_bb11 main@%shadow.mem.4.0_0
                            main@%.02.i_0
