(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-qRDly4/commutivity.pp.ms.o.bc")
(set-info :authors "SeaHorn v.0.1.0-rc3")
(declare-rel verifier.error (Bool Bool Bool ))
(declare-rel main@entry (Int ))
(declare-rel main@_bb6 (Int Int Int (Array Int Int) Int Int Int (Array Int Int) (Array Int Int) ))
(declare-rel main@_bb8 (Int Int (Array Int Int) Int Int (Array Int Int) Int Int (Array Int Int) ))
(declare-rel main@_bb10 (Int (Array Int Int) Int (Array Int Int) Int Int (Array Int Int) Int ))
(declare-rel main@_bb13 (Int (Array Int Int) Int (Array Int Int) Int (Array Int Int) Int Int ))
...
(rule (=> (and (main@_bb6 @__VERIFIER_nondet_int_0
         ...
         (=> (and main@_bb8_0 main@init.exit.i_0) (= main@%.0.i3.i_0 0))
         (=> (and main@_bb8_0 main@init.exit.i_0)
    ...
    (main@_bb8 @__VERIFIER_nondet_int_0
               ...
               main@%_1_0
               main@%sm5_0)))
(rule (let ((a!1 (=> main@_bb9_0 (= main@%_19_0 (+ main@%_5_0 (* main@%.0.i3.i_0 4))))))
(let ((a!2 (and (main@_bb8 @__VERIFIER_nondet_int_0
                           ...
                           main@%sm5_0)
                true
                (= main@%_15_0 (< main@%.0.i3.i_0 main@%_1_0))
                (=> main@_bb9_0 (and main@_bb9_0 main@_bb8_0))
                (=> (and main@_bb9_0 main@_bb8_0) main@%_15_0)
                (=> main@_bb9_0 (= main@%_17_0 @__VERIFIER_nondet_int_0))
                a!1
                (=> main@_bb9_0 (or (<= main@%_5_0 0) (> main@%_19_0 0)))
                (=> main@_bb9_0 (> main@%_5_0 0))
                (=> main@_bb9_0
                    (= main@%sm1_0
                       (store main@%shadow.mem.4.0_0 main@%_19_0 main@%_18_0)))
                (=> main@_bb9_0 (= main@%_20_0 (+ main@%.0.i3.i_0 1)))
                (=> main@_bb8_1 (and main@_bb8_1 main@_bb9_0))
                (=> (and main@_bb8_1 main@_bb9_0)
                    (= main@%shadow.mem.4.0_1 main@%sm1_0))
                (=> (and main@_bb8_1 main@_bb9_0)
                    (= main@%.0.i3.i_1 main@%_20_0))
                (=> (and main@_bb8_1 main@_bb9_0)
...
(rule (=> (and (main@_bb8 @__VERIFIER_nondet_int_0
         ...
         true
         (= main@%_15_0 (< main@%.0.i3.i_0 main@%_1_0))
         (=> main@init.exit4.i_0 (and main@init.exit4.i_0 main@_bb8_0))
         (=> (and main@init.exit4.i_0 main@_bb8_0) (not main@%_15_0))
         (=> main@_bb10_0 (and main@_bb10_0 main@init.exit4.i_0))
         (=> (and main@_bb10_0 main@init.exit4.i_0)
             (= main@%shadow.mem.8.0_0 main@%sm5_0))
         (=> (and main@_bb10_0 main@init.exit4.i_0) (= main@%.02.i_0 0))
         (=> (and main@_bb10_0 main@init.exit4.i_0)
    ...
    (main@_bb10 main@%_4_0
                ...
                main@%_1_0)))
(rule (let ((a!1 (=> main@_bb12_0 (= main@%_25_0 (+ main@%_4_0 (* main@%.02.i_0 4)))))
      (a!2 (=> main@_bb12_0 (= main@%_27_0 (+ main@%_5_0 (* main@%.02.i_0 4)))))
      (a!3 (=> main@_bb12_0 (= main@%_30_0 (+ main@%_6_0 (* main@%.02.i_0 4))))))
(let ((a!4 (and (main@_bb10 main@%_4_0
                            ...
                            main@%_1_0)
                true
                (= main@%_22_0 (< main@%.02.i_0 main@%_1_0))
                (=> main@_bb12_0 (and main@_bb12_0 main@_bb10_0))
                (=> (and main@_bb12_0 main@_bb10_0) main@%_22_0)
                a!1
                (=> main@_bb12_0 (or (<= main@%_4_0 0) (> main@%_25_0 0)))
                (=> main@_bb12_0 (> main@%_4_0 0))
                (=> main@_bb12_0
                    (= main@%_26_0 (select main@%shadow.mem.0.0_0 main@%_25_0)))
                a!2
                (=> main@_bb12_0 (or (<= main@%_5_0 0) (> main@%_27_0 0)))
                (=> main@_bb12_0 (> main@%_5_0 0))
                (=> main@_bb12_0
                    (= main@%_28_0 (select main@%shadow.mem.4.0_0 main@%_27_0)))
                (=> main@_bb12_0 (= main@%_29_0 (+ main@%_26_0 main@%_28_0)))
                a!3
                (=> main@_bb12_0 (or (<= main@%_6_0 0) (> main@%_30_0 0)))
                (=> main@_bb12_0 (> main@%_6_0 0))
                (=> main@_bb12_0
                    (= main@%sm2_0
                       (store main@%shadow.mem.8.0_0 main@%_30_0 main@%_29_0)))
                (=> main@_bb12_0 (= main@%_31_0 (+ main@%.02.i_0 1)))
                (=> main@_bb10_1 (and main@_bb10_1 main@_bb12_0))
                (=> (and main@_bb10_1 main@_bb12_0)
...
(rule (=> (and (main@_bb10 main@%_4_0
         ...
         (=> (and main@_bb13_0 main@_bb11_0) (= main@%.01.i_0 0))
         (=> (and main@_bb13_0 main@_bb11_0) (= main@%.01.i_1 main@%.01.i_0))
         main@_bb13_0)
    (main@_bb13 main@%_4_0
                ...
                main@%.01.i_1
                main@%_1_0)))
(rule (let ((a!1 (=> main@_bb14_0 (= main@%_35_0 (+ main@%_6_0 (* main@%.01.i_0 4)))))
      (a!2 (=> main@_bb14_0 (= main@%_37_0 (+ main@%_4_0 (* main@%.01.i_0 4)))))
      (a!3 (=> main@_bb14_0 (= main@%_39_0 (+ main@%_5_0 (* main@%.01.i_0 4))))))
(let ((a!4 (and (main@_bb13 main@%_4_0
                            main@%shadow.mem.0.0_0
                            main@%_5_0
                            main@%shadow.mem.4.0_0
                            main@%_6_0
                ...
                (=> main@_bb14_0 (= main@%_41_0 (+ main@%_38_0 main@%_40_0)))
                (=> main@_bb14_0 (= main@%_42_0 (= main@%_36_0 main@%_41_0)))
                (=> main@_bb14_0 (= main@%_43_0 (ite main@%_42_0 1 0)))
                (=> main@_bb14_0 (= main@%_44_0 (= main@%_43_0 0)))
                (=> main@__JVERIFIER_assert.exit.i_0
                    (and main@__JVERIFIER_assert.exit.i_0 main@_bb14_0))
                (=> (and main@__JVERIFIER_assert.exit.i_0 main@_bb14_0)
                    (not main@%_44_0))
                (=> main@__JVERIFIER_assert.exit.i_0
                    (= main@%_46_0 (+ main@%.01.i_0 1)))
                (=> main@_bb13_1
                    (and main@_bb13_1 main@__JVERIFIER_assert.exit.i_0))
                (=> (and main@_bb13_1 main@__JVERIFIER_assert.exit.i_0)
                    (= main@%.01.i_1 main@%_46_0))
                (=> (and main@_bb13_1 main@__JVERIFIER_assert.exit.i_0)
