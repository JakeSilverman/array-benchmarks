(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-AcKDUF/array_init_pair_sum_const.pp.ms.o.bc")
...
(declare-rel main@_bb (Int Int (Array Int Int) Int (Array Int Int) Int (Array Int Int) ))
...
(rule (let ((a!1 (=> main@_bb6_0
      ...
      (a!2 (=> main@_bb6_0
               (= main@%_10_0 (+ main@%_1_0 (* 0 400000) (* main@%.0.i_0 4))))))
(let ((a!3 (and (main@_bb main@%_0_0
                ...
                a!1
                (=> main@_bb6_0 (or (<= main@%_0_0 0) (> main@%_9_0 0)))
                (=> main@_bb6_0 (> main@%_0_0 0))
                (=> main@_bb6_0
                    (= main@%sm_0 (store main@%shadow.mem.0.0_0 main@%_9_0 1)))
                a!2
                (=> main@_bb6_0 (or (<= main@%_1_0 0) (> main@%_10_0 0)))
                (=> main@_bb6_0 (> main@%_1_0 0))
                (=> main@_bb6_0
                    (= main@%sm1_0 (store main@%shadow.mem.4.0_0 main@%_10_0 2)))
                (=> main@_bb6_0 (= main@%_11_0 (+ main@%.0.i_0 1)))
                ...
                (=> (and main@_bb_1 main@_bb6_0) (= main@%.0.i_1 main@%_11_0))
                (=> (and main@_bb_1 main@_bb6_0)
...
(rule (let ((a!1 (=> main@_bb9_0
               (= main@%_16_0 (+ main@%_0_0 (* 0 400000) (* main@%.1.i_0 4)))))
      (a!2 (=> main@_bb9_0
               (= main@%_18_0 (+ main@%_1_0 (* 0 400000) (* main@%.1.i_0 4)))))
      (a!3 (=> main@_bb9_0
               (= main@%_21_0 (+ main@%_2_0 (* 0 400000) (* main@%.1.i_0 4))))))
(let ((a!4 (and (main@_bb8 main@%_0_0
                ...
                a!2
                (=> main@_bb9_0 (or (<= main@%_1_0 0) (> main@%_18_0 0)))
                (=> main@_bb9_0 (> main@%_1_0 0))
                (=> main@_bb9_0
                    (= main@%_19_0 (select main@%shadow.mem.4.0_0 main@%_18_0)))
                (=> main@_bb9_0 (= main@%_20_0 (+ main@%_17_0 main@%_19_0)))
                a!3
                (=> main@_bb9_0 (or (<= main@%_2_0 0) (> main@%_21_0 0)))
                (=> main@_bb9_0 (> main@%_2_0 0))
                (=> main@_bb9_0
                    (= main@%sm2_0
                       (store main@%shadow.mem.8.0_0 main@%_21_0 main@%_20_0)))
                (=> main@_bb9_0 (= main@%_22_0 (+ main@%.1.i_0 1)))
                (=> main@_bb8_1 (and main@_bb8_1 main@_bb9_0))
                (=> (and main@_bb8_1 main@_bb9_0)
                    (= main@%shadow.mem.8.0_1 main@%sm2_0))
                (=> (and main@_bb8_1 main@_bb9_0) (= main@%.1.i_1 main@%_22_0))
                (=> (and main@_bb8_1 main@_bb9_0)
...
(rule (let ((a!1 (=> main@_bb12_0
               (= main@%_27_0 (+ main@%_2_0 (* 0 400000) (* main@%.2.i_0 4))))))
(let ((a!2 (and (main@_bb11 main@%_2_0 main@%shadow.mem.8.0_0 main@%.2.i_0)
                true
                (= main@%_25_0 (< main@%.2.i_0 100000))
                main@%_25_0
                ...
                (=> main@_bb12_0
                    (= main@%_28_0 (select main@%shadow.mem.8.0_0 main@%_27_0)))
                (=> main@_bb12_0 (= main@%_29_0 (> main@%_28_0 2)))
                (=> main@_bb12_0 (= main@%_30_0 (ite main@%_29_0 1 0)))
                (=> main@postcall_0 (and main@postcall_0 main@_bb12_0))
                (=> (and main@postcall_0 main@_bb12_0) main@%_31_0)
                (__VERIFIER_assert main@postcall_0 false false main@%_30_0)
                (=> main@postcall_0 (= main@%_32_0 (+ main@%.2.i_0 1)))
...
(let ((a!2 (and (main@_bb11 main@%_2_0 main@%shadow.mem.8.0_0 main@%.2.i_0)
                ...
                (=> (and main@precall_0 main@_bb12_0) (not main@%_31_0))
                (=> main@__VERIFIER_assert_0
                    (and main@__VERIFIER_assert_0 main@precall_0))
                (=> main@__VERIFIER_assert_0 (= main@%_33_0 (= main@%_30_0 0)))
                (=> main@__VERIFIER_assert_0 main@%_33_0)
