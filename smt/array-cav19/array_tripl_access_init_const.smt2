(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-brggkA/array_tripl_access_init_const.pp.ms.o.bc")
...
(rule (let ((a!1 (= main@%_6_0 (+ (+ main@%_0_0 (* 0 1200004)) (* main@%_5_0 4))))
      (a!2 (= main@%_9_0 (+ (+ main@%_0_0 (* 0 1200004)) (* main@%_8_0 4))))
      (a!3 (= main@%_12_0 (+ (+ main@%_0_0 (* 0 1200004)) (* main@%_11_0 4)))))
(let ((a!4 (and (main@_bb main@%.0.i_0 main@%_0_0 main@%shadow.mem.0.0_0)
                true
                (= main@%_3_0 (< main@%.0.i_0 100001))
                (=> main@_bb4_0 (and main@_bb4_0 main@_bb_0))
                (=> (and main@_bb4_0 main@_bb_0) main@%_3_0)
                (=> main@_bb4_0 (= main@%_5_0 (* main@%.0.i_0 3)))
                (=> main@_bb4_0 a!1)
                (=> main@_bb4_0 (or (<= main@%_0_0 0) (> main@%_6_0 0)))
                (=> main@_bb4_0 (> main@%_0_0 0))
                (=> main@_bb4_0
                    (= main@%sm_0 (store main@%shadow.mem.0.0_0 main@%_6_0 0)))
                (=> main@_bb4_0 (= main@%_7_0 (* main@%.0.i_0 3)))
                (=> main@_bb4_0 (= main@%_8_0 (+ main@%_7_0 1)))
                (=> main@_bb4_0 a!2)
                (=> main@_bb4_0 (or (<= main@%_0_0 0) (> main@%_9_0 0)))
                (=> main@_bb4_0 (> main@%_0_0 0))
                (=> main@_bb4_0 (= main@%sm1_0 (store main@%sm_0 main@%_9_0 0)))
                (=> main@_bb4_0 (= main@%_10_0 (* main@%.0.i_0 3)))
                (=> main@_bb4_0 (= main@%_11_0 (+ main@%_10_0 2)))
                (=> main@_bb4_0 a!3)
                (=> main@_bb4_0 (or (<= main@%_0_0 0) (> main@%_12_0 0)))
                (=> main@_bb4_0 (> main@%_0_0 0))
                (=> main@_bb4_0
                    (= main@%sm2_0 (store main@%sm1_0 main@%_12_0 0)))
                (=> main@_bb4_0 (= main@%_13_0 (+ main@%.0.i_0 1)))
                (=> main@_bb_1 (and main@_bb_1 main@_bb4_0))
                (=> (and main@_bb_1 main@_bb4_0)
                    (= main@%shadow.mem.0.0_1 main@%sm2_0))
                (=> (and main@_bb_1 main@_bb4_0) (= main@%.0.i_1 main@%_13_0))
                (=> (and main@_bb_1 main@_bb4_0)
                    (= main@%shadow.mem.0.0_2 main@%shadow.mem.0.0_1))
                (=> (and main@_bb_1 main@_bb4_0) (= main@%.0.i_2 main@%.0.i_1))
                main@_bb_1)))
  (=> a!4 (main@_bb main@%.0.i_2 main@%_0_0 main@%shadow.mem.0.0_2)))))
(rule (=> (and (main@_bb main@%.0.i_0 main@%_0_0 main@%shadow.mem.0.0_0)
         ...
         main@_bb6_0)
    (main@_bb6 main@%_0_0 main@%shadow.mem.0.0_0 main@%.1.i_1)))
(rule (let ((a!1 (=> main@_bb7_0
               (= main@%_18_0 (+ main@%_0_0 (* 0 1200004) (* main@%.1.i_0 4))))))
(let ((a!2 (and (main@_bb6 main@%_0_0 main@%shadow.mem.0.0_0 main@%.1.i_0)
                true
                (= main@%_16_0 (< main@%.1.i_0 300001))
                main@%_16_0
                ...
                main@_bb6_1)))
  (=> a!2 (main@_bb6 main@%_0_0 main@%shadow.mem.0.0_0 main@%.1.i_2)))))
(rule (let ((a!1 (=> main@_bb7_0
               (= main@%_18_0 (+ main@%_0_0 (* 0 1200004) (* main@%.1.i_0 4))))))
(let ((a!2 (and (main@_bb6 main@%_0_0 main@%shadow.mem.0.0_0 main@%.1.i_0)
                true
                ...
                (=> (and main@precall_0 main@_bb7_0) (not main@%_22_0))
