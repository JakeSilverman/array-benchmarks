(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-VuJbf5/array_tiling_poly6.pp.ms.o.bc")
...
(declare-rel main@_bb5 (Int Int (Array Int Int) Int ))
(declare-rel main@_bb8 (Int (Array Int Int) Int Int ))
...
(rule (=> (and (main@entry @__VERIFIER_nondet_int_0)
         ...
         main@_bb_0)
    (main@_bb main@%.0.i_1 main@%_3_0 main@%shadow.mem.0.0_1 main@%_1_0)))
(rule (let ((a!1 (=> main@_bb3_0 (= main@%_10_0 (+ main@%_3_0 (* main@%.0.i_0 4))))))
(let ((a!2 (and (main@_bb main@%.0.i_0
                          main@%_3_0
                          main@%shadow.mem.0.0_0
                          main@%_1_0)
                true
                (= main@%_5_0 (< main@%.0.i_0 main@%_1_0))
                (=> main@_bb3_0 (and main@_bb3_0 main@_bb_0))
                (=> (and main@_bb3_0 main@_bb_0) main@%_5_0)
                (=> main@_bb3_0 (= main@%_7_0 (+ main@%.0.i_0 (- 1))))
                (=> main@_bb3_0 (= main@%_8_0 (+ main@%.0.i_0 1)))
                a!1
                (=> main@_bb3_0 (or (<= main@%_3_0 0) (> main@%_10_0 0)))
                ...
                main@_bb_1)))
  (=> a!2 (main@_bb main@%.0.i_2 main@%_3_0 main@%shadow.mem.0.0_2 main@%_1_0)))))
(rule (=> (and (main@_bb main@%.0.i_0 main@%_3_0 main@%shadow.mem.0.0_0 main@%_1_0)
         true
         (= main@%_5_0 (< main@%.0.i_0 main@%_1_0))
         ...
         main@_bb5_0)
    (main@_bb5 main@%_3_0 main@%.1.i_1 main@%shadow.mem.0.1_1 main@%_1_0)))
(rule (let ((a!1 (=> main@_bb6_0 (= main@%_16_0 (+ main@%_3_0 (* main@%.1.i_0 4)))))
      (a!2 (=> main@_bb6_0 (= main@%_20_0 (+ main@%_3_0 (* main@%.1.i_0 4))))))
(let ((a!3 (and (main@_bb5 main@%_3_0
                           main@%.1.i_0
                ...
                a!1
                (=> main@_bb6_0 (or (<= main@%_3_0 0) (> main@%_16_0 0)))
                (=> main@_bb6_0 (> main@%_3_0 0))
                (=> main@_bb6_0
                    (= main@%_17_0 (select main@%shadow.mem.0.1_0 main@%_16_0)))
                (=> main@_bb6_0 (= main@%_19_0 (- main@%_17_0 main@%_18_0)))
                a!2
                (=> main@_bb6_0 (or (<= main@%_3_0 0) (> main@%_20_0 0)))
                (=> main@_bb6_0 (> main@%_3_0 0))
                (=> main@_bb6_0
                    (= main@%sm1_0
                       (store main@%shadow.mem.0.1_0 main@%_20_0 main@%_19_0)))
                (=> main@_bb6_0 (= main@%_21_0 (+ main@%.1.i_0 1)))
                (=> main@_bb5_1 (and main@_bb5_1 main@_bb6_0))
                (=> (and main@_bb5_1 main@_bb6_0)
                    (= main@%shadow.mem.0.1_1 main@%sm1_0))
                (=> (and main@_bb5_1 main@_bb6_0) (= main@%.1.i_1 main@%_21_0))
                (=> (and main@_bb5_1 main@_bb6_0)
                    (= main@%shadow.mem.0.1_2 main@%shadow.mem.0.1_1))
                (=> (and main@_bb5_1 main@_bb6_0) (= main@%.1.i_2 main@%.1.i_1))
                main@_bb5_1)))
  (=> a!3 (main@_bb5 main@%_3_0 main@%.1.i_2 main@%shadow.mem.0.1_2 main@%_1_0)))))
(rule (=> (and (main@_bb5 main@%_3_0 main@%.1.i_0 main@%shadow.mem.0.1_0 main@%_1_0)
         true
         (= main@%_14_0 (< main@%.1.i_0 main@%_1_0))
         (=> main@_bb7_0 (and main@_bb7_0 main@_bb5_0))
         (=> (and main@_bb7_0 main@_bb5_0) (not main@%_14_0))
         (=> main@_bb8_0 (and main@_bb8_0 main@_bb7_0))
         (=> (and main@_bb8_0 main@_bb7_0) (= main@%.2.i_0 0))
         (=> (and main@_bb8_0 main@_bb7_0) (= main@%.2.i_1 main@%.2.i_0))
         main@_bb8_0)
    (main@_bb8 main@%_3_0 main@%shadow.mem.0.1_0 main@%.2.i_1 main@%_1_0)))
(rule (let ((a!1 (=> main@_bb9_0 (= main@%_26_0 (+ main@%_3_0 (* main@%.2.i_0 4))))))
(let ((a!2 (and (main@_bb8 main@%_3_0
                           main@%shadow.mem.0.1_0
                           main@%.2.i_0
                           main@%_1_0)
                true
                (= main@%_24_0 (< main@%.2.i_0 main@%_1_0))
                main@%_24_0
                (=> main@_bb9_0 (and main@_bb9_0 main@_bb8_0))
                a!1
                (=> main@_bb9_0 (or (<= main@%_3_0 0) (> main@%_26_0 0)))
                (=> main@_bb9_0 (> main@%_3_0 0))
                (=> main@_bb9_0
                    (= main@%_27_0 (select main@%shadow.mem.0.1_0 main@%_26_0)))
                (=> main@_bb9_0 (= main@%_28_0 (= main@%_27_0 (- 1))))
                (=> main@_bb9_0 (= main@%_29_0 (ite main@%_28_0 1 0)))
                (=> main@postcall_0 (and main@postcall_0 main@_bb9_0))
                (=> (and main@postcall_0 main@_bb9_0) main@%_30_0)
                ...
                main@_bb8_1)))
  (=> a!2 (main@_bb8 main@%_3_0 main@%shadow.mem.0.1_0 main@%.2.i_2 main@%_1_0)))))
(rule (let ((a!1 (=> main@_bb9_0 (= main@%_26_0 (+ main@%_3_0 (* main@%.2.i_0 4))))))
(let ((a!2 (and (main@_bb8 main@%_3_0
                           main@%shadow.mem.0.1_0
                           main@%.2.i_0
                ...
                (=> (and main@precall_0 main@_bb9_0) (not main@%_30_0))
