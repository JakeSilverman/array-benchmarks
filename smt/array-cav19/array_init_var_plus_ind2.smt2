(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-nmQvaJ/array_init_var_plus_ind2.pp.ms.o.bc")
...
(declare-rel main@_bb (Int (Array Int Int) Int Int Int Int ))
(declare-rel main@_bb7 (Int Int Int (Array Int Int) Int ))
...
(let ((a!2 (and (main@_bb main@%.0.i_0
                ...
                (=> main@_bb3_0 (= main@%_11_0 (- main@%.02.i_0 main@%.0.i_0)))
                ...
                (=> (and main@_bb4_0 main@_bb3_0) (= main@%.05.i_0 true))
                (=> (and main@_bb4_0 main@_bb3_0) (= main@%.13.i_0 main@%_11_0))
                (=> (and main@_bb4_0 main@_bb3_0) (= main@%.1.i_0 main@%_10_0))
                (=> |tuple(main@_bb2_0, main@_bb4_0)|
                    (= main@%shadow.mem.0.1_1 main@%shadow.mem.0.0_0))
                (=> |tuple(main@_bb2_0, main@_bb4_0)| (= main@%.05.i_1 false))
                (=> |tuple(main@_bb2_0, main@_bb4_0)|
                ...
                (=> (and main@_bb5_0 main@_bb4_0) main@%.05.i_2)
                (=> main@_bb5_0 (= main@%_14_0 (+ main@%.0.i_0 1)))
                ...
                (=> (and main@_bb_1 main@_bb5_0) (= main@%.0.i_1 main@%_14_0))
                (=> (and main@_bb_1 main@_bb5_0)
...
(let ((a!2 (and (main@_bb main@%.0.i_0
                ...
                (=> (and main@_bb7_0 main@_bb6_0) (= main@%.04.i_0 1))
...
(rule (let ((a!1 (=> main@_bb8_0
               (= main@%_19_0 (+ main@%_0_0 (* 0 400000) (* main@%.04.i_0 4))))))
(let ((a!2 (and (main@_bb7 main@%.0.i_0
                           ...
                           main@%.2.i_0)
                true
                (= main@%_17_0 (< main@%.04.i_0 main@%.0.i_0))
                main@%_17_0
                ...
                (=> main@_bb8_0 (= main@%_21_0 (>= main@%_20_0 main@%.2.i_0)))
...
(let ((a!2 (and (main@_bb7 main@%.0.i_0
                ...
                (=> main@__JVERIFIER_assert_0 (= main@%_25_0 (= main@%_22_0 0)))
                (=> main@__JVERIFIER_assert_0 main@%_25_0)
