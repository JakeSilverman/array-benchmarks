(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-mf7S2W/array_init_pair_symmetr2.pp.ms.o.bc")
...
(rule (let ((a!1 (=> main@_bb6_0
      ...
      (a!2 (=> main@_bb6_0
               (= main@%_14_0
                  (ite (>= main@%.off3.i_0 0) (< main@%.off3.i_0 199999) false))))
      (a!3 (=> main@_bb6_0
               (= main@%_16_0 (+ main@%_0_0 (* 0 400000) (* main@%.0.i_0 4)))))
      (a!4 (=> main@_bb6_0
               (= main@%_17_0 (+ main@%_1_0 (* 0 400000) (* main@%.0.i_0 4))))))
(let ((a!5 (and (main@_bb @__VERIFIER_nondet_int_0
                          main@%_0_0
                          main@%.0.i_0
                ...
                (=> main@_bb6_0 (= main@%.off.i_0 (+ main@%_12_0 99999)))
                a!1
                (=> main@_bb6_0 main@%_13_0)
                (=> main@_bb6_0 (= main@%.off3.i_0 (+ main@%_10_0 99999)))
                a!2
                (=> main@_bb6_0 main@%_14_0)
                (=> main@_bb6_0 (= main@%_15_0 (> main@%_10_0 main@%_12_0)))
                (=> main@_bb6_0 main@%_15_0)
                a!3
                (=> main@_bb6_0 (or (<= main@%_0_0 0) (> main@%_16_0 0)))
                (=> main@_bb6_0 (> main@%_0_0 0))
                (=> main@_bb6_0
                    (= main@%sm_0
                       (store main@%shadow.mem.0.0_0 main@%_16_0 main@%_10_0)))
                a!4
                (=> main@_bb6_0 (or (<= main@%_1_0 0) (> main@%_17_0 0)))
                (=> main@_bb6_0 (> main@%_1_0 0))
                (=> main@_bb6_0
                    (= main@%sm1_0
                       (store main@%shadow.mem.4.0_0 main@%_17_0 main@%_12_0)))
                (=> main@_bb6_0 (= main@%_18_0 (+ main@%.0.i_0 1)))
                ...
                (=> (and main@_bb_1 main@_bb6_0) (= main@%.0.i_1 main@%_18_0))
                (=> (and main@_bb_1 main@_bb6_0)
...
(rule (let ((a!1 (=> main@_bb9_0
               (= main@%_23_0 (+ main@%_0_0 (* 0 400000) (* main@%.1.i_0 4)))))
      (a!2 (=> main@_bb9_0
               (= main@%_25_0 (+ main@%_1_0 (* 0 400000) (* main@%.1.i_0 4)))))
      (a!3 (=> main@_bb9_0
               (= main@%_28_0 (+ main@%_2_0 (* 0 400000) (* main@%.1.i_0 4))))))
(let ((a!4 (and (main@_bb8 main@%_0_0
                ...
                (=> (and main@_bb9_0 main@_bb8_0) main@%_21_0)
                a!1
...
(rule (=> (and (main@_bb8 main@%_0_0
         ...
         (=> (and main@_bb10_0 main@_bb8_0) (not main@%_21_0))
...
(rule (let ((a!1 (=> main@_bb12_0
               (= main@%_34_0 (+ main@%_2_0 (* 0 400000) (* main@%.2.i_0 4))))))
(let ((a!2 (and (main@_bb11 main@%_2_0 main@%shadow.mem.8.0_0 main@%.2.i_0)
                true
                (= main@%_32_0 (< main@%.2.i_0 100000))
                main@%_32_0
                (=> main@_bb12_0 (and main@_bb12_0 main@_bb11_0))
                a!1
                (=> main@_bb12_0 (or (<= main@%_2_0 0) (> main@%_34_0 0)))
                (=> main@_bb12_0 (> main@%_2_0 0))
                (=> main@_bb12_0
                    (= main@%_35_0 (select main@%shadow.mem.8.0_0 main@%_34_0)))
                (=> main@_bb12_0 (= main@%_36_0 (> main@%_35_0 0)))
                (=> main@_bb12_0 (= main@%_37_0 (ite main@%_36_0 1 0)))
                (=> main@postcall_0 (and main@postcall_0 main@_bb12_0))
                (=> (and main@postcall_0 main@_bb12_0) main@%_38_0)
                (__VERIFIER_assert main@postcall_0 false false main@%_37_0)
                (=> main@postcall_0 (= main@%_39_0 (+ main@%.2.i_0 1)))
                (=> main@_bb11_1 (and main@_bb11_1 main@postcall_0))
                (=> (and main@_bb11_1 main@postcall_0)
                    (= main@%.2.i_1 main@%_39_0))
                (=> (and main@_bb11_1 main@postcall_0)
...
(let ((a!2 (and (main@_bb11 main@%_2_0 main@%shadow.mem.8.0_0 main@%.2.i_0)
                ...
                (=> (and main@precall_0 main@_bb12_0) (not main@%_38_0))
                (=> main@__VERIFIER_assert_0
                    (and main@__VERIFIER_assert_0 main@precall_0))
                (=> main@__VERIFIER_assert_0 (= main@%_40_0 (= main@%_37_0 0)))
