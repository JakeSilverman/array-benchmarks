(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-elJwoD/array6_pattern.pp.ms.o.bc")
...
(rule (=> (and (main@_bb main@%_4_0
    ...
    (main@_bb8 main@%_4_0
               ...
               @__VERIFIER_nondet_int_0
               @__VERIFIER_nondet_short_0)))
(rule (let ((a!1 (=> main@_bb10_0 (= main@%_29_0 (+ main@%_4_0 (* main@%_28_0 4)))))
      (a!2 (=> main@_bb10_0 (= main@%_33_0 (+ main@%_4_0 (* main@%_32_0 4)))))
      (a!3 (=> main@_bb10_0 (= main@%_37_0 (+ main@%_4_0 (* main@%_36_0 4)))))
      (a!4 (=> main@_bb10_0 (= main@%_40_0 (+ main@%_6_0 (* main@%_39_0 4)))))
      (a!5 (=> main@_bb10_0 (= main@%_44_0 (+ main@%_6_0 (* main@%_43_0 4)))))
      (a!6 (=> main@_bb10_0 (= main@%_48_0 (+ main@%_6_0 (* main@%_47_0 4))))))
(let ((a!7 (and (main@_bb8 main@%_4_0
                ...
                (=> (and main@_bb9_0 main@_bb8_0) main@%_19_0)
                (=> main@_bb9_0 (= main@%_21_0 main@%_18_0))
                (=> main@_bb9_0 (= main@%_22_0 main@%_1_0))
                (=> main@_bb9_0 (= main@%_23_0 (+ main@%_22_0 (- 1))))
                (=> main@_bb9_0 (= main@%_24_0 (> main@%_23_0 main@%_21_0)))
                (=> |tuple(main@_bb8_0, main@_bb10_0)| main@_bb8_0)
                (=> main@_bb10_0
                    (or (and main@_bb10_0 main@_bb9_0)
                        |tuple(main@_bb8_0, main@_bb10_0)|))
                (=> |tuple(main@_bb8_0, main@_bb10_0)| (not main@%_19_0))
                (=> (and main@_bb10_0 main@_bb9_0) (= main@%_26_0 main@%_24_0))
                (=> |tuple(main@_bb8_0, main@_bb10_0)| (= main@%_26_1 false))
                (=> (and main@_bb10_0 main@_bb9_0) (= main@%_26_2 main@%_26_0))
                (=> |tuple(main@_bb8_0, main@_bb10_0)|
                    (= main@%_26_2 main@%_26_1))
                (=> main@_bb10_0 main@%_26_2)
                (=> main@_bb10_0 (= main@%_27_0 main@%_18_0))
                (=> main@_bb10_0 (= main@%_28_0 (+ main@%_27_0 (- 1))))
                a!1
                (=> main@_bb10_0 (or (<= main@%_4_0 0) (> main@%_29_0 0)))
                (=> main@_bb10_0 (> main@%_4_0 0))
                (=> main@_bb10_0
                    (= main@%_30_0 (select main@%shadow.mem.0.1_0 main@%_29_0)))
                (=> main@_bb10_0 (= main@%_31_0 main@%_18_0))
                (=> main@_bb10_0 (= main@%_32_0 (+ main@%_31_0 1)))
                a!2
                (=> main@_bb10_0 (or (<= main@%_4_0 0) (> main@%_33_0 0)))
                (=> main@_bb10_0 (> main@%_4_0 0))
                (=> main@_bb10_0
                    (= main@%_34_0 (select main@%shadow.mem.0.1_0 main@%_33_0)))
                (=> main@_bb10_0 (= main@%_35_0 (+ main@%_30_0 main@%_34_0)))
                (=> main@_bb10_0 (= main@%_36_0 main@%_18_0))
                a!3
                (=> main@_bb10_0 (or (<= main@%_4_0 0) (> main@%_37_0 0)))
                (=> main@_bb10_0 (> main@%_4_0 0))
                (=> main@_bb10_0
                    (= main@%sm2_0
                       (store main@%shadow.mem.0.1_0 main@%_37_0 main@%_35_0)))
                (=> main@_bb10_0 (= main@%_38_0 main@%_18_0))
                (=> main@_bb10_0 (= main@%_39_0 (+ main@%_38_0 (- 1))))
                a!4
                (=> main@_bb10_0 (or (<= main@%_6_0 0) (> main@%_40_0 0)))
                (=> main@_bb10_0 (> main@%_6_0 0))
                (=> main@_bb10_0
                    (= main@%_41_0 (select main@%shadow.mem.4.1_0 main@%_40_0)))
                (=> main@_bb10_0 (= main@%_42_0 main@%_18_0))
                (=> main@_bb10_0 (= main@%_43_0 (+ main@%_42_0 1)))
                a!5
                (=> main@_bb10_0 (or (<= main@%_6_0 0) (> main@%_44_0 0)))
                (=> main@_bb10_0 (> main@%_6_0 0))
                (=> main@_bb10_0
                    (= main@%_45_0 (select main@%shadow.mem.4.1_0 main@%_44_0)))
                (=> main@_bb10_0 (= main@%_46_0 (+ main@%_41_0 main@%_45_0)))
                (=> main@_bb10_0 (= main@%_47_0 main@%_18_0))
                a!6
                (=> main@_bb10_0 (or (<= main@%_6_0 0) (> main@%_48_0 0)))
                (=> main@_bb10_0 (> main@%_6_0 0))
                (=> main@_bb10_0
                    (= main@%sm3_0
                       (store main@%shadow.mem.4.1_0 main@%_48_0 main@%_46_0)))
                (=> main@_bb10_0 (= main@%_49_0 @__VERIFIER_nondet_int_0))
                (=> main@_bb10_0 (= main@%_51_0 (= main@%_50_0 0)))
                (=> main@_bb11_0 (and main@_bb11_0 main@_bb10_0))
                (=> (and main@_bb11_0 main@_bb10_0) (not main@%_51_0))
...
(let ((a!7 (and (main@_bb8 main@%_4_0
                ...
                (=> (and main@_bb12_0 main@_bb10_0) main@%_51_0)
  ...
  (=> a!7
      (main@_bb13 main@%_4_0
                  ...
                  main@%sm3_0
                  main@%_1_0)))))
(rule (let ((a!1 (=> main@_bb14_0 (= main@%_58_0 (+ main@%_4_0 (* main@%.1.i_0 4)))))
      (a!2 (=> main@_bb14_0 (= main@%_62_0 (+ main@%_6_0 (* main@%.1.i_0 4))))))
(let ((a!3 (and (main@_bb13 main@%_4_0
                            ...
                            main@%_1_0)
                true
                (= main@%_55_0 main@%_1_0)
                (= main@%_56_0 (< main@%.1.i_0 main@%_55_0))
                (=> main@_bb14_0 (and main@_bb14_0 main@_bb13_0))
                (=> (and main@_bb14_0 main@_bb13_0) main@%_56_0)
                a!1
                (=> main@_bb14_0 (or (<= main@%_4_0 0) (> main@%_58_0 0)))
                (=> main@_bb14_0 (> main@%_4_0 0))
                (=> main@_bb14_0
                    (= main@%_59_0 (select main@%sm2_0 main@%_58_0)))
                (=> main@_bb14_0 (= main@%_60_0 main@%_59_0))
                (=> main@_bb14_0 (= main@%_61_0 (+ main@%.0.i_0 main@%_60_0)))
                a!2
                (=> main@_bb14_0 (or (<= main@%_6_0 0) (> main@%_62_0 0)))
                (=> main@_bb14_0 (> main@%_6_0 0))
                (=> main@_bb14_0
                    (= main@%_63_0 (select main@%sm3_0 main@%_62_0)))
                (=> main@_bb14_0 (= main@%_64_0 main@%_63_0))
                (=> main@_bb14_0 (= main@%_65_0 (+ main@%_61_0 main@%_64_0)))
                (=> main@_bb14_0 (= main@%_66_0 (+ main@%.1.i_0 1)))
                (=> main@_bb13_1 (and main@_bb13_1 main@_bb14_0))
                (=> (and main@_bb13_1 main@_bb14_0)
                    (= main@%.1.i_1 main@%_66_0))
                (=> (and main@_bb13_1 main@_bb14_0)
                    (= main@%.0.i_1 main@%_65_0))
                (=> (and main@_bb13_1 main@_bb14_0)
...
(rule (let ((a!1 (and (main@_bb13 main@%_4_0
                ...
                (=> (and main@orig.main.exit_0 main@_bb13_0) (not main@%_56_0))
                (=> main@orig.main.exit_0 (= main@%_67_0 (= main@%.0.i_0 0)))
                (=> main@orig.main.exit_0 (= main@%_68_0 (ite main@%_67_0 1 0)))
                (=> main@orig.main.exit_0 (not main@%_69_0))
                ...
                (=> main@__JVERIFIER_assert_0 (= main@%_70_0 (= main@%_68_0 0)))
                (=> main@__JVERIFIER_assert_0 main@%_70_0)
