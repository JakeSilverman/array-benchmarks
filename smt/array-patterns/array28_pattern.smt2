(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-V4ei9n/array28_pattern.pp.ms.o.bc")
...
(rule (let ((a!1 (and (main@_bb14 main@%_4_0
                ...
                (=> main@__JVERIFIER_assert_0 (= main@%_58_0 (= main@%_56_0 0)))
                (=> main@__JVERIFIER_assert_0 main@%_58_0)
...
(let ((a!3 (and (main@_bb16 main@%_4_0
                ...
                (=> main@_bb17_0 (= main@%_50_0 main@%_49_0))
                (=> main@_bb17_0 (= main@%_51_0 (+ main@%.1.i_0 main@%_50_0)))
                (=> main@_bb17_0 (= main@%_52_0 (+ main@%.14.i_0 1)))
                (=> main@_bb16_1 (and main@_bb16_1 main@_bb17_0))
                (=> (and main@_bb16_1 main@_bb17_0)
                    (= main@%.14.i_1 main@%_52_0))
                (=> (and main@_bb16_1 main@_bb17_0)
...
(rule (let ((a!1 (and (main@_bb5 main@%.03.i_0
  ...
  (=> a!1
      (main@_bb main@%.01.i_2
                ...
                main@%shadow.mem.0.0_1
                main@%_1_0))))
(rule (let ((a!1 (=> main@_bb10_0 (= main@%_31_0 (+ main@%_6_0 (* main@%_30_0 4)))))
      (a!2 (=> main@_bb10_0 (= main@%_32_0 (+ main@%_31_0 (* main@%.03.i_0 4)))))
      (a!3 (=> main@_bb9_0 (= main@%_27_0 (+ main@%_6_0 (* main@%_26_0 4)))))
      (a!4 (=> main@_bb9_0 (= main@%_28_0 (+ main@%_27_0 (* main@%.03.i_0 4)))))
      (a!5 (=> main@_bb7_0 (= main@%_19_0 (+ main@%_6_0 (* main@%_18_0 4)))))
      (a!6 (=> main@_bb7_0 (= main@%_20_0 (+ main@%_19_0 (* main@%.03.i_0 4))))))
(let ((a!7 (and (main@_bb5 main@%.03.i_0
                           main@%shadow.mem.0.1_0
                           main@%.01.i_0
                           main@%_4_0
                           main@%_6_0
                ...
                (=> main@_bb6_0 (= main@%_15_0 (> main@%.01.i_0 main@%.03.i_0)))
                (=> main@_bb8_0 (and main@_bb8_0 main@_bb6_0))
                (=> (and main@_bb8_0 main@_bb6_0) (not main@%_15_0))
                (=> main@_bb8_0 (= main@%_22_0 (< main@%.01.i_0 main@%.03.i_0)))
                (=> main@_bb10_0 (and main@_bb10_0 main@_bb8_0))
                (=> (and main@_bb10_0 main@_bb8_0) (not main@%_22_0))
                a!1
                (=> main@_bb10_0 (or (<= main@%_6_0 0) (> main@%_31_0 0)))
                a!2
                (=> main@_bb10_0 (or (<= main@%_31_0 0) (> main@%_32_0 0)))
                (=> main@_bb10_0 (> main@%_31_0 0))
                (=> main@_bb10_0
                    (= main@%sm2_0 (store main@%shadow.mem.0.1_0 main@%_32_0 0)))
                (=> main@_bb9_0 (and main@_bb9_0 main@_bb8_0))
                (=> (and main@_bb9_0 main@_bb8_0) main@%_22_0)
                (=> main@_bb9_0 (= main@%_24_0 (+ main@%.01.i_0 main@%.03.i_0)))
                (=> main@_bb9_0 (= main@%_25_0 (- 0 main@%_24_0)))
                a!3
                (=> main@_bb9_0 (or (<= main@%_6_0 0) (> main@%_27_0 0)))
                a!4
                (=> main@_bb9_0 (or (<= main@%_27_0 0) (> main@%_28_0 0)))
                (=> main@_bb9_0 (> main@%_27_0 0))
                (=> main@_bb9_0
                    (= main@%sm1_0
                       (store main@%shadow.mem.0.1_0 main@%_28_0 main@%_25_0)))
                (=> main@_bb7_0 (and main@_bb7_0 main@_bb6_0))
                (=> (and main@_bb7_0 main@_bb6_0) main@%_15_0)
                (=> main@_bb7_0 (= main@%_17_0 (+ main@%.01.i_0 main@%.03.i_0)))
                a!5
                (=> main@_bb7_0 (or (<= main@%_6_0 0) (> main@%_19_0 0)))
                a!6
                (=> main@_bb7_0 (or (<= main@%_19_0 0) (> main@%_20_0 0)))
                (=> main@_bb7_0 (> main@%_19_0 0))
                (=> main@_bb7_0
                    (= main@%sm_0
