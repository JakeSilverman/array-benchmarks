(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-Tu7PCA/array4_pattern.pp.ms.o.bc")
(set-info :authors "SeaHorn v.0.1.0-rc3")
(declare-rel verifier.error (Bool Bool Bool ))
(declare-rel main@entry (Int Int ))
(declare-rel main@_bb (Int Int (Array Int Int) Int (Array Int Int) Int Int Int ))
(declare-rel main@_bb8 (Int Int Int Int (Array Int Int) (Array Int Int) Int Int ))
(declare-rel main@_bb11 (Int Int Int (Array Int Int) Int (Array Int Int) Int ))
...
(rule (=> (and (main@_bb main@%_4_0
         ...
         (=> (and main@_bb8_0 main@_bb7_0) (= main@%.1.i_0 1))
         (=> (and main@_bb8_0 main@_bb7_0)
...
(rule (let ((a!1 (and (main@_bb8 main@%_4_0
                ...
                (= main@%_18_0 @__VERIFIER_nondet_short_0)
                (= main@%_20_0 (> main@%_17_0 (- 1)))
                (= main@%_21_0 (< main@%_17_0 main@%_1_0))
                (= main@%..i_0 (and main@%_20_0 main@%_21_0))
                main@%..i_0
                (= main@%_22_0 (> main@%_19_0 (- 1)))
                (= main@%_23_0 (< main@%_19_0 main@%_1_0))
                (= main@%_24_0 (and main@%_22_0 main@%_23_0))
                main@%_24_0
                ...
                main@%_28_0
                (= main@%_29_0 main@%_19_0)
                (= main@%_30_0 (+ main@%_6_0 (* main@%_29_0 4)))
                ...
                (= main@%_34_0 (+ main@%_4_0 (* main@%_33_0 4)))
                (or (<= main@%_4_0 0) (> main@%_34_0 0))
                (> main@%_4_0 0)
                (= main@%sm2_0
                   (store main@%shadow.mem.0.1_0 main@%_34_0 main@%.1.i_0))
                (= main@%_35_0 (- 0 main@%.1.i_0))
                (= main@%_36_0 main@%_19_0)
                (= main@%_37_0 (+ main@%_6_0 (* main@%_36_0 4)))
                (or (<= main@%_6_0 0) (> main@%_37_0 0))
                (> main@%_6_0 0)
                (= main@%sm3_0
                   (store main@%shadow.mem.4.1_0 main@%_37_0 main@%_35_0))
                (= main@%_38_0 @__VERIFIER_nondet_int_0)
                (= main@%_40_0 (= main@%_39_0 0))
                (=> main@_bb9_0 (and main@_bb9_0 main@_bb8_0))
                (=> (and main@_bb9_0 main@_bb8_0) (not main@%_40_0))
                (=> main@_bb9_0 (= main@%_42_0 (+ main@%.1.i_0 1)))
                ...
                (=> (and main@_bb8_1 main@_bb9_0) (= main@%.1.i_1 main@%_42_0))
                (=> (and main@_bb8_1 main@_bb9_0)
...
(rule (let ((a!1 (and (main@_bb8 main@%_4_0
                ...
                (=> (and main@_bb10_0 main@_bb8_0) main@%_40_0)
  ...
  (=> a!1
      (main@_bb11 main@%_4_0
                  ...
                  main@%sm3_0
                  main@%_1_0))))
(rule (let ((a!1 (=> main@_bb12_0 (= main@%_48_0 (+ main@%_4_0 (* main@%.2.i_0 4)))))
      (a!2 (=> main@_bb12_0 (= main@%_52_0 (+ main@%_6_0 (* main@%.2.i_0 4))))))
(let ((a!3 (and (main@_bb11 main@%_4_0
                ...
                (= main@%_46_0 (< main@%.2.i_0 main@%_45_0))
                (=> main@_bb12_0 (and main@_bb12_0 main@_bb11_0))
                (=> (and main@_bb12_0 main@_bb11_0) main@%_46_0)
                a!1
                (=> main@_bb12_0 (or (<= main@%_4_0 0) (> main@%_48_0 0)))
                (=> main@_bb12_0 (> main@%_4_0 0))
                (=> main@_bb12_0
                    (= main@%_49_0 (select main@%sm2_0 main@%_48_0)))
                (=> main@_bb12_0 (= main@%_50_0 main@%_49_0))
                (=> main@_bb12_0 (= main@%_51_0 (+ main@%.0.i_0 main@%_50_0)))
                a!2
                (=> main@_bb12_0 (or (<= main@%_6_0 0) (> main@%_52_0 0)))
                (=> main@_bb12_0 (> main@%_6_0 0))
                (=> main@_bb12_0
                    (= main@%_53_0 (select main@%sm3_0 main@%_52_0)))
                (=> main@_bb12_0 (= main@%_54_0 main@%_53_0))
                (=> main@_bb12_0 (= main@%_55_0 (+ main@%_51_0 main@%_54_0)))
                (=> main@_bb12_0 (= main@%_56_0 (+ main@%.2.i_0 1)))
                (=> main@_bb11_1 (and main@_bb11_1 main@_bb12_0))
                (=> (and main@_bb11_1 main@_bb12_0)
                    (= main@%.2.i_1 main@%_56_0))
                (=> (and main@_bb11_1 main@_bb12_0)
                    (= main@%.0.i_1 main@%_55_0))
                (=> (and main@_bb11_1 main@_bb12_0)
...
(rule (let ((a!1 (and (main@_bb11 main@%_4_0
                ...
                (=> (and main@orig.main.exit_0 main@_bb11_0) (not main@%_46_0))
                (=> main@orig.main.exit_0 (= main@%_57_0 (= main@%.0.i_0 0)))
                ...
                (=> main@__JVERIFIER_assert_0 (= main@%_60_0 (= main@%_58_0 0)))
                (=> main@__JVERIFIER_assert_0 main@%_60_0)
