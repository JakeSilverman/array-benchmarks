(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-NDMgnO/array27_pattern.pp.ms.o.bc")
...
(rule (let ((a!1 (and (main@_bb11 main@%_4_0
                ...
                (=> main@__VERIFIER_assert_0 (= main@%_56_0 (= main@%_54_0 0)))
...
(let ((a!4 (and (main@_bb4 main@%.03.i_0
                ...
                (=> main@_bb7_0
                    (= main@%sm1_0
                       (store main@%shadow.mem.0.1_0 main@%_21_0 main@%.01.i_0)))
