(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-qPPkx2/partial_mod_count_limited_1.pp.ms.o.bc")
...
(rule (let ((a!1 (=> main@_bb3_0
               (= main@%_11_0 (+ main@%_0_0 (* 0 4000000) (* main@%.0.i_0 4)))))
      (a!2 (=> main@_bb4_0
...
(let ((a!4 (and (main@_bb main@%_0_0
                ...
                (=> main@_bb3_0 (= main@%_12_0 (< main@%.03.i_0 main@%_1_0)))
                ...
                (=> main@_bb5_0
                    (= main@%..03.i_0 (+ main@%.03.i_0 main@%_19_0)))
...
(rule (let ((a!1 (=> main@_bb8_0
      ...
      (a!2 (=> main@_bb8_0
               (= main@%_29_0
                  (ite (>= main@%..01.i_0 0) (< main@%..01.i_0 1000000) false)))))
(let ((a!3 (and (main@_bb7 main@%_0_0
                ...
                (=> main@_bb8_0
                    (= main@%..01.i_0 (+ main@%.01.i_0 main@%_28_0)))
                a!2
