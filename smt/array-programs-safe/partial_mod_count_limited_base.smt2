(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-cAmGOw/partial_mod_count_limited_base.pp.ms.o.bc")
...
(rule (let ((a!1 (=> main@_bb3_0
               (= main@%_9_0 (+ main@%_0_0 (* 0 4000000) (* main@%.0.i_0 4)))))
      (a!2 (=> main@_bb4_0
               (= main@%_14_0 (+ main@%_0_0 (* 0 4000000) (* main@%.0.i_0 4)))))
      (a!3 (=> main@_bb5_0
               (= main@%_16_0 (+ main@%_0_0 (* 0 4000000) (* main@%.0.i_0 4))))))
(let ((a!4 (and (main@_bb main@%_0_0
                ...
                (=> main@_bb3_0 (= main@%_10_0 (> main@%.0.i_0 500000)))
                (=> main@_bb3_0 (= main@%_11_0 (< main@%.04.i_0 1)))
                (=> main@_bb3_0
                ...
                (=> main@_bb5_0
                    (= main@%..04.i_0 (+ main@%.04.i_0 main@%_19_0)))
                (=> main@_bb5_0 (= main@%_20_0 (+ main@%.0.i_0 1)))
                (=> main@_bb_1 (and main@_bb_1 main@_bb5_0))
                (=> (and main@_bb_1 main@_bb5_0)
                    (= main@%shadow.mem.0.0_1 main@%shadow.mem.0.1_2))
                (=> (and main@_bb_1 main@_bb5_0)
                    (= main@%.04.i_1 main@%..04.i_0))
                (=> (and main@_bb_1 main@_bb5_0) (= main@%.0.i_1 main@%_20_0))
                (=> (and main@_bb_1 main@_bb5_0)
...
(rule (=> (and (main@_bb main@%_0_0
         ...
         (=> (and main@_bb7_0 main@_bb6_0) (= main@%.02.i_0 0))
         (=> (and main@_bb7_0 main@_bb6_0) (= main@%.1.i_0 0))
         (=> (and main@_bb7_0 main@_bb6_0) (= main@%.02.i_1 main@%.02.i_0))
         (=> (and main@_bb7_0 main@_bb6_0) (= main@%.1.i_1 main@%.1.i_0))
         main@_bb7_0)
    (main@_bb7 main@%_0_0 main@%shadow.mem.0.0_0 main@%.1.i_1 main@%.02.i_1)))
(rule (let ((a!1 (=> main@_bb8_0
               (= main@%_25_0 (+ main@%_0_0 (* 0 4000000) (* main@%.1.i_0 4))))))
(let ((a!2 (and (main@_bb7 main@%_0_0
                           main@%shadow.mem.0.0_0
                           main@%.1.i_0
                           main@%.02.i_0)
                true
                (= main@%_23_0 (< main@%.1.i_0 1000000))
                main@%_23_0
                ...
                (=> main@_bb8_0
                    (= main@%..02.i_0 (+ main@%.02.i_0 main@%_28_0)))
                (=> main@_bb8_0 (= main@%_29_0 (< main@%..02.i_0 2)))
                ...
                (=> main@postcall_0 (= main@%_32_0 (+ main@%.1.i_0 1)))
                ...
                main@_bb7_1)))
  (=> a!2
      (main@_bb7 main@%_0_0 main@%shadow.mem.0.0_0 main@%.1.i_2 main@%.02.i_2)))))
(rule (let ((a!1 (=> main@_bb8_0
               (= main@%_25_0 (+ main@%_0_0 (* 0 4000000) (* main@%.1.i_0 4))))))
(let ((a!2 (and (main@_bb7 main@%_0_0
                           main@%shadow.mem.0.0_0
