(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-3108Re/partial_mod_count_limited_4.pp.ms.o.bc")
...
(rule (let ((a!1 (and main@entry
                ...
                (= main@%_6_0 (ite (>= main@%_2_0 0) (< main@%_2_0 250) false))
...
(let ((a!4 (and (main@_bb main@%_0_0
                ...
                (=> main@_bb4_0 (= main@%_15_0 (rem main@%.0.i_0 4)))
                a!2
...
(rule (let ((a!1 (=> main@_bb8_0
      ...
      (a!2 (=> main@_bb8_0
               (= main@%_31_0
                  (ite (>= main@%..01.i_0 0) (< main@%..01.i_0 125) false)))))
