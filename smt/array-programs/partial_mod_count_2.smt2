(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-FBZEaa/partial_mod_count_2.pp.ms.o.bc")
...
(let ((a!3 (and (main@_bb main@%.01.i_0 main@%shadow.mem.0.0_0 main@%_0_0)
                ...
                (=> main@_bb4_0 (= main@%_9_0 (rem main@%.01.i_0 2)))
                a!2
...
(let ((a!2 (and (main@_bb7 main@%shadow.mem.0.0_0
                ...
                (=> main@_bb8_0 (= main@%_21_0 (< main@%..0.i_0 250000)))
