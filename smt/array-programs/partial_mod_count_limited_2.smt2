(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-Ra1Fz2/partial_mod_count_limited_2.pp.ms.o.bc")
...
(rule (let ((a!1 (and main@entry
                ...
                (= main@%_4_0 (ite (>= main@%_2_0 0) (< main@%_2_0 500) false))
...
(let ((a!4 (and (main@_bb main@%_0_0
                ...
                (=> main@_bb4_0 (= main@%_13_0 (rem main@%.01.i_0 2)))
                a!2
...
(rule (let ((a!1 (=> main@_bb8_0
      ...
      (a!2 (=> main@_bb8_0
               (= main@%_29_0
                  (ite (>= main@%..03.i_0 0) (< main@%..03.i_0 250) false)))))
