(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-awds1z/array_of_struct_loop_dep.pp.ms.o.bc")
...
(let ((a!2 (and (main@_bb6 @a_0 main@%.1.i_0 main@%shadow.mem.0.1_0)
                ...
                (=> main@__VERIFIER_assert_0 (= main@%_20_0 (= main@%_12_0 0)))
