(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-Hfxk6k/array_range_init.pp.ms.o.bc")
...
(rule (let ((a!1 (=> main@_bb3_0
               (= main@%_3_0
                  (ite (>= main@%.0.i_0 0) (< main@%.0.i_0 10001) false))))
      (a!2 (=> main@_bb3_0
               (= main@%_4_0 (+ @a_0 (* 0 400000) (* main@%.0.i_0 4))))))
(let ((a!3 (and (main@_bb main@%.0.i_0 @a_0 main@%shadow.mem.0.0_0)
                ...
                a!1
                a!2
                (=> main@_bb3_0 (or (<= @a_0 0) (> main@%_4_0 0)))
                (=> main@_bb3_0 (= main@%..i_0 (ite main@%_3_0 10 0)))
                (=> main@_bb3_0 (> @a_0 0))
                (=> main@_bb3_0
                    (= main@%sm1_0
                       (store main@%shadow.mem.0.0_0 main@%_4_0 main@%..i_0)))
                (=> main@_bb3_0 (= main@%_5_0 (+ main@%.0.i_0 1)))
                (=> main@_bb_1 (and main@_bb_1 main@_bb3_0))
                (=> (and main@_bb_1 main@_bb3_0)
                    (= main@%shadow.mem.0.0_1 main@%sm1_0))
                (=> (and main@_bb_1 main@_bb3_0) (= main@%.0.i_1 main@%_5_0))
                (=> (and main@_bb_1 main@_bb3_0)
...
(rule (let ((a!1 (=> main@_bb6_0
               (= main@%_10_0 (+ @a_0 (* 0 400000) (* main@%.1.i_0 4))))))
(let ((a!2 (and (main@_bb5 @a_0 main@%shadow.mem.0.1_0 main@%.1.i_0)
                ...
                (=> main@_bb6_0 (= main@%_12_0 (= main@%_11_0 10)))
...
(let ((a!2 (and (main@_bb5 @a_0 main@%shadow.mem.0.1_0 main@%.1.i_0)
                ...
                (=> main@__JVERIFIER_assert_0 (= main@%_16_0 (= main@%_13_0 0)))
                (=> main@__JVERIFIER_assert_0 main@%_16_0)
