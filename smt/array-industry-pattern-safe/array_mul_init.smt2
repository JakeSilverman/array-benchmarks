(set-info :original "/var/folders/xz/sgqbj6yn0yv_1mpy6_jqympm0000gn/T/sea-ZT32Xt/array_mul_init.pp.ms.o.bc")
...
(declare-rel main@_bb (Int Int (Array Int Int) Int (Array Int Int) Int ))
(declare-rel main@_bb8 (Int Int Int (Array Int Int) (Array Int Int) Int ))
(declare-rel main@_bb13 (Int Int (Array Int Int) (Array Int Int) Int ))
...
(rule (let ((a!1 (=> main@_bb6_0
      ...
      (a!2 (=> main@_bb6_0
               (= main@%_8_0 (+ main@%_1_0 (* 0 400000) (* main@%.0.i_0 4))))))
(let ((a!3 (and (main@_bb main@%_0_0
                ...
                (=> main@_bb6_0
                    (= main@%sm_0
                       (store main@%shadow.mem.0.0_0 main@%_7_0 main@%.0.i_0)))
                a!2
                (=> main@_bb6_0 (or (<= main@%_1_0 0) (> main@%_8_0 0)))
                (=> main@_bb6_0 (> main@%_1_0 0))
                (=> main@_bb6_0
                    (= main@%sm1_0
                       (store main@%shadow.mem.4.0_0 main@%_8_0 main@%.0.i_0)))
                (=> main@_bb6_0 (= main@%_9_0 (+ main@%.0.i_0 1)))
                ...
                (=> (and main@_bb_1 main@_bb6_0) (= main@%.0.i_1 main@%_9_0))
                (=> (and main@_bb_1 main@_bb6_0)
...
(rule (let ((a!1 (=> main@_bb10_0
               (= main@%_21_0 (+ main@%_0_0 (* 0 400000) (* main@%.1.i_0 4)))))
      (a!2 (=> main@_bb10_0
               (= main@%_23_0 (+ main@%_1_0 (* 0 400000) (* main@%.1.i_0 4))))))
(let ((a!3 (and (main@_bb8 main@%_0_0
                ...
                (=> (and main@_bb9_0 main@_bb8_0) main@%_12_0)
                (=> main@_bb9_0 (= main@%_14_0 @__VERIFIER_nondet_short_0))
                (=> main@_bb9_0 (= main@%_16_0 (= main@%_15_0 0)))
                (=> main@_bb10_0 (and main@_bb10_0 main@_bb9_0))
                (=> (and main@_bb10_0 main@_bb9_0) (not main@%_16_0))
                (=> main@_bb10_0 (= main@%_18_0 @__VERIFIER_nondet_short_0))
                (=> main@_bb10_0 (= main@%_20_0 main@%_19_0))
                a!1
                (=> main@_bb10_0 (or (<= main@%_0_0 0) (> main@%_21_0 0)))
                (=> main@_bb10_0 (> main@%_0_0 0))
                (=> main@_bb10_0
                    (= main@%sm2_0
                       (store main@%shadow.mem.0.1_0 main@%_21_0 main@%_20_0)))
                a!2
                (=> main@_bb10_0 (or (<= main@%_1_0 0) (> main@%_23_0 0)))
                (=> main@_bb10_0 (> main@%_1_0 0))
                (=> main@_bb10_0
                    (= main@%sm3_0
                       (store main@%shadow.mem.4.1_0 main@%_23_0 main@%_22_0)))
                (=> |tuple(main@_bb9_0, main@_bb11_0)| main@_bb9_0)
                (=> main@_bb11_0
                    (or (and main@_bb11_0 main@_bb10_0)
                        |tuple(main@_bb9_0, main@_bb11_0)|))
                (=> |tuple(main@_bb9_0, main@_bb11_0)| main@%_16_0)
...
(rule (=> (and (main@_bb8 main@%_0_0
         ...
         (=> (and main@_bb12_0 main@_bb8_0) (not main@%_12_0))
...
(rule (let ((a!1 (=> main@_bb14_0
               (= main@%_30_0 (+ main@%_0_0 (* 0 400000) (* main@%.2.i_0 4)))))
      (a!2 (=> main@_bb14_0
               (= main@%_32_0 (+ main@%_1_0 (* 0 400000) (* main@%.2.i_0 4)))))
      (a!3 (=> main@_bb15_0
               (= main@%_36_0 (+ main@%_1_0 (* 0 400000) (* main@%.2.i_0 4)))))
      (a!4 (=> main@_bb15_0
               (= main@%_38_0 (+ main@%_0_0 (* 0 400000) (* main@%.2.i_0 4))))))
(let ((a!5 (and (main@_bb13 main@%_0_0
                            main@%_1_0
                            main@%shadow.mem.0.1_0
                            main@%shadow.mem.4.1_0
                            main@%.2.i_0)
                ...
                a!1
                (=> main@_bb14_0 (or (<= main@%_0_0 0) (> main@%_30_0 0)))
                (=> main@_bb14_0 (> main@%_0_0 0))
                (=> main@_bb14_0
                    (= main@%_31_0 (select main@%shadow.mem.0.1_0 main@%_30_0)))
                a!2
                (=> main@_bb14_0 (or (<= main@%_1_0 0) (> main@%_32_0 0)))
                (=> main@_bb14_0 (> main@%_1_0 0))
                (=> main@_bb14_0
                    (= main@%_33_0 (select main@%shadow.mem.4.1_0 main@%_32_0)))
                ...
                a!3
                (=> main@_bb15_0 (or (<= main@%_1_0 0) (> main@%_36_0 0)))
                (=> main@_bb15_0 (> main@%_1_0 0))
                (=> main@_bb15_0
                    (= main@%_37_0 (select main@%shadow.mem.4.1_0 main@%_36_0)))
                a!4
                (=> main@_bb15_0 (or (<= main@%_0_0 0) (> main@%_38_0 0)))
                (=> main@_bb15_0 (> main@%_0_0 0))
                (=> main@_bb15_0
                    (= main@%_39_0 (select main@%shadow.mem.0.1_0 main@%_38_0)))
                (=> main@_bb15_0 (= main@%_41_0 (= main@%_37_0 main@%_40_0)))
                ...
                (=> (and main@_bb16_0 main@_bb15_0) (= main@%_43_0 main@%_41_0))
                (=> |tuple(main@_bb14_0, main@_bb16_0)| (= main@%_43_1 true))
                (=> (and main@_bb16_0 main@_bb15_0) (= main@%_43_2 main@%_43_0))
                (=> |tuple(main@_bb14_0, main@_bb16_0)|
                    (= main@%_43_2 main@%_43_1))
                (=> main@_bb16_0 (= main@%_44_0 (ite main@%_43_2 1 0)))
                ...
                (=> main@postcall_0 (= main@%_46_0 (+ main@%.2.i_0 1)))
