...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "relax-2-2.c", 91, __extension__ __PRETTY_FUNCTION__); })); }



void __ORIG_VERIFIER_assert(int cond) {
