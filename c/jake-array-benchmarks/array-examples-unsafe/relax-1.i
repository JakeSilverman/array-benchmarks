# 0 "./array-examples-unsafe/relax-1.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "./array-examples-unsafe/relax-1.c"
extern void __VERIFIER_assume(int);
extern unsigned long __VERIFIER_nondet_ulong(void);
extern int __VERIFIER_nondet_int();
# 86 "./array-examples-unsafe/relax-1.c"
...
# 96 "./array-examples-unsafe/relax-1.c" 2


# 97 "./array-examples-unsafe/relax-1.c"
...
int main()
{
  ...
  {
    __JVERIFIER_assert(pat_len<=a_len+1);
    ...
    a[i] = __VERIFIER_nondet_int();
        if(i<different)
          ...
          __JVERIFIER_assert(pat[i]==a[i-1]);
    }
  }
  else if(pat_len<=a_len+1)
  {
    ...
    if(pat_len>a_len)
      ++differences;
    __JVERIFIER_assert(differences>1);
  }
