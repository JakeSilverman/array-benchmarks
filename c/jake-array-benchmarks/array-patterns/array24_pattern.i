# 0 "./array-patterns/array24_pattern.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "./array-patterns/array24_pattern.c"
# 26 "./array-patterns/array24_pattern.c"
...
int main()
{
 ...
 while(1)
  ...
  array[index1][index2] = (outerBoundaryPatternCheck(index1)||outerBoundaryPatternCheck(index2)) ? array[index1][index2] : (num*num) ;
 ...
 __JVERIFIER_assert(sum >= 0 && sum <= (ARR_SIZE-2)*(ARR_SIZE-2)) ;
 return 0 ;
}
