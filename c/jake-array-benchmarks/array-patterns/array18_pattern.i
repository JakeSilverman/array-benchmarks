# 0 "./array-patterns/array18_pattern.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "./array-patterns/array18_pattern.c"
# 28 "./array-patterns/array18_pattern.c"
...
int main()
{
 ...
 while(1)
  ...
  array[ARR_SIZE-1-index1][index2] = (index1 == index2) ? (num*num*num*num) : array[ARR_SIZE-1-index1][index2] ;
