# 0 "c/term/loops-safe//veris.c_OpenSER_cases1_stripFullBoth_arr.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "c/term/loops-safe//veris.c_OpenSER_cases1_stripFullBoth_arr.c"
...
# 3 "c/term/loops-safe//veris.c_OpenSER_cases1_stripFullBoth_arr.c" 2

# 3 "c/term/loops-safe//veris.c_OpenSER_cases1_stripFullBoth_arr.c"
void reach_error() { 
# 3 "c/term/loops-safe//veris.c_OpenSER_cases1_stripFullBoth_arr.c" 3 4
                    ((void) sizeof ((
# 3 "c/term/loops-safe//veris.c_OpenSER_cases1_stripFullBoth_arr.c"
                    0
# 3 "c/term/loops-safe//veris.c_OpenSER_cases1_stripFullBoth_arr.c" 3 4
...
# 3 "c/term/loops-safe//veris.c_OpenSER_cases1_stripFullBoth_arr.c"
                    "0"
# 3 "c/term/loops-safe//veris.c_OpenSER_cases1_stripFullBoth_arr.c" 3 4
                    , "c/term/loops-safe//veris.c_OpenSER_cases1_stripFullBoth_arr.c", 3, __extension__ __PRETTY_FUNCTION__); }))
# 3 "c/term/loops-safe//veris.c_OpenSER_cases1_stripFullBoth_arr.c"
                             ; }
...
# 38 "c/term/loops-safe//veris.c_OpenSER_cases1_stripFullBoth_arr.c"
...
# 103 "c/term/loops-safe//veris.c_OpenSER_cases1_stripFullBoth_arr.c"
typedef int NSS_STATUS;



typedef char fstring[2];
# 135 "c/term/loops-safe//veris.c_OpenSER_cases1_stripFullBoth_arr.c"
struct sockaddr_un
{
  char sun_path[2 + 1];
};
