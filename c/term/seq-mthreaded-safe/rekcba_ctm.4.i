# 0 "c/term/seq-mthreaded-safe//rekcba_ctm.4.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "c/term/seq-mthreaded-safe//rekcba_ctm.4.c"
extern void abort(void);
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "rekcba_ctm.4.c", 3, "reach_error"); }
# 16 "c/term/seq-mthreaded-safe//rekcba_ctm.4.c"
...
__inline void __startrek_schedule_jobs(void)
{
  ...
  if(!(__startrek_end_t0[7] <= 55)) {abort();}
  ...
  if(!(__startrek_start_t0[6] <= __startrek_end_t0[6])) {abort();}
  if(!(__startrek_start_t0[7] <= __startrek_end_t0[7])) {abort();}
  ...
  if(!(__startrek_end_t0[5] <= __startrek_start_t0[6] - 1)) {abort();}
  if(!(__startrek_end_t0[6] <= __startrek_start_t0[7] - 1)) {abort();}
  ...
  if(!(__startrek_end_t1[15] <= 55)) {abort();}
  ...
  if(!(__startrek_start_t1[12] <= __startrek_end_t1[12])) {abort();}
  if(!(__startrek_start_t1[13] <= __startrek_end_t1[13])) {abort();}
  if(!(__startrek_start_t1[14] <= __startrek_end_t1[14])) {abort();}
  if(!(__startrek_start_t1[15] <= __startrek_end_t1[15])) {abort();}
  ...
  if(!(__startrek_end_t1[11] <= __startrek_start_t1[12] - 1)) {abort();}
  if(!(__startrek_end_t1[12] <= __startrek_start_t1[13] - 1)) {abort();}
  if(!(__startrek_end_t1[13] <= __startrek_start_t1[14] - 1)) {abort();}
  if(!(__startrek_end_t1[14] <= __startrek_start_t1[15] - 1)) {abort();}
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t1[0]) {
    if (__startrek_start_t1[0] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t1[0])) {abort();}
      if(!(__startrek_end_t1[0] < __startrek_end_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t1[0]) {
    if (__startrek_start_t1[0] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t1[0])) {abort();}
      if(!(__startrek_end_t1[0] < __startrek_end_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t1[1]) {
    if (__startrek_start_t1[1] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t1[1])) {abort();}
      if(!(__startrek_end_t1[1] < __startrek_end_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t1[1]) {
    if (__startrek_start_t1[1] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t1[1])) {abort();}
      if(!(__startrek_end_t1[1] < __startrek_end_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t1[2]) {
    if (__startrek_start_t1[2] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t1[2])) {abort();}
      if(!(__startrek_end_t1[2] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t1[0] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t1[2]) {
    if (__startrek_start_t1[2] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t1[2])) {abort();}
      if(!(__startrek_end_t1[2] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t1[0] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t1[3]) {
    if (__startrek_start_t1[3] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t1[3])) {abort();}
      if(!(__startrek_end_t1[3] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t1[1] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t1[3]) {
    if (__startrek_start_t1[3] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t1[3])) {abort();}
      if(!(__startrek_end_t1[3] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t1[1] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t1[4]) {
    if (__startrek_start_t1[4] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t1[4])) {abort();}
      if(!(__startrek_end_t1[4] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t1[2] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t1[4]) {
    if (__startrek_start_t1[4] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t1[4])) {abort();}
      if(!(__startrek_end_t1[4] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t1[2] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t1[5]) {
    if (__startrek_start_t1[5] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t1[5])) {abort();}
      if(!(__startrek_end_t1[5] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t1[3] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t1[5]) {
    if (__startrek_start_t1[5] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t1[5])) {abort();}
      if(!(__startrek_end_t1[5] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t1[3] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t1[6]) {
    if (__startrek_start_t1[6] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t1[6])) {abort();}
      if(!(__startrek_end_t1[6] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t1[4] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t1[6]) {
    if (__startrek_start_t1[6] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t1[6])) {abort();}
      if(!(__startrek_end_t1[6] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t1[4] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t1[7]) {
    if (__startrek_start_t1[7] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t1[7])) {abort();}
      if(!(__startrek_end_t1[7] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t1[5] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t1[7]) {
    if (__startrek_start_t1[7] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t1[7])) {abort();}
      if(!(__startrek_end_t1[7] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t1[5] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t1[8]) {
    if (__startrek_start_t1[8] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t1[8])) {abort();}
      if(!(__startrek_end_t1[8] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t1[6] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t1[8]) {
    if (__startrek_start_t1[8] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t1[8])) {abort();}
      if(!(__startrek_end_t1[8] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t1[6] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t1[9]) {
    if (__startrek_start_t1[9] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t1[9])) {abort();}
      if(!(__startrek_end_t1[9] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t1[7] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t1[9]) {
    if (__startrek_start_t1[9] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t1[9])) {abort();}
      if(!(__startrek_end_t1[9] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t1[7] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t1[10]) {
    if (__startrek_start_t1[10] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t1[10])) {abort();}
      if(!(__startrek_end_t1[10] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t1[8] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t1[10]) {
    if (__startrek_start_t1[10] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t1[10])) {abort();}
      if(!(__startrek_end_t1[10] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t1[8] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t1[11]) {
    if (__startrek_start_t1[11] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t1[11])) {abort();}
      if(!(__startrek_end_t1[11] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t1[9] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t1[11]) {
    if (__startrek_start_t1[11] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t1[11])) {abort();}
      if(!(__startrek_end_t1[11] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t1[9] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[0] <= __startrek_end_t1[12]) {
    if (__startrek_start_t1[12] <= __startrek_end_t0[0]) {
      {
      if(!(__startrek_start_t0[0] <= __startrek_start_t1[12])) {abort();}
      if(!(__startrek_end_t1[12] < __startrek_end_t0[0])) {abort();}
      if(!(__startrek_end_t1[10] < __startrek_start_t0[0])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[1] <= __startrek_end_t1[12]) {
    if (__startrek_start_t1[12] <= __startrek_end_t0[1]) {
      {
      if(!(__startrek_start_t0[1] <= __startrek_start_t1[12])) {abort();}
      if(!(__startrek_end_t1[12] < __startrek_end_t0[1])) {abort();}
      if(!(__startrek_end_t1[10] < __startrek_start_t0[1])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[2] <= __startrek_end_t1[12]) {
    if (__startrek_start_t1[12] <= __startrek_end_t0[2]) {
      {
      if(!(__startrek_start_t0[2] <= __startrek_start_t1[12])) {abort();}
      if(!(__startrek_end_t1[12] < __startrek_end_t0[2])) {abort();}
      if(!(__startrek_end_t1[10] < __startrek_start_t0[2])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[3] <= __startrek_end_t1[12]) {
    if (__startrek_start_t1[12] <= __startrek_end_t0[3]) {
      {
      if(!(__startrek_start_t0[3] <= __startrek_start_t1[12])) {abort();}
      if(!(__startrek_end_t1[12] < __startrek_end_t0[3])) {abort();}
      if(!(__startrek_end_t1[10] < __startrek_start_t0[3])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[4] <= __startrek_end_t1[12]) {
    if (__startrek_start_t1[12] <= __startrek_end_t0[4]) {
      {
      if(!(__startrek_start_t0[4] <= __startrek_start_t1[12])) {abort();}
      if(!(__startrek_end_t1[12] < __startrek_end_t0[4])) {abort();}
      if(!(__startrek_end_t1[10] < __startrek_start_t0[4])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[5] <= __startrek_end_t1[12]) {
    if (__startrek_start_t1[12] <= __startrek_end_t0[5]) {
      {
      if(!(__startrek_start_t0[5] <= __startrek_start_t1[12])) {abort();}
      if(!(__startrek_end_t1[12] < __startrek_end_t0[5])) {abort();}
      if(!(__startrek_end_t1[10] < __startrek_start_t0[5])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[6] <= __startrek_end_t1[12]) {
    if (__startrek_start_t1[12] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t1[12])) {abort();}
      if(!(__startrek_end_t1[12] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t1[10] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t1[12]) {
    if (__startrek_start_t1[12] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t1[12])) {abort();}
      if(!(__startrek_end_t1[12] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t1[10] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[0] <= __startrek_end_t1[13]) {
    if (__startrek_start_t1[13] <= __startrek_end_t0[0]) {
      {
      if(!(__startrek_start_t0[0] <= __startrek_start_t1[13])) {abort();}
      if(!(__startrek_end_t1[13] < __startrek_end_t0[0])) {abort();}
      if(!(__startrek_end_t1[11] < __startrek_start_t0[0])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[1] <= __startrek_end_t1[13]) {
    if (__startrek_start_t1[13] <= __startrek_end_t0[1]) {
      {
      if(!(__startrek_start_t0[1] <= __startrek_start_t1[13])) {abort();}
      if(!(__startrek_end_t1[13] < __startrek_end_t0[1])) {abort();}
      if(!(__startrek_end_t1[11] < __startrek_start_t0[1])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[2] <= __startrek_end_t1[13]) {
    if (__startrek_start_t1[13] <= __startrek_end_t0[2]) {
      {
      if(!(__startrek_start_t0[2] <= __startrek_start_t1[13])) {abort();}
      if(!(__startrek_end_t1[13] < __startrek_end_t0[2])) {abort();}
      if(!(__startrek_end_t1[11] < __startrek_start_t0[2])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[3] <= __startrek_end_t1[13]) {
    if (__startrek_start_t1[13] <= __startrek_end_t0[3]) {
      {
      if(!(__startrek_start_t0[3] <= __startrek_start_t1[13])) {abort();}
      if(!(__startrek_end_t1[13] < __startrek_end_t0[3])) {abort();}
      if(!(__startrek_end_t1[11] < __startrek_start_t0[3])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[4] <= __startrek_end_t1[13]) {
    if (__startrek_start_t1[13] <= __startrek_end_t0[4]) {
      {
      if(!(__startrek_start_t0[4] <= __startrek_start_t1[13])) {abort();}
      if(!(__startrek_end_t1[13] < __startrek_end_t0[4])) {abort();}
      if(!(__startrek_end_t1[11] < __startrek_start_t0[4])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[5] <= __startrek_end_t1[13]) {
    if (__startrek_start_t1[13] <= __startrek_end_t0[5]) {
      {
      if(!(__startrek_start_t0[5] <= __startrek_start_t1[13])) {abort();}
      if(!(__startrek_end_t1[13] < __startrek_end_t0[5])) {abort();}
      if(!(__startrek_end_t1[11] < __startrek_start_t0[5])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[6] <= __startrek_end_t1[13]) {
    if (__startrek_start_t1[13] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t1[13])) {abort();}
      if(!(__startrek_end_t1[13] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t1[11] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t1[13]) {
    if (__startrek_start_t1[13] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t1[13])) {abort();}
      if(!(__startrek_end_t1[13] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t1[11] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[0] <= __startrek_end_t1[14]) {
    if (__startrek_start_t1[14] <= __startrek_end_t0[0]) {
      {
      if(!(__startrek_start_t0[0] <= __startrek_start_t1[14])) {abort();}
      if(!(__startrek_end_t1[14] < __startrek_end_t0[0])) {abort();}
      if(!(__startrek_end_t1[12] < __startrek_start_t0[0])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[1] <= __startrek_end_t1[14]) {
    if (__startrek_start_t1[14] <= __startrek_end_t0[1]) {
      {
      if(!(__startrek_start_t0[1] <= __startrek_start_t1[14])) {abort();}
      if(!(__startrek_end_t1[14] < __startrek_end_t0[1])) {abort();}
      if(!(__startrek_end_t1[12] < __startrek_start_t0[1])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[2] <= __startrek_end_t1[14]) {
    if (__startrek_start_t1[14] <= __startrek_end_t0[2]) {
      {
      if(!(__startrek_start_t0[2] <= __startrek_start_t1[14])) {abort();}
      if(!(__startrek_end_t1[14] < __startrek_end_t0[2])) {abort();}
      if(!(__startrek_end_t1[12] < __startrek_start_t0[2])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[3] <= __startrek_end_t1[14]) {
    if (__startrek_start_t1[14] <= __startrek_end_t0[3]) {
      {
      if(!(__startrek_start_t0[3] <= __startrek_start_t1[14])) {abort();}
      if(!(__startrek_end_t1[14] < __startrek_end_t0[3])) {abort();}
      if(!(__startrek_end_t1[12] < __startrek_start_t0[3])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[4] <= __startrek_end_t1[14]) {
    if (__startrek_start_t1[14] <= __startrek_end_t0[4]) {
      {
      if(!(__startrek_start_t0[4] <= __startrek_start_t1[14])) {abort();}
      if(!(__startrek_end_t1[14] < __startrek_end_t0[4])) {abort();}
      if(!(__startrek_end_t1[12] < __startrek_start_t0[4])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[5] <= __startrek_end_t1[14]) {
    if (__startrek_start_t1[14] <= __startrek_end_t0[5]) {
      {
      if(!(__startrek_start_t0[5] <= __startrek_start_t1[14])) {abort();}
      if(!(__startrek_end_t1[14] < __startrek_end_t0[5])) {abort();}
      if(!(__startrek_end_t1[12] < __startrek_start_t0[5])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[6] <= __startrek_end_t1[14]) {
    if (__startrek_start_t1[14] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t1[14])) {abort();}
      if(!(__startrek_end_t1[14] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t1[12] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t1[14]) {
    if (__startrek_start_t1[14] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t1[14])) {abort();}
      if(!(__startrek_end_t1[14] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t1[12] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[0] <= __startrek_end_t1[15]) {
    if (__startrek_start_t1[15] <= __startrek_end_t0[0]) {
      {
      if(!(__startrek_start_t0[0] <= __startrek_start_t1[15])) {abort();}
      if(!(__startrek_end_t1[15] < __startrek_end_t0[0])) {abort();}
      if(!(__startrek_end_t1[13] < __startrek_start_t0[0])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[1] <= __startrek_end_t1[15]) {
    if (__startrek_start_t1[15] <= __startrek_end_t0[1]) {
      {
      if(!(__startrek_start_t0[1] <= __startrek_start_t1[15])) {abort();}
      if(!(__startrek_end_t1[15] < __startrek_end_t0[1])) {abort();}
      if(!(__startrek_end_t1[13] < __startrek_start_t0[1])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[2] <= __startrek_end_t1[15]) {
    if (__startrek_start_t1[15] <= __startrek_end_t0[2]) {
      {
      if(!(__startrek_start_t0[2] <= __startrek_start_t1[15])) {abort();}
      if(!(__startrek_end_t1[15] < __startrek_end_t0[2])) {abort();}
      if(!(__startrek_end_t1[13] < __startrek_start_t0[2])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[3] <= __startrek_end_t1[15]) {
    if (__startrek_start_t1[15] <= __startrek_end_t0[3]) {
      {
      if(!(__startrek_start_t0[3] <= __startrek_start_t1[15])) {abort();}
      if(!(__startrek_end_t1[15] < __startrek_end_t0[3])) {abort();}
      if(!(__startrek_end_t1[13] < __startrek_start_t0[3])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[4] <= __startrek_end_t1[15]) {
    if (__startrek_start_t1[15] <= __startrek_end_t0[4]) {
      {
      if(!(__startrek_start_t0[4] <= __startrek_start_t1[15])) {abort();}
      if(!(__startrek_end_t1[15] < __startrek_end_t0[4])) {abort();}
      if(!(__startrek_end_t1[13] < __startrek_start_t0[4])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[5] <= __startrek_end_t1[15]) {
    if (__startrek_start_t1[15] <= __startrek_end_t0[5]) {
      {
      if(!(__startrek_start_t0[5] <= __startrek_start_t1[15])) {abort();}
      if(!(__startrek_end_t1[15] < __startrek_end_t0[5])) {abort();}
      if(!(__startrek_end_t1[13] < __startrek_start_t0[5])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[6] <= __startrek_end_t1[15]) {
    if (__startrek_start_t1[15] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t1[15])) {abort();}
      if(!(__startrek_end_t1[15] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t1[13] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t1[15]) {
    if (__startrek_start_t1[15] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t1[15])) {abort();}
      if(!(__startrek_end_t1[15] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t1[13] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if(!(__startrek_end_t2[15] <= 55)) {abort();}
  ...
  if(!(__startrek_start_t2[12] <= __startrek_end_t2[12])) {abort();}
  if(!(__startrek_start_t2[13] <= __startrek_end_t2[13])) {abort();}
  if(!(__startrek_start_t2[14] <= __startrek_end_t2[14])) {abort();}
  if(!(__startrek_start_t2[15] <= __startrek_end_t2[15])) {abort();}
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t2[0]) {
    if (__startrek_start_t2[0] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t2[0])) {abort();}
      if(!(__startrek_end_t2[0] < __startrek_end_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t2[0]) {
    if (__startrek_start_t2[0] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t2[0])) {abort();}
      if(!(__startrek_end_t2[0] < __startrek_end_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[12] <= __startrek_end_t2[0]) {
    if (__startrek_start_t2[0] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t2[0])) {abort();}
      if(!(__startrek_end_t2[0] < __startrek_end_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t2[0]) {
    if (__startrek_start_t2[0] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t2[0])) {abort();}
      if(!(__startrek_end_t2[0] < __startrek_end_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t2[0]) {
    if (__startrek_start_t2[0] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t2[0])) {abort();}
      if(!(__startrek_end_t2[0] < __startrek_end_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t2[0]) {
    if (__startrek_start_t2[0] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t2[0])) {abort();}
      if(!(__startrek_end_t2[0] < __startrek_end_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t2[1]) {
    if (__startrek_start_t2[1] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t2[1])) {abort();}
      if(!(__startrek_end_t2[1] < __startrek_end_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t2[1]) {
    if (__startrek_start_t2[1] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t2[1])) {abort();}
      if(!(__startrek_end_t2[1] < __startrek_end_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[12] <= __startrek_end_t2[1]) {
    if (__startrek_start_t2[1] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t2[1])) {abort();}
      if(!(__startrek_end_t2[1] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t2[0] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t2[1]) {
    if (__startrek_start_t2[1] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t2[1])) {abort();}
      if(!(__startrek_end_t2[1] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t2[0] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t2[1]) {
    if (__startrek_start_t2[1] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t2[1])) {abort();}
      if(!(__startrek_end_t2[1] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t2[0] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t2[1]) {
    if (__startrek_start_t2[1] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t2[1])) {abort();}
      if(!(__startrek_end_t2[1] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t2[0] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t2[2]) {
    if (__startrek_start_t2[2] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t2[2])) {abort();}
      if(!(__startrek_end_t2[2] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t2[0] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t2[2]) {
    if (__startrek_start_t2[2] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t2[2])) {abort();}
      if(!(__startrek_end_t2[2] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t2[0] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[12] <= __startrek_end_t2[2]) {
    if (__startrek_start_t2[2] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t2[2])) {abort();}
      if(!(__startrek_end_t2[2] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t2[1] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t2[2]) {
    if (__startrek_start_t2[2] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t2[2])) {abort();}
      if(!(__startrek_end_t2[2] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t2[1] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t2[2]) {
    if (__startrek_start_t2[2] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t2[2])) {abort();}
      if(!(__startrek_end_t2[2] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t2[1] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t2[2]) {
    if (__startrek_start_t2[2] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t2[2])) {abort();}
      if(!(__startrek_end_t2[2] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t2[1] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t2[3]) {
    if (__startrek_start_t2[3] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t2[3])) {abort();}
      if(!(__startrek_end_t2[3] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t2[1] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t2[3]) {
    if (__startrek_start_t2[3] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t2[3])) {abort();}
      if(!(__startrek_end_t2[3] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t2[1] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[12] <= __startrek_end_t2[3]) {
    if (__startrek_start_t2[3] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t2[3])) {abort();}
      if(!(__startrek_end_t2[3] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t2[2] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t2[3]) {
    if (__startrek_start_t2[3] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t2[3])) {abort();}
      if(!(__startrek_end_t2[3] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t2[2] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t2[3]) {
    if (__startrek_start_t2[3] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t2[3])) {abort();}
      if(!(__startrek_end_t2[3] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t2[2] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t2[3]) {
    if (__startrek_start_t2[3] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t2[3])) {abort();}
      if(!(__startrek_end_t2[3] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t2[2] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t2[4]) {
    if (__startrek_start_t2[4] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t2[4])) {abort();}
      if(!(__startrek_end_t2[4] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t2[2] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t2[4]) {
    if (__startrek_start_t2[4] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t2[4])) {abort();}
      if(!(__startrek_end_t2[4] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t2[2] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[12] <= __startrek_end_t2[4]) {
    if (__startrek_start_t2[4] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t2[4])) {abort();}
      if(!(__startrek_end_t2[4] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t2[3] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t2[4]) {
    if (__startrek_start_t2[4] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t2[4])) {abort();}
      if(!(__startrek_end_t2[4] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t2[3] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t2[4]) {
    if (__startrek_start_t2[4] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t2[4])) {abort();}
      if(!(__startrek_end_t2[4] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t2[3] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t2[4]) {
    if (__startrek_start_t2[4] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t2[4])) {abort();}
      if(!(__startrek_end_t2[4] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t2[3] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t2[5]) {
    if (__startrek_start_t2[5] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t2[5])) {abort();}
      if(!(__startrek_end_t2[5] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t2[3] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t2[5]) {
    if (__startrek_start_t2[5] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t2[5])) {abort();}
      if(!(__startrek_end_t2[5] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t2[3] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[12] <= __startrek_end_t2[5]) {
    if (__startrek_start_t2[5] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t2[5])) {abort();}
      if(!(__startrek_end_t2[5] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t2[4] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t2[5]) {
    if (__startrek_start_t2[5] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t2[5])) {abort();}
      if(!(__startrek_end_t2[5] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t2[4] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t2[5]) {
    if (__startrek_start_t2[5] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t2[5])) {abort();}
      if(!(__startrek_end_t2[5] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t2[4] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t2[5]) {
    if (__startrek_start_t2[5] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t2[5])) {abort();}
      if(!(__startrek_end_t2[5] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t2[4] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t2[6]) {
    if (__startrek_start_t2[6] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t2[6])) {abort();}
      if(!(__startrek_end_t2[6] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t2[4] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t2[6]) {
    if (__startrek_start_t2[6] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t2[6])) {abort();}
      if(!(__startrek_end_t2[6] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t2[4] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[12] <= __startrek_end_t2[6]) {
    if (__startrek_start_t2[6] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t2[6])) {abort();}
      if(!(__startrek_end_t2[6] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t2[5] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t2[6]) {
    if (__startrek_start_t2[6] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t2[6])) {abort();}
      if(!(__startrek_end_t2[6] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t2[5] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t2[6]) {
    if (__startrek_start_t2[6] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t2[6])) {abort();}
      if(!(__startrek_end_t2[6] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t2[5] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t2[6]) {
    if (__startrek_start_t2[6] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t2[6])) {abort();}
      if(!(__startrek_end_t2[6] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t2[5] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t2[7]) {
    if (__startrek_start_t2[7] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t2[7])) {abort();}
      if(!(__startrek_end_t2[7] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t2[5] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t2[7]) {
    if (__startrek_start_t2[7] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t2[7])) {abort();}
      if(!(__startrek_end_t2[7] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t2[5] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[12] <= __startrek_end_t2[7]) {
    if (__startrek_start_t2[7] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t2[7])) {abort();}
      if(!(__startrek_end_t2[7] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t2[6] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t2[7]) {
    if (__startrek_start_t2[7] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t2[7])) {abort();}
      if(!(__startrek_end_t2[7] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t2[6] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t2[7]) {
    if (__startrek_start_t2[7] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t2[7])) {abort();}
      if(!(__startrek_end_t2[7] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t2[6] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t2[7]) {
    if (__startrek_start_t2[7] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t2[7])) {abort();}
      if(!(__startrek_end_t2[7] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t2[6] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t2[8]) {
    if (__startrek_start_t2[8] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t2[8])) {abort();}
      if(!(__startrek_end_t2[8] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t2[6] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t2[8]) {
    if (__startrek_start_t2[8] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t2[8])) {abort();}
      if(!(__startrek_end_t2[8] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t2[6] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[12] <= __startrek_end_t2[8]) {
    if (__startrek_start_t2[8] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t2[8])) {abort();}
      if(!(__startrek_end_t2[8] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t2[7] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t2[8]) {
    if (__startrek_start_t2[8] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t2[8])) {abort();}
      if(!(__startrek_end_t2[8] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t2[7] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t2[8]) {
    if (__startrek_start_t2[8] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t2[8])) {abort();}
      if(!(__startrek_end_t2[8] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t2[7] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t2[8]) {
    if (__startrek_start_t2[8] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t2[8])) {abort();}
      if(!(__startrek_end_t2[8] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t2[7] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t2[9]) {
    if (__startrek_start_t2[9] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t2[9])) {abort();}
      if(!(__startrek_end_t2[9] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t2[7] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t2[9]) {
    if (__startrek_start_t2[9] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t2[9])) {abort();}
      if(!(__startrek_end_t2[9] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t2[7] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[12] <= __startrek_end_t2[9]) {
    if (__startrek_start_t2[9] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t2[9])) {abort();}
      if(!(__startrek_end_t2[9] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t2[8] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t2[9]) {
    if (__startrek_start_t2[9] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t2[9])) {abort();}
      if(!(__startrek_end_t2[9] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t2[8] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t2[9]) {
    if (__startrek_start_t2[9] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t2[9])) {abort();}
      if(!(__startrek_end_t2[9] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t2[8] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t2[9]) {
    if (__startrek_start_t2[9] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t2[9])) {abort();}
      if(!(__startrek_end_t2[9] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t2[8] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t2[10]) {
    if (__startrek_start_t2[10] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t2[10])) {abort();}
      if(!(__startrek_end_t2[10] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t2[8] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t2[10]) {
    if (__startrek_start_t2[10] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t2[10])) {abort();}
      if(!(__startrek_end_t2[10] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t2[8] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[12] <= __startrek_end_t2[10]) {
    if (__startrek_start_t2[10] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t2[10])) {abort();}
      if(!(__startrek_end_t2[10] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t2[9] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t2[10]) {
    if (__startrek_start_t2[10] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t2[10])) {abort();}
      if(!(__startrek_end_t2[10] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t2[9] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t2[10]) {
    if (__startrek_start_t2[10] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t2[10])) {abort();}
      if(!(__startrek_end_t2[10] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t2[9] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t2[10]) {
    if (__startrek_start_t2[10] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t2[10])) {abort();}
      if(!(__startrek_end_t2[10] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t2[9] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t2[11]) {
    if (__startrek_start_t2[11] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t2[11])) {abort();}
      if(!(__startrek_end_t2[11] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t2[9] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t2[11]) {
    if (__startrek_start_t2[11] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t2[11])) {abort();}
      if(!(__startrek_end_t2[11] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t2[9] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[12] <= __startrek_end_t2[11]) {
    if (__startrek_start_t2[11] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t2[11])) {abort();}
      if(!(__startrek_end_t2[11] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t2[10] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t2[11]) {
    if (__startrek_start_t2[11] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t2[11])) {abort();}
      if(!(__startrek_end_t2[11] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t2[10] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t2[11]) {
    if (__startrek_start_t2[11] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t2[11])) {abort();}
      if(!(__startrek_end_t2[11] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t2[10] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t2[11]) {
    if (__startrek_start_t2[11] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t2[11])) {abort();}
      if(!(__startrek_end_t2[11] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t2[10] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[4] <= __startrek_end_t2[12]) {
    if (__startrek_start_t2[12] <= __startrek_end_t0[4]) {
      {
      if(!(__startrek_start_t0[4] <= __startrek_start_t2[12])) {abort();}
      if(!(__startrek_end_t2[12] < __startrek_end_t0[4])) {abort();}
      if(!(__startrek_end_t2[10] < __startrek_start_t0[4])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[5] <= __startrek_end_t2[12]) {
    if (__startrek_start_t2[12] <= __startrek_end_t0[5]) {
      {
      if(!(__startrek_start_t0[5] <= __startrek_start_t2[12])) {abort();}
      if(!(__startrek_end_t2[12] < __startrek_end_t0[5])) {abort();}
      if(!(__startrek_end_t2[10] < __startrek_start_t0[5])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[6] <= __startrek_end_t2[12]) {
    if (__startrek_start_t2[12] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t2[12])) {abort();}
      if(!(__startrek_end_t2[12] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t2[10] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t2[12]) {
    if (__startrek_start_t2[12] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t2[12])) {abort();}
      if(!(__startrek_end_t2[12] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t2[10] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[8] <= __startrek_end_t2[12]) {
    if (__startrek_start_t2[12] <= __startrek_end_t1[8]) {
      {
      if(!(__startrek_start_t1[8] <= __startrek_start_t2[12])) {abort();}
      if(!(__startrek_end_t2[12] < __startrek_end_t1[8])) {abort();}
      if(!(__startrek_end_t2[11] < __startrek_start_t1[8])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[9] <= __startrek_end_t2[12]) {
    if (__startrek_start_t2[12] <= __startrek_end_t1[9]) {
      {
      if(!(__startrek_start_t1[9] <= __startrek_start_t2[12])) {abort();}
      if(!(__startrek_end_t2[12] < __startrek_end_t1[9])) {abort();}
      if(!(__startrek_end_t2[11] < __startrek_start_t1[9])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[10] <= __startrek_end_t2[12]) {
    if (__startrek_start_t2[12] <= __startrek_end_t1[10]) {
      {
      if(!(__startrek_start_t1[10] <= __startrek_start_t2[12])) {abort();}
      if(!(__startrek_end_t2[12] < __startrek_end_t1[10])) {abort();}
      if(!(__startrek_end_t2[11] < __startrek_start_t1[10])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[11] <= __startrek_end_t2[12]) {
    if (__startrek_start_t2[12] <= __startrek_end_t1[11]) {
      {
      if(!(__startrek_start_t1[11] <= __startrek_start_t2[12])) {abort();}
      if(!(__startrek_end_t2[12] < __startrek_end_t1[11])) {abort();}
      if(!(__startrek_end_t2[11] < __startrek_start_t1[11])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[12] <= __startrek_end_t2[12]) {
    if (__startrek_start_t2[12] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t2[12])) {abort();}
      if(!(__startrek_end_t2[12] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t2[11] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t2[12]) {
    if (__startrek_start_t2[12] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t2[12])) {abort();}
      if(!(__startrek_end_t2[12] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t2[11] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t2[12]) {
    if (__startrek_start_t2[12] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t2[12])) {abort();}
      if(!(__startrek_end_t2[12] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t2[11] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t2[12]) {
    if (__startrek_start_t2[12] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t2[12])) {abort();}
      if(!(__startrek_end_t2[12] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t2[11] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[4] <= __startrek_end_t2[13]) {
    if (__startrek_start_t2[13] <= __startrek_end_t0[4]) {
      {
      if(!(__startrek_start_t0[4] <= __startrek_start_t2[13])) {abort();}
      if(!(__startrek_end_t2[13] < __startrek_end_t0[4])) {abort();}
      if(!(__startrek_end_t2[11] < __startrek_start_t0[4])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[5] <= __startrek_end_t2[13]) {
    if (__startrek_start_t2[13] <= __startrek_end_t0[5]) {
      {
      if(!(__startrek_start_t0[5] <= __startrek_start_t2[13])) {abort();}
      if(!(__startrek_end_t2[13] < __startrek_end_t0[5])) {abort();}
      if(!(__startrek_end_t2[11] < __startrek_start_t0[5])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[6] <= __startrek_end_t2[13]) {
    if (__startrek_start_t2[13] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t2[13])) {abort();}
      if(!(__startrek_end_t2[13] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t2[11] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t2[13]) {
    if (__startrek_start_t2[13] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t2[13])) {abort();}
      if(!(__startrek_end_t2[13] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t2[11] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[8] <= __startrek_end_t2[13]) {
    if (__startrek_start_t2[13] <= __startrek_end_t1[8]) {
      {
      if(!(__startrek_start_t1[8] <= __startrek_start_t2[13])) {abort();}
      if(!(__startrek_end_t2[13] < __startrek_end_t1[8])) {abort();}
      if(!(__startrek_end_t2[12] < __startrek_start_t1[8])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[9] <= __startrek_end_t2[13]) {
    if (__startrek_start_t2[13] <= __startrek_end_t1[9]) {
      {
      if(!(__startrek_start_t1[9] <= __startrek_start_t2[13])) {abort();}
      if(!(__startrek_end_t2[13] < __startrek_end_t1[9])) {abort();}
      if(!(__startrek_end_t2[12] < __startrek_start_t1[9])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[10] <= __startrek_end_t2[13]) {
    if (__startrek_start_t2[13] <= __startrek_end_t1[10]) {
      {
      if(!(__startrek_start_t1[10] <= __startrek_start_t2[13])) {abort();}
      if(!(__startrek_end_t2[13] < __startrek_end_t1[10])) {abort();}
      if(!(__startrek_end_t2[12] < __startrek_start_t1[10])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[11] <= __startrek_end_t2[13]) {
    if (__startrek_start_t2[13] <= __startrek_end_t1[11]) {
      {
      if(!(__startrek_start_t1[11] <= __startrek_start_t2[13])) {abort();}
      if(!(__startrek_end_t2[13] < __startrek_end_t1[11])) {abort();}
      if(!(__startrek_end_t2[12] < __startrek_start_t1[11])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[12] <= __startrek_end_t2[13]) {
    if (__startrek_start_t2[13] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t2[13])) {abort();}
      if(!(__startrek_end_t2[13] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t2[12] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t2[13]) {
    if (__startrek_start_t2[13] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t2[13])) {abort();}
      if(!(__startrek_end_t2[13] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t2[12] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t2[13]) {
    if (__startrek_start_t2[13] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t2[13])) {abort();}
      if(!(__startrek_end_t2[13] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t2[12] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t2[13]) {
    if (__startrek_start_t2[13] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t2[13])) {abort();}
      if(!(__startrek_end_t2[13] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t2[12] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[4] <= __startrek_end_t2[14]) {
    if (__startrek_start_t2[14] <= __startrek_end_t0[4]) {
      {
      if(!(__startrek_start_t0[4] <= __startrek_start_t2[14])) {abort();}
      if(!(__startrek_end_t2[14] < __startrek_end_t0[4])) {abort();}
      if(!(__startrek_end_t2[12] < __startrek_start_t0[4])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[5] <= __startrek_end_t2[14]) {
    if (__startrek_start_t2[14] <= __startrek_end_t0[5]) {
      {
      if(!(__startrek_start_t0[5] <= __startrek_start_t2[14])) {abort();}
      if(!(__startrek_end_t2[14] < __startrek_end_t0[5])) {abort();}
      if(!(__startrek_end_t2[12] < __startrek_start_t0[5])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[6] <= __startrek_end_t2[14]) {
    if (__startrek_start_t2[14] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t2[14])) {abort();}
      if(!(__startrek_end_t2[14] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t2[12] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t2[14]) {
    if (__startrek_start_t2[14] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t2[14])) {abort();}
      if(!(__startrek_end_t2[14] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t2[12] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[8] <= __startrek_end_t2[14]) {
    if (__startrek_start_t2[14] <= __startrek_end_t1[8]) {
      {
      if(!(__startrek_start_t1[8] <= __startrek_start_t2[14])) {abort();}
      if(!(__startrek_end_t2[14] < __startrek_end_t1[8])) {abort();}
      if(!(__startrek_end_t2[13] < __startrek_start_t1[8])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[9] <= __startrek_end_t2[14]) {
    if (__startrek_start_t2[14] <= __startrek_end_t1[9]) {
      {
      if(!(__startrek_start_t1[9] <= __startrek_start_t2[14])) {abort();}
      if(!(__startrek_end_t2[14] < __startrek_end_t1[9])) {abort();}
      if(!(__startrek_end_t2[13] < __startrek_start_t1[9])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[10] <= __startrek_end_t2[14]) {
    if (__startrek_start_t2[14] <= __startrek_end_t1[10]) {
      {
      if(!(__startrek_start_t1[10] <= __startrek_start_t2[14])) {abort();}
      if(!(__startrek_end_t2[14] < __startrek_end_t1[10])) {abort();}
      if(!(__startrek_end_t2[13] < __startrek_start_t1[10])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[11] <= __startrek_end_t2[14]) {
    if (__startrek_start_t2[14] <= __startrek_end_t1[11]) {
      {
      if(!(__startrek_start_t1[11] <= __startrek_start_t2[14])) {abort();}
      if(!(__startrek_end_t2[14] < __startrek_end_t1[11])) {abort();}
      if(!(__startrek_end_t2[13] < __startrek_start_t1[11])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[12] <= __startrek_end_t2[14]) {
    if (__startrek_start_t2[14] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t2[14])) {abort();}
      if(!(__startrek_end_t2[14] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t2[13] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t2[14]) {
    if (__startrek_start_t2[14] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t2[14])) {abort();}
      if(!(__startrek_end_t2[14] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t2[13] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t2[14]) {
    if (__startrek_start_t2[14] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t2[14])) {abort();}
      if(!(__startrek_end_t2[14] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t2[13] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t2[14]) {
    if (__startrek_start_t2[14] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t2[14])) {abort();}
      if(!(__startrek_end_t2[14] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t2[13] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[4] <= __startrek_end_t2[15]) {
    if (__startrek_start_t2[15] <= __startrek_end_t0[4]) {
      {
      if(!(__startrek_start_t0[4] <= __startrek_start_t2[15])) {abort();}
      if(!(__startrek_end_t2[15] < __startrek_end_t0[4])) {abort();}
      if(!(__startrek_end_t2[13] < __startrek_start_t0[4])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[5] <= __startrek_end_t2[15]) {
    if (__startrek_start_t2[15] <= __startrek_end_t0[5]) {
      {
      if(!(__startrek_start_t0[5] <= __startrek_start_t2[15])) {abort();}
      if(!(__startrek_end_t2[15] < __startrek_end_t0[5])) {abort();}
      if(!(__startrek_end_t2[13] < __startrek_start_t0[5])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[6] <= __startrek_end_t2[15]) {
    if (__startrek_start_t2[15] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t2[15])) {abort();}
      if(!(__startrek_end_t2[15] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t2[13] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t2[15]) {
    if (__startrek_start_t2[15] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t2[15])) {abort();}
      if(!(__startrek_end_t2[15] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t2[13] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[8] <= __startrek_end_t2[15]) {
    if (__startrek_start_t2[15] <= __startrek_end_t1[8]) {
      {
      if(!(__startrek_start_t1[8] <= __startrek_start_t2[15])) {abort();}
      if(!(__startrek_end_t2[15] < __startrek_end_t1[8])) {abort();}
      if(!(__startrek_end_t2[14] < __startrek_start_t1[8])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[9] <= __startrek_end_t2[15]) {
    if (__startrek_start_t2[15] <= __startrek_end_t1[9]) {
      {
      if(!(__startrek_start_t1[9] <= __startrek_start_t2[15])) {abort();}
      if(!(__startrek_end_t2[15] < __startrek_end_t1[9])) {abort();}
      if(!(__startrek_end_t2[14] < __startrek_start_t1[9])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[10] <= __startrek_end_t2[15]) {
    if (__startrek_start_t2[15] <= __startrek_end_t1[10]) {
      {
      if(!(__startrek_start_t1[10] <= __startrek_start_t2[15])) {abort();}
      if(!(__startrek_end_t2[15] < __startrek_end_t1[10])) {abort();}
      if(!(__startrek_end_t2[14] < __startrek_start_t1[10])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[11] <= __startrek_end_t2[15]) {
    if (__startrek_start_t2[15] <= __startrek_end_t1[11]) {
      {
      if(!(__startrek_start_t1[11] <= __startrek_start_t2[15])) {abort();}
      if(!(__startrek_end_t2[15] < __startrek_end_t1[11])) {abort();}
      if(!(__startrek_end_t2[14] < __startrek_start_t1[11])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[12] <= __startrek_end_t2[15]) {
    if (__startrek_start_t2[15] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t2[15])) {abort();}
      if(!(__startrek_end_t2[15] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t2[14] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t2[15]) {
    if (__startrek_start_t2[15] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t2[15])) {abort();}
      if(!(__startrek_end_t2[15] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t2[14] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t2[15]) {
    if (__startrek_start_t2[15] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t2[15])) {abort();}
      if(!(__startrek_end_t2[15] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t2[14] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t2[15]) {
    if (__startrek_start_t2[15] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t2[15])) {abort();}
      if(!(__startrek_end_t2[15] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t2[14] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  ...
  if(!(__startrek_end_t3[15] <= 55)) {abort();}
  ...
  if(!(__startrek_end_t3[11] <= __startrek_start_t3[12] - 1)) {abort();}
  if(!(__startrek_end_t3[12] <= __startrek_start_t3[13] - 1)) {abort();}
  if(!(__startrek_end_t3[13] <= __startrek_start_t3[14] - 1)) {abort();}
  if(!(__startrek_end_t3[14] <= __startrek_start_t3[15] - 1)) {abort();}
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t3[0]) {
    if (__startrek_start_t3[0] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t3[0])) {abort();}
      if(!(__startrek_end_t3[0] < __startrek_end_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t3[0]) {
    if (__startrek_start_t3[0] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t3[0])) {abort();}
      if(!(__startrek_end_t3[0] < __startrek_end_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[12] <= __startrek_end_t3[0]) {
    if (__startrek_start_t3[0] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t3[0])) {abort();}
      if(!(__startrek_end_t3[0] < __startrek_end_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t3[0]) {
    if (__startrek_start_t3[0] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t3[0])) {abort();}
      if(!(__startrek_end_t3[0] < __startrek_end_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t3[0]) {
    if (__startrek_start_t3[0] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t3[0])) {abort();}
      if(!(__startrek_end_t3[0] < __startrek_end_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t3[0]) {
    if (__startrek_start_t3[0] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t3[0])) {abort();}
      if(!(__startrek_end_t3[0] < __startrek_end_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t2[12] <= __startrek_end_t3[0]) {
    if (__startrek_start_t3[0] <= __startrek_end_t2[12]) {
      {
      if(!(__startrek_start_t2[12] <= __startrek_start_t3[0])) {abort();}
      if(!(__startrek_end_t3[0] < __startrek_end_t2[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[13] <= __startrek_end_t3[0]) {
    if (__startrek_start_t3[0] <= __startrek_end_t2[13]) {
      {
      if(!(__startrek_start_t2[13] <= __startrek_start_t3[0])) {abort();}
      if(!(__startrek_end_t3[0] < __startrek_end_t2[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[14] <= __startrek_end_t3[0]) {
    if (__startrek_start_t3[0] <= __startrek_end_t2[14]) {
      {
      if(!(__startrek_start_t2[14] <= __startrek_start_t3[0])) {abort();}
      if(!(__startrek_end_t3[0] < __startrek_end_t2[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[15] <= __startrek_end_t3[0]) {
    if (__startrek_start_t3[0] <= __startrek_end_t2[15]) {
      {
      if(!(__startrek_start_t2[15] <= __startrek_start_t3[0])) {abort();}
      if(!(__startrek_end_t3[0] < __startrek_end_t2[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t3[1]) {
    if (__startrek_start_t3[1] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t3[1])) {abort();}
      if(!(__startrek_end_t3[1] < __startrek_end_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t3[1]) {
    if (__startrek_start_t3[1] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t3[1])) {abort();}
      if(!(__startrek_end_t3[1] < __startrek_end_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[12] <= __startrek_end_t3[1]) {
    if (__startrek_start_t3[1] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t3[1])) {abort();}
      if(!(__startrek_end_t3[1] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t3[0] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t3[1]) {
    if (__startrek_start_t3[1] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t3[1])) {abort();}
      if(!(__startrek_end_t3[1] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t3[0] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t3[1]) {
    if (__startrek_start_t3[1] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t3[1])) {abort();}
      if(!(__startrek_end_t3[1] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t3[0] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t3[1]) {
    if (__startrek_start_t3[1] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t3[1])) {abort();}
      if(!(__startrek_end_t3[1] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t3[0] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t2[12] <= __startrek_end_t3[1]) {
    if (__startrek_start_t3[1] <= __startrek_end_t2[12]) {
      {
      if(!(__startrek_start_t2[12] <= __startrek_start_t3[1])) {abort();}
      if(!(__startrek_end_t3[1] < __startrek_end_t2[12])) {abort();}
      if(!(__startrek_end_t3[0] < __startrek_start_t2[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[13] <= __startrek_end_t3[1]) {
    if (__startrek_start_t3[1] <= __startrek_end_t2[13]) {
      {
      if(!(__startrek_start_t2[13] <= __startrek_start_t3[1])) {abort();}
      if(!(__startrek_end_t3[1] < __startrek_end_t2[13])) {abort();}
      if(!(__startrek_end_t3[0] < __startrek_start_t2[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[14] <= __startrek_end_t3[1]) {
    if (__startrek_start_t3[1] <= __startrek_end_t2[14]) {
      {
      if(!(__startrek_start_t2[14] <= __startrek_start_t3[1])) {abort();}
      if(!(__startrek_end_t3[1] < __startrek_end_t2[14])) {abort();}
      if(!(__startrek_end_t3[0] < __startrek_start_t2[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[15] <= __startrek_end_t3[1]) {
    if (__startrek_start_t3[1] <= __startrek_end_t2[15]) {
      {
      if(!(__startrek_start_t2[15] <= __startrek_start_t3[1])) {abort();}
      if(!(__startrek_end_t3[1] < __startrek_end_t2[15])) {abort();}
      if(!(__startrek_end_t3[0] < __startrek_start_t2[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t3[2]) {
    if (__startrek_start_t3[2] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t3[2])) {abort();}
      if(!(__startrek_end_t3[2] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t3[0] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t3[2]) {
    if (__startrek_start_t3[2] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t3[2])) {abort();}
      if(!(__startrek_end_t3[2] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t3[0] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[12] <= __startrek_end_t3[2]) {
    if (__startrek_start_t3[2] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t3[2])) {abort();}
      if(!(__startrek_end_t3[2] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t3[1] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t3[2]) {
    if (__startrek_start_t3[2] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t3[2])) {abort();}
      if(!(__startrek_end_t3[2] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t3[1] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t3[2]) {
    if (__startrek_start_t3[2] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t3[2])) {abort();}
      if(!(__startrek_end_t3[2] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t3[1] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t3[2]) {
    if (__startrek_start_t3[2] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t3[2])) {abort();}
      if(!(__startrek_end_t3[2] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t3[1] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t2[12] <= __startrek_end_t3[2]) {
    if (__startrek_start_t3[2] <= __startrek_end_t2[12]) {
      {
      if(!(__startrek_start_t2[12] <= __startrek_start_t3[2])) {abort();}
      if(!(__startrek_end_t3[2] < __startrek_end_t2[12])) {abort();}
      if(!(__startrek_end_t3[1] < __startrek_start_t2[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[13] <= __startrek_end_t3[2]) {
    if (__startrek_start_t3[2] <= __startrek_end_t2[13]) {
      {
      if(!(__startrek_start_t2[13] <= __startrek_start_t3[2])) {abort();}
      if(!(__startrek_end_t3[2] < __startrek_end_t2[13])) {abort();}
      if(!(__startrek_end_t3[1] < __startrek_start_t2[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[14] <= __startrek_end_t3[2]) {
    if (__startrek_start_t3[2] <= __startrek_end_t2[14]) {
      {
      if(!(__startrek_start_t2[14] <= __startrek_start_t3[2])) {abort();}
      if(!(__startrek_end_t3[2] < __startrek_end_t2[14])) {abort();}
      if(!(__startrek_end_t3[1] < __startrek_start_t2[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[15] <= __startrek_end_t3[2]) {
    if (__startrek_start_t3[2] <= __startrek_end_t2[15]) {
      {
      if(!(__startrek_start_t2[15] <= __startrek_start_t3[2])) {abort();}
      if(!(__startrek_end_t3[2] < __startrek_end_t2[15])) {abort();}
      if(!(__startrek_end_t3[1] < __startrek_start_t2[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t3[3]) {
    if (__startrek_start_t3[3] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t3[3])) {abort();}
      if(!(__startrek_end_t3[3] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t3[1] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t3[3]) {
    if (__startrek_start_t3[3] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t3[3])) {abort();}
      if(!(__startrek_end_t3[3] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t3[1] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[12] <= __startrek_end_t3[3]) {
    if (__startrek_start_t3[3] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t3[3])) {abort();}
      if(!(__startrek_end_t3[3] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t3[2] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t3[3]) {
    if (__startrek_start_t3[3] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t3[3])) {abort();}
      if(!(__startrek_end_t3[3] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t3[2] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t3[3]) {
    if (__startrek_start_t3[3] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t3[3])) {abort();}
      if(!(__startrek_end_t3[3] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t3[2] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t3[3]) {
    if (__startrek_start_t3[3] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t3[3])) {abort();}
      if(!(__startrek_end_t3[3] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t3[2] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t2[12] <= __startrek_end_t3[3]) {
    if (__startrek_start_t3[3] <= __startrek_end_t2[12]) {
      {
      if(!(__startrek_start_t2[12] <= __startrek_start_t3[3])) {abort();}
      if(!(__startrek_end_t3[3] < __startrek_end_t2[12])) {abort();}
      if(!(__startrek_end_t3[2] < __startrek_start_t2[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[13] <= __startrek_end_t3[3]) {
    if (__startrek_start_t3[3] <= __startrek_end_t2[13]) {
      {
      if(!(__startrek_start_t2[13] <= __startrek_start_t3[3])) {abort();}
      if(!(__startrek_end_t3[3] < __startrek_end_t2[13])) {abort();}
      if(!(__startrek_end_t3[2] < __startrek_start_t2[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[14] <= __startrek_end_t3[3]) {
    if (__startrek_start_t3[3] <= __startrek_end_t2[14]) {
      {
      if(!(__startrek_start_t2[14] <= __startrek_start_t3[3])) {abort();}
      if(!(__startrek_end_t3[3] < __startrek_end_t2[14])) {abort();}
      if(!(__startrek_end_t3[2] < __startrek_start_t2[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[15] <= __startrek_end_t3[3]) {
    if (__startrek_start_t3[3] <= __startrek_end_t2[15]) {
      {
      if(!(__startrek_start_t2[15] <= __startrek_start_t3[3])) {abort();}
      if(!(__startrek_end_t3[3] < __startrek_end_t2[15])) {abort();}
      if(!(__startrek_end_t3[2] < __startrek_start_t2[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t3[4]) {
    if (__startrek_start_t3[4] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t3[4])) {abort();}
      if(!(__startrek_end_t3[4] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t3[2] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t3[4]) {
    if (__startrek_start_t3[4] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t3[4])) {abort();}
      if(!(__startrek_end_t3[4] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t3[2] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[12] <= __startrek_end_t3[4]) {
    if (__startrek_start_t3[4] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t3[4])) {abort();}
      if(!(__startrek_end_t3[4] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t3[3] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t3[4]) {
    if (__startrek_start_t3[4] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t3[4])) {abort();}
      if(!(__startrek_end_t3[4] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t3[3] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t3[4]) {
    if (__startrek_start_t3[4] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t3[4])) {abort();}
      if(!(__startrek_end_t3[4] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t3[3] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t3[4]) {
    if (__startrek_start_t3[4] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t3[4])) {abort();}
      if(!(__startrek_end_t3[4] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t3[3] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t2[12] <= __startrek_end_t3[4]) {
    if (__startrek_start_t3[4] <= __startrek_end_t2[12]) {
      {
      if(!(__startrek_start_t2[12] <= __startrek_start_t3[4])) {abort();}
      if(!(__startrek_end_t3[4] < __startrek_end_t2[12])) {abort();}
      if(!(__startrek_end_t3[3] < __startrek_start_t2[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[13] <= __startrek_end_t3[4]) {
    if (__startrek_start_t3[4] <= __startrek_end_t2[13]) {
      {
      if(!(__startrek_start_t2[13] <= __startrek_start_t3[4])) {abort();}
      if(!(__startrek_end_t3[4] < __startrek_end_t2[13])) {abort();}
      if(!(__startrek_end_t3[3] < __startrek_start_t2[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[14] <= __startrek_end_t3[4]) {
    if (__startrek_start_t3[4] <= __startrek_end_t2[14]) {
      {
      if(!(__startrek_start_t2[14] <= __startrek_start_t3[4])) {abort();}
      if(!(__startrek_end_t3[4] < __startrek_end_t2[14])) {abort();}
      if(!(__startrek_end_t3[3] < __startrek_start_t2[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[15] <= __startrek_end_t3[4]) {
    if (__startrek_start_t3[4] <= __startrek_end_t2[15]) {
      {
      if(!(__startrek_start_t2[15] <= __startrek_start_t3[4])) {abort();}
      if(!(__startrek_end_t3[4] < __startrek_end_t2[15])) {abort();}
      if(!(__startrek_end_t3[3] < __startrek_start_t2[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t3[5]) {
    if (__startrek_start_t3[5] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t3[5])) {abort();}
      if(!(__startrek_end_t3[5] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t3[3] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t3[5]) {
    if (__startrek_start_t3[5] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t3[5])) {abort();}
      if(!(__startrek_end_t3[5] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t3[3] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[12] <= __startrek_end_t3[5]) {
    if (__startrek_start_t3[5] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t3[5])) {abort();}
      if(!(__startrek_end_t3[5] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t3[4] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t3[5]) {
    if (__startrek_start_t3[5] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t3[5])) {abort();}
      if(!(__startrek_end_t3[5] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t3[4] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t3[5]) {
    if (__startrek_start_t3[5] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t3[5])) {abort();}
      if(!(__startrek_end_t3[5] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t3[4] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t3[5]) {
    if (__startrek_start_t3[5] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t3[5])) {abort();}
      if(!(__startrek_end_t3[5] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t3[4] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t2[12] <= __startrek_end_t3[5]) {
    if (__startrek_start_t3[5] <= __startrek_end_t2[12]) {
      {
      if(!(__startrek_start_t2[12] <= __startrek_start_t3[5])) {abort();}
      if(!(__startrek_end_t3[5] < __startrek_end_t2[12])) {abort();}
      if(!(__startrek_end_t3[4] < __startrek_start_t2[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[13] <= __startrek_end_t3[5]) {
    if (__startrek_start_t3[5] <= __startrek_end_t2[13]) {
      {
      if(!(__startrek_start_t2[13] <= __startrek_start_t3[5])) {abort();}
      if(!(__startrek_end_t3[5] < __startrek_end_t2[13])) {abort();}
      if(!(__startrek_end_t3[4] < __startrek_start_t2[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[14] <= __startrek_end_t3[5]) {
    if (__startrek_start_t3[5] <= __startrek_end_t2[14]) {
      {
      if(!(__startrek_start_t2[14] <= __startrek_start_t3[5])) {abort();}
      if(!(__startrek_end_t3[5] < __startrek_end_t2[14])) {abort();}
      if(!(__startrek_end_t3[4] < __startrek_start_t2[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[15] <= __startrek_end_t3[5]) {
    if (__startrek_start_t3[5] <= __startrek_end_t2[15]) {
      {
      if(!(__startrek_start_t2[15] <= __startrek_start_t3[5])) {abort();}
      if(!(__startrek_end_t3[5] < __startrek_end_t2[15])) {abort();}
      if(!(__startrek_end_t3[4] < __startrek_start_t2[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t3[6]) {
    if (__startrek_start_t3[6] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t3[6])) {abort();}
      if(!(__startrek_end_t3[6] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t3[4] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t3[6]) {
    if (__startrek_start_t3[6] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t3[6])) {abort();}
      if(!(__startrek_end_t3[6] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t3[4] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[12] <= __startrek_end_t3[6]) {
    if (__startrek_start_t3[6] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t3[6])) {abort();}
      if(!(__startrek_end_t3[6] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t3[5] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t3[6]) {
    if (__startrek_start_t3[6] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t3[6])) {abort();}
      if(!(__startrek_end_t3[6] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t3[5] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t3[6]) {
    if (__startrek_start_t3[6] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t3[6])) {abort();}
      if(!(__startrek_end_t3[6] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t3[5] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t3[6]) {
    if (__startrek_start_t3[6] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t3[6])) {abort();}
      if(!(__startrek_end_t3[6] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t3[5] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t2[12] <= __startrek_end_t3[6]) {
    if (__startrek_start_t3[6] <= __startrek_end_t2[12]) {
      {
      if(!(__startrek_start_t2[12] <= __startrek_start_t3[6])) {abort();}
      if(!(__startrek_end_t3[6] < __startrek_end_t2[12])) {abort();}
      if(!(__startrek_end_t3[5] < __startrek_start_t2[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[13] <= __startrek_end_t3[6]) {
    if (__startrek_start_t3[6] <= __startrek_end_t2[13]) {
      {
      if(!(__startrek_start_t2[13] <= __startrek_start_t3[6])) {abort();}
      if(!(__startrek_end_t3[6] < __startrek_end_t2[13])) {abort();}
      if(!(__startrek_end_t3[5] < __startrek_start_t2[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[14] <= __startrek_end_t3[6]) {
    if (__startrek_start_t3[6] <= __startrek_end_t2[14]) {
      {
      if(!(__startrek_start_t2[14] <= __startrek_start_t3[6])) {abort();}
      if(!(__startrek_end_t3[6] < __startrek_end_t2[14])) {abort();}
      if(!(__startrek_end_t3[5] < __startrek_start_t2[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[15] <= __startrek_end_t3[6]) {
    if (__startrek_start_t3[6] <= __startrek_end_t2[15]) {
      {
      if(!(__startrek_start_t2[15] <= __startrek_start_t3[6])) {abort();}
      if(!(__startrek_end_t3[6] < __startrek_end_t2[15])) {abort();}
      if(!(__startrek_end_t3[5] < __startrek_start_t2[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t3[7]) {
    if (__startrek_start_t3[7] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t3[7])) {abort();}
      if(!(__startrek_end_t3[7] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t3[5] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t3[7]) {
    if (__startrek_start_t3[7] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t3[7])) {abort();}
      if(!(__startrek_end_t3[7] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t3[5] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[12] <= __startrek_end_t3[7]) {
    if (__startrek_start_t3[7] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t3[7])) {abort();}
      if(!(__startrek_end_t3[7] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t3[6] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t3[7]) {
    if (__startrek_start_t3[7] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t3[7])) {abort();}
      if(!(__startrek_end_t3[7] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t3[6] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t3[7]) {
    if (__startrek_start_t3[7] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t3[7])) {abort();}
      if(!(__startrek_end_t3[7] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t3[6] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t3[7]) {
    if (__startrek_start_t3[7] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t3[7])) {abort();}
      if(!(__startrek_end_t3[7] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t3[6] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t2[12] <= __startrek_end_t3[7]) {
    if (__startrek_start_t3[7] <= __startrek_end_t2[12]) {
      {
      if(!(__startrek_start_t2[12] <= __startrek_start_t3[7])) {abort();}
      if(!(__startrek_end_t3[7] < __startrek_end_t2[12])) {abort();}
      if(!(__startrek_end_t3[6] < __startrek_start_t2[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[13] <= __startrek_end_t3[7]) {
    if (__startrek_start_t3[7] <= __startrek_end_t2[13]) {
      {
      if(!(__startrek_start_t2[13] <= __startrek_start_t3[7])) {abort();}
      if(!(__startrek_end_t3[7] < __startrek_end_t2[13])) {abort();}
      if(!(__startrek_end_t3[6] < __startrek_start_t2[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[14] <= __startrek_end_t3[7]) {
    if (__startrek_start_t3[7] <= __startrek_end_t2[14]) {
      {
      if(!(__startrek_start_t2[14] <= __startrek_start_t3[7])) {abort();}
      if(!(__startrek_end_t3[7] < __startrek_end_t2[14])) {abort();}
      if(!(__startrek_end_t3[6] < __startrek_start_t2[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[15] <= __startrek_end_t3[7]) {
    if (__startrek_start_t3[7] <= __startrek_end_t2[15]) {
      {
      if(!(__startrek_start_t2[15] <= __startrek_start_t3[7])) {abort();}
      if(!(__startrek_end_t3[7] < __startrek_end_t2[15])) {abort();}
      if(!(__startrek_end_t3[6] < __startrek_start_t2[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t3[8]) {
    if (__startrek_start_t3[8] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t3[8])) {abort();}
      if(!(__startrek_end_t3[8] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t3[6] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t3[8]) {
    if (__startrek_start_t3[8] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t3[8])) {abort();}
      if(!(__startrek_end_t3[8] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t3[6] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[12] <= __startrek_end_t3[8]) {
    if (__startrek_start_t3[8] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t3[8])) {abort();}
      if(!(__startrek_end_t3[8] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t3[7] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t3[8]) {
    if (__startrek_start_t3[8] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t3[8])) {abort();}
      if(!(__startrek_end_t3[8] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t3[7] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t3[8]) {
    if (__startrek_start_t3[8] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t3[8])) {abort();}
      if(!(__startrek_end_t3[8] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t3[7] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t3[8]) {
    if (__startrek_start_t3[8] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t3[8])) {abort();}
      if(!(__startrek_end_t3[8] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t3[7] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t2[12] <= __startrek_end_t3[8]) {
    if (__startrek_start_t3[8] <= __startrek_end_t2[12]) {
      {
      if(!(__startrek_start_t2[12] <= __startrek_start_t3[8])) {abort();}
      if(!(__startrek_end_t3[8] < __startrek_end_t2[12])) {abort();}
      if(!(__startrek_end_t3[7] < __startrek_start_t2[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[13] <= __startrek_end_t3[8]) {
    if (__startrek_start_t3[8] <= __startrek_end_t2[13]) {
      {
      if(!(__startrek_start_t2[13] <= __startrek_start_t3[8])) {abort();}
      if(!(__startrek_end_t3[8] < __startrek_end_t2[13])) {abort();}
      if(!(__startrek_end_t3[7] < __startrek_start_t2[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[14] <= __startrek_end_t3[8]) {
    if (__startrek_start_t3[8] <= __startrek_end_t2[14]) {
      {
      if(!(__startrek_start_t2[14] <= __startrek_start_t3[8])) {abort();}
      if(!(__startrek_end_t3[8] < __startrek_end_t2[14])) {abort();}
      if(!(__startrek_end_t3[7] < __startrek_start_t2[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[15] <= __startrek_end_t3[8]) {
    if (__startrek_start_t3[8] <= __startrek_end_t2[15]) {
      {
      if(!(__startrek_start_t2[15] <= __startrek_start_t3[8])) {abort();}
      if(!(__startrek_end_t3[8] < __startrek_end_t2[15])) {abort();}
      if(!(__startrek_end_t3[7] < __startrek_start_t2[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t3[9]) {
    if (__startrek_start_t3[9] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t3[9])) {abort();}
      if(!(__startrek_end_t3[9] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t3[7] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t3[9]) {
    if (__startrek_start_t3[9] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t3[9])) {abort();}
      if(!(__startrek_end_t3[9] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t3[7] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[12] <= __startrek_end_t3[9]) {
    if (__startrek_start_t3[9] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t3[9])) {abort();}
      if(!(__startrek_end_t3[9] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t3[8] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t3[9]) {
    if (__startrek_start_t3[9] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t3[9])) {abort();}
      if(!(__startrek_end_t3[9] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t3[8] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t3[9]) {
    if (__startrek_start_t3[9] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t3[9])) {abort();}
      if(!(__startrek_end_t3[9] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t3[8] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t3[9]) {
    if (__startrek_start_t3[9] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t3[9])) {abort();}
      if(!(__startrek_end_t3[9] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t3[8] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t2[12] <= __startrek_end_t3[9]) {
    if (__startrek_start_t3[9] <= __startrek_end_t2[12]) {
      {
      if(!(__startrek_start_t2[12] <= __startrek_start_t3[9])) {abort();}
      if(!(__startrek_end_t3[9] < __startrek_end_t2[12])) {abort();}
      if(!(__startrek_end_t3[8] < __startrek_start_t2[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[13] <= __startrek_end_t3[9]) {
    if (__startrek_start_t3[9] <= __startrek_end_t2[13]) {
      {
      if(!(__startrek_start_t2[13] <= __startrek_start_t3[9])) {abort();}
      if(!(__startrek_end_t3[9] < __startrek_end_t2[13])) {abort();}
      if(!(__startrek_end_t3[8] < __startrek_start_t2[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[14] <= __startrek_end_t3[9]) {
    if (__startrek_start_t3[9] <= __startrek_end_t2[14]) {
      {
      if(!(__startrek_start_t2[14] <= __startrek_start_t3[9])) {abort();}
      if(!(__startrek_end_t3[9] < __startrek_end_t2[14])) {abort();}
      if(!(__startrek_end_t3[8] < __startrek_start_t2[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[15] <= __startrek_end_t3[9]) {
    if (__startrek_start_t3[9] <= __startrek_end_t2[15]) {
      {
      if(!(__startrek_start_t2[15] <= __startrek_start_t3[9])) {abort();}
      if(!(__startrek_end_t3[9] < __startrek_end_t2[15])) {abort();}
      if(!(__startrek_end_t3[8] < __startrek_start_t2[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t3[10]) {
    if (__startrek_start_t3[10] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t3[10])) {abort();}
      if(!(__startrek_end_t3[10] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t3[8] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t3[10]) {
    if (__startrek_start_t3[10] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t3[10])) {abort();}
      if(!(__startrek_end_t3[10] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t3[8] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[12] <= __startrek_end_t3[10]) {
    if (__startrek_start_t3[10] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t3[10])) {abort();}
      if(!(__startrek_end_t3[10] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t3[9] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t3[10]) {
    if (__startrek_start_t3[10] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t3[10])) {abort();}
      if(!(__startrek_end_t3[10] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t3[9] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t3[10]) {
    if (__startrek_start_t3[10] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t3[10])) {abort();}
      if(!(__startrek_end_t3[10] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t3[9] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t3[10]) {
    if (__startrek_start_t3[10] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t3[10])) {abort();}
      if(!(__startrek_end_t3[10] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t3[9] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t2[12] <= __startrek_end_t3[10]) {
    if (__startrek_start_t3[10] <= __startrek_end_t2[12]) {
      {
      if(!(__startrek_start_t2[12] <= __startrek_start_t3[10])) {abort();}
      if(!(__startrek_end_t3[10] < __startrek_end_t2[12])) {abort();}
      if(!(__startrek_end_t3[9] < __startrek_start_t2[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[13] <= __startrek_end_t3[10]) {
    if (__startrek_start_t3[10] <= __startrek_end_t2[13]) {
      {
      if(!(__startrek_start_t2[13] <= __startrek_start_t3[10])) {abort();}
      if(!(__startrek_end_t3[10] < __startrek_end_t2[13])) {abort();}
      if(!(__startrek_end_t3[9] < __startrek_start_t2[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[14] <= __startrek_end_t3[10]) {
    if (__startrek_start_t3[10] <= __startrek_end_t2[14]) {
      {
      if(!(__startrek_start_t2[14] <= __startrek_start_t3[10])) {abort();}
      if(!(__startrek_end_t3[10] < __startrek_end_t2[14])) {abort();}
      if(!(__startrek_end_t3[9] < __startrek_start_t2[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[15] <= __startrek_end_t3[10]) {
    if (__startrek_start_t3[10] <= __startrek_end_t2[15]) {
      {
      if(!(__startrek_start_t2[15] <= __startrek_start_t3[10])) {abort();}
      if(!(__startrek_end_t3[10] < __startrek_end_t2[15])) {abort();}
      if(!(__startrek_end_t3[9] < __startrek_start_t2[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t0[6] <= __startrek_end_t3[11]) {
    if (__startrek_start_t3[11] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t3[11])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t3[9] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t3[11]) {
    if (__startrek_start_t3[11] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t3[11])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t3[9] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t1[12] <= __startrek_end_t3[11]) {
    if (__startrek_start_t3[11] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t3[11])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t3[10] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t3[11]) {
    if (__startrek_start_t3[11] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t3[11])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t3[10] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t3[11]) {
    if (__startrek_start_t3[11] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t3[11])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t3[10] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t3[11]) {
    if (__startrek_start_t3[11] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t3[11])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t3[10] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  ...
  if (__startrek_start_t2[12] <= __startrek_end_t3[11]) {
    if (__startrek_start_t3[11] <= __startrek_end_t2[12]) {
      {
      if(!(__startrek_start_t2[12] <= __startrek_start_t3[11])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_end_t2[12])) {abort();}
      if(!(__startrek_end_t3[10] < __startrek_start_t2[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[13] <= __startrek_end_t3[11]) {
    if (__startrek_start_t3[11] <= __startrek_end_t2[13]) {
      {
      if(!(__startrek_start_t2[13] <= __startrek_start_t3[11])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_end_t2[13])) {abort();}
      if(!(__startrek_end_t3[10] < __startrek_start_t2[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[14] <= __startrek_end_t3[11]) {
    if (__startrek_start_t3[11] <= __startrek_end_t2[14]) {
      {
      if(!(__startrek_start_t2[14] <= __startrek_start_t3[11])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_end_t2[14])) {abort();}
      if(!(__startrek_end_t3[10] < __startrek_start_t2[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[15] <= __startrek_end_t3[11]) {
    if (__startrek_start_t3[11] <= __startrek_end_t2[15]) {
      {
      if(!(__startrek_start_t2[15] <= __startrek_start_t3[11])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_end_t2[15])) {abort();}
      if(!(__startrek_end_t3[10] < __startrek_start_t2[15])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[0] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t0[0]) {
      {
      if(!(__startrek_start_t0[0] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t0[0])) {abort();}
      if(!(__startrek_end_t3[10] < __startrek_start_t0[0])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[1] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t0[1]) {
      {
      if(!(__startrek_start_t0[1] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t0[1])) {abort();}
      if(!(__startrek_end_t3[10] < __startrek_start_t0[1])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[2] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t0[2]) {
      {
      if(!(__startrek_start_t0[2] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t0[2])) {abort();}
      if(!(__startrek_end_t3[10] < __startrek_start_t0[2])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[3] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t0[3]) {
      {
      if(!(__startrek_start_t0[3] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t0[3])) {abort();}
      if(!(__startrek_end_t3[10] < __startrek_start_t0[3])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[4] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t0[4]) {
      {
      if(!(__startrek_start_t0[4] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t0[4])) {abort();}
      if(!(__startrek_end_t3[10] < __startrek_start_t0[4])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[5] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t0[5]) {
      {
      if(!(__startrek_start_t0[5] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t0[5])) {abort();}
      if(!(__startrek_end_t3[10] < __startrek_start_t0[5])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[6] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t3[10] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t3[10] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[0] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t1[0]) {
      {
      if(!(__startrek_start_t1[0] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t1[0])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t1[0])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[1] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t1[1]) {
      {
      if(!(__startrek_start_t1[1] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t1[1])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t1[1])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[2] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t1[2]) {
      {
      if(!(__startrek_start_t1[2] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t1[2])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t1[2])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[3] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t1[3]) {
      {
      if(!(__startrek_start_t1[3] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t1[3])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t1[3])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[4] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t1[4]) {
      {
      if(!(__startrek_start_t1[4] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t1[4])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t1[4])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[5] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t1[5]) {
      {
      if(!(__startrek_start_t1[5] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t1[5])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t1[5])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[6] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t1[6]) {
      {
      if(!(__startrek_start_t1[6] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t1[6])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t1[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[7] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t1[7]) {
      {
      if(!(__startrek_start_t1[7] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t1[7])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t1[7])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[8] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t1[8]) {
      {
      if(!(__startrek_start_t1[8] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t1[8])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t1[8])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[9] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t1[9]) {
      {
      if(!(__startrek_start_t1[9] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t1[9])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t1[9])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[10] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t1[10]) {
      {
      if(!(__startrek_start_t1[10] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t1[10])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t1[10])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[11] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t1[11]) {
      {
      if(!(__startrek_start_t1[11] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t1[11])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t1[11])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[12] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[0] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t2[0]) {
      {
      if(!(__startrek_start_t2[0] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t2[0])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t2[0])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[1] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t2[1]) {
      {
      if(!(__startrek_start_t2[1] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t2[1])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t2[1])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[2] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t2[2]) {
      {
      if(!(__startrek_start_t2[2] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t2[2])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t2[2])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[3] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t2[3]) {
      {
      if(!(__startrek_start_t2[3] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t2[3])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t2[3])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[4] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t2[4]) {
      {
      if(!(__startrek_start_t2[4] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t2[4])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t2[4])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[5] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t2[5]) {
      {
      if(!(__startrek_start_t2[5] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t2[5])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t2[5])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[6] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t2[6]) {
      {
      if(!(__startrek_start_t2[6] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t2[6])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t2[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[7] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t2[7]) {
      {
      if(!(__startrek_start_t2[7] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t2[7])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t2[7])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[8] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t2[8]) {
      {
      if(!(__startrek_start_t2[8] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t2[8])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t2[8])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[9] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t2[9]) {
      {
      if(!(__startrek_start_t2[9] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t2[9])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t2[9])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[10] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t2[10]) {
      {
      if(!(__startrek_start_t2[10] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t2[10])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t2[10])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[11] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t2[11]) {
      {
      if(!(__startrek_start_t2[11] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t2[11])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t2[11])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[12] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t2[12]) {
      {
      if(!(__startrek_start_t2[12] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t2[12])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t2[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[13] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t2[13]) {
      {
      if(!(__startrek_start_t2[13] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t2[13])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t2[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[14] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t2[14]) {
      {
      if(!(__startrek_start_t2[14] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t2[14])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t2[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[15] <= __startrek_end_t3[12]) {
    if (__startrek_start_t3[12] <= __startrek_end_t2[15]) {
      {
      if(!(__startrek_start_t2[15] <= __startrek_start_t3[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_end_t2[15])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t2[15])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[0] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t0[0]) {
      {
      if(!(__startrek_start_t0[0] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t0[0])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t0[0])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[1] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t0[1]) {
      {
      if(!(__startrek_start_t0[1] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t0[1])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t0[1])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[2] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t0[2]) {
      {
      if(!(__startrek_start_t0[2] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t0[2])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t0[2])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[3] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t0[3]) {
      {
      if(!(__startrek_start_t0[3] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t0[3])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t0[3])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[4] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t0[4]) {
      {
      if(!(__startrek_start_t0[4] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t0[4])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t0[4])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[5] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t0[5]) {
      {
      if(!(__startrek_start_t0[5] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t0[5])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t0[5])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[6] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t3[11] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[0] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t1[0]) {
      {
      if(!(__startrek_start_t1[0] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t1[0])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t1[0])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[1] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t1[1]) {
      {
      if(!(__startrek_start_t1[1] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t1[1])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t1[1])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[2] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t1[2]) {
      {
      if(!(__startrek_start_t1[2] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t1[2])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t1[2])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[3] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t1[3]) {
      {
      if(!(__startrek_start_t1[3] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t1[3])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t1[3])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[4] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t1[4]) {
      {
      if(!(__startrek_start_t1[4] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t1[4])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t1[4])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[5] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t1[5]) {
      {
      if(!(__startrek_start_t1[5] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t1[5])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t1[5])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[6] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t1[6]) {
      {
      if(!(__startrek_start_t1[6] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t1[6])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t1[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[7] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t1[7]) {
      {
      if(!(__startrek_start_t1[7] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t1[7])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t1[7])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[8] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t1[8]) {
      {
      if(!(__startrek_start_t1[8] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t1[8])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t1[8])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[9] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t1[9]) {
      {
      if(!(__startrek_start_t1[9] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t1[9])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t1[9])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[10] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t1[10]) {
      {
      if(!(__startrek_start_t1[10] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t1[10])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t1[10])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[11] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t1[11]) {
      {
      if(!(__startrek_start_t1[11] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t1[11])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t1[11])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[12] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[0] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t2[0]) {
      {
      if(!(__startrek_start_t2[0] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t2[0])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t2[0])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[1] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t2[1]) {
      {
      if(!(__startrek_start_t2[1] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t2[1])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t2[1])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[2] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t2[2]) {
      {
      if(!(__startrek_start_t2[2] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t2[2])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t2[2])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[3] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t2[3]) {
      {
      if(!(__startrek_start_t2[3] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t2[3])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t2[3])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[4] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t2[4]) {
      {
      if(!(__startrek_start_t2[4] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t2[4])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t2[4])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[5] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t2[5]) {
      {
      if(!(__startrek_start_t2[5] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t2[5])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t2[5])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[6] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t2[6]) {
      {
      if(!(__startrek_start_t2[6] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t2[6])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t2[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[7] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t2[7]) {
      {
      if(!(__startrek_start_t2[7] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t2[7])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t2[7])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[8] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t2[8]) {
      {
      if(!(__startrek_start_t2[8] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t2[8])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t2[8])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[9] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t2[9]) {
      {
      if(!(__startrek_start_t2[9] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t2[9])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t2[9])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[10] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t2[10]) {
      {
      if(!(__startrek_start_t2[10] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t2[10])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t2[10])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[11] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t2[11]) {
      {
      if(!(__startrek_start_t2[11] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t2[11])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t2[11])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[12] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t2[12]) {
      {
      if(!(__startrek_start_t2[12] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t2[12])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t2[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[13] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t2[13]) {
      {
      if(!(__startrek_start_t2[13] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t2[13])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t2[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[14] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t2[14]) {
      {
      if(!(__startrek_start_t2[14] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t2[14])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t2[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[15] <= __startrek_end_t3[13]) {
    if (__startrek_start_t3[13] <= __startrek_end_t2[15]) {
      {
      if(!(__startrek_start_t2[15] <= __startrek_start_t3[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_end_t2[15])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t2[15])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[0] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t0[0]) {
      {
      if(!(__startrek_start_t0[0] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t0[0])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t0[0])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[1] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t0[1]) {
      {
      if(!(__startrek_start_t0[1] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t0[1])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t0[1])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[2] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t0[2]) {
      {
      if(!(__startrek_start_t0[2] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t0[2])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t0[2])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[3] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t0[3]) {
      {
      if(!(__startrek_start_t0[3] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t0[3])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t0[3])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[4] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t0[4]) {
      {
      if(!(__startrek_start_t0[4] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t0[4])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t0[4])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[5] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t0[5]) {
      {
      if(!(__startrek_start_t0[5] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t0[5])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t0[5])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[6] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t3[12] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[0] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t1[0]) {
      {
      if(!(__startrek_start_t1[0] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t1[0])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t1[0])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[1] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t1[1]) {
      {
      if(!(__startrek_start_t1[1] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t1[1])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t1[1])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[2] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t1[2]) {
      {
      if(!(__startrek_start_t1[2] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t1[2])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t1[2])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[3] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t1[3]) {
      {
      if(!(__startrek_start_t1[3] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t1[3])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t1[3])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[4] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t1[4]) {
      {
      if(!(__startrek_start_t1[4] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t1[4])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t1[4])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[5] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t1[5]) {
      {
      if(!(__startrek_start_t1[5] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t1[5])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t1[5])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[6] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t1[6]) {
      {
      if(!(__startrek_start_t1[6] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t1[6])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t1[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[7] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t1[7]) {
      {
      if(!(__startrek_start_t1[7] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t1[7])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t1[7])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[8] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t1[8]) {
      {
      if(!(__startrek_start_t1[8] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t1[8])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t1[8])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[9] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t1[9]) {
      {
      if(!(__startrek_start_t1[9] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t1[9])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t1[9])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[10] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t1[10]) {
      {
      if(!(__startrek_start_t1[10] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t1[10])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t1[10])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[11] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t1[11]) {
      {
      if(!(__startrek_start_t1[11] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t1[11])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t1[11])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[12] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[0] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t2[0]) {
      {
      if(!(__startrek_start_t2[0] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t2[0])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t2[0])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[1] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t2[1]) {
      {
      if(!(__startrek_start_t2[1] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t2[1])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t2[1])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[2] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t2[2]) {
      {
      if(!(__startrek_start_t2[2] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t2[2])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t2[2])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[3] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t2[3]) {
      {
      if(!(__startrek_start_t2[3] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t2[3])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t2[3])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[4] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t2[4]) {
      {
      if(!(__startrek_start_t2[4] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t2[4])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t2[4])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[5] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t2[5]) {
      {
      if(!(__startrek_start_t2[5] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t2[5])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t2[5])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[6] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t2[6]) {
      {
      if(!(__startrek_start_t2[6] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t2[6])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t2[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[7] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t2[7]) {
      {
      if(!(__startrek_start_t2[7] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t2[7])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t2[7])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[8] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t2[8]) {
      {
      if(!(__startrek_start_t2[8] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t2[8])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t2[8])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[9] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t2[9]) {
      {
      if(!(__startrek_start_t2[9] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t2[9])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t2[9])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[10] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t2[10]) {
      {
      if(!(__startrek_start_t2[10] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t2[10])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t2[10])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[11] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t2[11]) {
      {
      if(!(__startrek_start_t2[11] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t2[11])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t2[11])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[12] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t2[12]) {
      {
      if(!(__startrek_start_t2[12] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t2[12])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t2[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[13] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t2[13]) {
      {
      if(!(__startrek_start_t2[13] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t2[13])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t2[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[14] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t2[14]) {
      {
      if(!(__startrek_start_t2[14] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t2[14])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t2[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[15] <= __startrek_end_t3[14]) {
    if (__startrek_start_t3[14] <= __startrek_end_t2[15]) {
      {
      if(!(__startrek_start_t2[15] <= __startrek_start_t3[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_end_t2[15])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t2[15])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[0] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t0[0]) {
      {
      if(!(__startrek_start_t0[0] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t0[0])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t0[0])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[1] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t0[1]) {
      {
      if(!(__startrek_start_t0[1] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t0[1])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t0[1])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[2] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t0[2]) {
      {
      if(!(__startrek_start_t0[2] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t0[2])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t0[2])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[3] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t0[3]) {
      {
      if(!(__startrek_start_t0[3] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t0[3])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t0[3])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[4] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t0[4]) {
      {
      if(!(__startrek_start_t0[4] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t0[4])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t0[4])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[5] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t0[5]) {
      {
      if(!(__startrek_start_t0[5] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t0[5])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t0[5])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[6] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t0[6]) {
      {
      if(!(__startrek_start_t0[6] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t0[6])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t0[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t0[7] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t0[7]) {
      {
      if(!(__startrek_start_t0[7] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t0[7])) {abort();}
      if(!(__startrek_end_t3[13] < __startrek_start_t0[7])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[0] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t1[0]) {
      {
      if(!(__startrek_start_t1[0] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t1[0])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t1[0])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[1] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t1[1]) {
      {
      if(!(__startrek_start_t1[1] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t1[1])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t1[1])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[2] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t1[2]) {
      {
      if(!(__startrek_start_t1[2] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t1[2])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t1[2])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[3] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t1[3]) {
      {
      if(!(__startrek_start_t1[3] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t1[3])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t1[3])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[4] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t1[4]) {
      {
      if(!(__startrek_start_t1[4] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t1[4])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t1[4])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[5] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t1[5]) {
      {
      if(!(__startrek_start_t1[5] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t1[5])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t1[5])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[6] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t1[6]) {
      {
      if(!(__startrek_start_t1[6] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t1[6])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t1[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[7] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t1[7]) {
      {
      if(!(__startrek_start_t1[7] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t1[7])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t1[7])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[8] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t1[8]) {
      {
      if(!(__startrek_start_t1[8] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t1[8])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t1[8])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[9] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t1[9]) {
      {
      if(!(__startrek_start_t1[9] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t1[9])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t1[9])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[10] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t1[10]) {
      {
      if(!(__startrek_start_t1[10] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t1[10])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t1[10])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[11] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t1[11]) {
      {
      if(!(__startrek_start_t1[11] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t1[11])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t1[11])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[12] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t1[12]) {
      {
      if(!(__startrek_start_t1[12] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t1[12])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t1[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[13] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t1[13]) {
      {
      if(!(__startrek_start_t1[13] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t1[13])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t1[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[14] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t1[14]) {
      {
      if(!(__startrek_start_t1[14] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t1[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t1[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t1[15] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t1[15]) {
      {
      if(!(__startrek_start_t1[15] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t1[15])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t1[15])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[0] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t2[0]) {
      {
      if(!(__startrek_start_t2[0] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t2[0])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t2[0])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[1] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t2[1]) {
      {
      if(!(__startrek_start_t2[1] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t2[1])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t2[1])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[2] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t2[2]) {
      {
      if(!(__startrek_start_t2[2] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t2[2])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t2[2])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[3] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t2[3]) {
      {
      if(!(__startrek_start_t2[3] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t2[3])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t2[3])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[4] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t2[4]) {
      {
      if(!(__startrek_start_t2[4] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t2[4])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t2[4])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[5] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t2[5]) {
      {
      if(!(__startrek_start_t2[5] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t2[5])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t2[5])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[6] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t2[6]) {
      {
      if(!(__startrek_start_t2[6] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t2[6])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t2[6])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[7] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t2[7]) {
      {
      if(!(__startrek_start_t2[7] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t2[7])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t2[7])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[8] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t2[8]) {
      {
      if(!(__startrek_start_t2[8] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t2[8])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t2[8])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[9] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t2[9]) {
      {
      if(!(__startrek_start_t2[9] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t2[9])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t2[9])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[10] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t2[10]) {
      {
      if(!(__startrek_start_t2[10] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t2[10])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t2[10])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[11] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t2[11]) {
      {
      if(!(__startrek_start_t2[11] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t2[11])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t2[11])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[12] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t2[12]) {
      {
      if(!(__startrek_start_t2[12] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t2[12])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t2[12])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[13] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t2[13]) {
      {
      if(!(__startrek_start_t2[13] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t2[13])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t2[13])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[14] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t2[14]) {
      {
      if(!(__startrek_start_t2[14] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t2[14])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t2[14])) {abort();}
      }
    }
  }
  if (__startrek_start_t2[15] <= __startrek_end_t3[15]) {
    if (__startrek_start_t3[15] <= __startrek_end_t2[15]) {
      {
      if(!(__startrek_start_t2[15] <= __startrek_start_t3[15])) {abort();}
      if(!(__startrek_end_t3[15] < __startrek_end_t2[15])) {abort();}
      if(!(__startrek_end_t3[14] < __startrek_start_t2[15])) {abort();}
      }
    }
  }
}
...
__inline static _Bool __startrek_cs_t0(void)
{
  ...
  if (__startrek_round != __startrek_job_end) {
    ...
    if (__startrek_start_t1[12] < __startrek_round) {
      if(!(__startrek_round > __startrek_end_t1[12])) {abort();}
    }
    if (__startrek_start_t1[13] < __startrek_round) {
      if(!(__startrek_round > __startrek_end_t1[13])) {abort();}
    }
    if (__startrek_start_t1[14] < __startrek_round) {
      if(!(__startrek_round > __startrek_end_t1[14])) {abort();}
    }
    if (__startrek_start_t1[15] < __startrek_round) {
      if(!(__startrek_round > __startrek_end_t1[15])) {abort();}
    }
    ...
    if (__startrek_start_t2[12] < __startrek_round) {
      if(!(__startrek_round > __startrek_end_t2[12])) {abort();}
    }
    if (__startrek_start_t2[13] < __startrek_round) {
      if(!(__startrek_round > __startrek_end_t2[13])) {abort();}
    }
    if (__startrek_start_t2[14] < __startrek_round) {
      if(!(__startrek_round > __startrek_end_t2[14])) {abort();}
    }
    if (__startrek_start_t2[15] < __startrek_round) {
      if(!(__startrek_round > __startrek_end_t2[15])) {abort();}
    }
    }
  }
  return (1);
...
__inline void __startrek_check_assumptions(void)
{
  ...
  {
  if(!(_i___startrek_job_count_Writer_[55] == ___startrek_job_count_Writer_[54])) {abort();}
  if(!(_i___startrek_job_count_Writer_[54] == ___startrek_job_count_Writer_[53])) {abort();}
  if(!(_i___startrek_job_count_Writer_[53] == ___startrek_job_count_Writer_[52])) {abort();}
  if(!(_i___startrek_job_count_Writer_[52] == ___startrek_job_count_Writer_[51])) {abort();}
  if(!(_i___startrek_job_count_Writer_[51] == ___startrek_job_count_Writer_[50])) {abort();}
  if(!(_i___startrek_job_count_Writer_[50] == ___startrek_job_count_Writer_[49])) {abort();}
  if(!(_i___startrek_job_count_Writer_[49] == ___startrek_job_count_Writer_[48])) {abort();}
  if(!(_i___startrek_job_count_Writer_[48] == ___startrek_job_count_Writer_[47])) {abort();}
  if(!(_i___startrek_job_count_Writer_[47] == ___startrek_job_count_Writer_[46])) {abort();}
  if(!(_i___startrek_job_count_Writer_[46] == ___startrek_job_count_Writer_[45])) {abort();}
  if(!(_i___startrek_job_count_Writer_[45] == ___startrek_job_count_Writer_[44])) {abort();}
  if(!(_i___startrek_job_count_Writer_[44] == ___startrek_job_count_Writer_[43])) {abort();}
  if(!(_i___startrek_job_count_Writer_[43] == ___startrek_job_count_Writer_[42])) {abort();}
  if(!(_i___startrek_job_count_Writer_[42] == ___startrek_job_count_Writer_[41])) {abort();}
  ...
  if(!(_i___startrek_job_count_Reader_[55] == ___startrek_job_count_Reader_[54])) {abort();}
  if(!(_i___startrek_job_count_Reader_[54] == ___startrek_job_count_Reader_[53])) {abort();}
  if(!(_i___startrek_job_count_Reader_[53] == ___startrek_job_count_Reader_[52])) {abort();}
  if(!(_i___startrek_job_count_Reader_[52] == ___startrek_job_count_Reader_[51])) {abort();}
  if(!(_i___startrek_job_count_Reader_[51] == ___startrek_job_count_Reader_[50])) {abort();}
  if(!(_i___startrek_job_count_Reader_[50] == ___startrek_job_count_Reader_[49])) {abort();}
  if(!(_i___startrek_job_count_Reader_[49] == ___startrek_job_count_Reader_[48])) {abort();}
  if(!(_i___startrek_job_count_Reader_[48] == ___startrek_job_count_Reader_[47])) {abort();}
  if(!(_i___startrek_job_count_Reader_[47] == ___startrek_job_count_Reader_[46])) {abort();}
  if(!(_i___startrek_job_count_Reader_[46] == ___startrek_job_count_Reader_[45])) {abort();}
  if(!(_i___startrek_job_count_Reader_[45] == ___startrek_job_count_Reader_[44])) {abort();}
  if(!(_i___startrek_job_count_Reader_[44] == ___startrek_job_count_Reader_[43])) {abort();}
  if(!(_i___startrek_job_count_Reader_[43] == ___startrek_job_count_Reader_[42])) {abort();}
  if(!(_i___startrek_job_count_Reader_[42] == ___startrek_job_count_Reader_[41])) {abort();}
  ...
  if(!(_i___startrek_job_count_TapeMover_[55] == ___startrek_job_count_TapeMover_[54])) {abort();}
  if(!(_i___startrek_job_count_TapeMover_[54] == ___startrek_job_count_TapeMover_[53])) {abort();}
  if(!(_i___startrek_job_count_TapeMover_[53] == ___startrek_job_count_TapeMover_[52])) {abort();}
  if(!(_i___startrek_job_count_TapeMover_[52] == ___startrek_job_count_TapeMover_[51])) {abort();}
  if(!(_i___startrek_job_count_TapeMover_[51] == ___startrek_job_count_TapeMover_[50])) {abort();}
  if(!(_i___startrek_job_count_TapeMover_[50] == ___startrek_job_count_TapeMover_[49])) {abort();}
  if(!(_i___startrek_job_count_TapeMover_[49] == ___startrek_job_count_TapeMover_[48])) {abort();}
  if(!(_i___startrek_job_count_TapeMover_[48] == ___startrek_job_count_TapeMover_[47])) {abort();}
  if(!(_i___startrek_job_count_TapeMover_[47] == ___startrek_job_count_TapeMover_[46])) {abort();}
  if(!(_i___startrek_job_count_TapeMover_[46] == ___startrek_job_count_TapeMover_[45])) {abort();}
  if(!(_i___startrek_job_count_TapeMover_[45] == ___startrek_job_count_TapeMover_[44])) {abort();}
  if(!(_i___startrek_job_count_TapeMover_[44] == ___startrek_job_count_TapeMover_[43])) {abort();}
  if(!(_i___startrek_job_count_TapeMover_[43] == ___startrek_job_count_TapeMover_[42])) {abort();}
  if(!(_i___startrek_job_count_TapeMover_[42] == ___startrek_job_count_TapeMover_[41])) {abort();}
  ...
  if(!(_i___startrek_job_count_Controller_[55] == ___startrek_job_count_Controller_[54])) {abort();}
  if(!(_i___startrek_job_count_Controller_[54] == ___startrek_job_count_Controller_[53])) {abort();}
  if(!(_i___startrek_job_count_Controller_[53] == ___startrek_job_count_Controller_[52])) {abort();}
  if(!(_i___startrek_job_count_Controller_[52] == ___startrek_job_count_Controller_[51])) {abort();}
  if(!(_i___startrek_job_count_Controller_[51] == ___startrek_job_count_Controller_[50])) {abort();}
  if(!(_i___startrek_job_count_Controller_[50] == ___startrek_job_count_Controller_[49])) {abort();}
  if(!(_i___startrek_job_count_Controller_[49] == ___startrek_job_count_Controller_[48])) {abort();}
  if(!(_i___startrek_job_count_Controller_[48] == ___startrek_job_count_Controller_[47])) {abort();}
  if(!(_i___startrek_job_count_Controller_[47] == ___startrek_job_count_Controller_[46])) {abort();}
  if(!(_i___startrek_job_count_Controller_[46] == ___startrek_job_count_Controller_[45])) {abort();}
  if(!(_i___startrek_job_count_Controller_[45] == ___startrek_job_count_Controller_[44])) {abort();}
  if(!(_i___startrek_job_count_Controller_[44] == ___startrek_job_count_Controller_[43])) {abort();}
  if(!(_i___startrek_job_count_Controller_[43] == ___startrek_job_count_Controller_[42])) {abort();}
  if(!(_i___startrek_job_count_Controller_[42] == ___startrek_job_count_Controller_[41])) {abort();}
  ...
  if(!(_i_T_state_[55] == _T_state_[54])) {abort();}
  if(!(_i_T_state_[54] == _T_state_[53])) {abort();}
  if(!(_i_T_state_[53] == _T_state_[52])) {abort();}
  if(!(_i_T_state_[52] == _T_state_[51])) {abort();}
  if(!(_i_T_state_[51] == _T_state_[50])) {abort();}
  if(!(_i_T_state_[50] == _T_state_[49])) {abort();}
  if(!(_i_T_state_[49] == _T_state_[48])) {abort();}
  if(!(_i_T_state_[48] == _T_state_[47])) {abort();}
  if(!(_i_T_state_[47] == _T_state_[46])) {abort();}
  if(!(_i_T_state_[46] == _T_state_[45])) {abort();}
  if(!(_i_T_state_[45] == _T_state_[44])) {abort();}
  if(!(_i_T_state_[44] == _T_state_[43])) {abort();}
  if(!(_i_T_state_[43] == _T_state_[42])) {abort();}
  if(!(_i_T_state_[42] == _T_state_[41])) {abort();}
  ...
  if(!(_i_W_state_[55] == _W_state_[54])) {abort();}
  if(!(_i_W_state_[54] == _W_state_[53])) {abort();}
  if(!(_i_W_state_[53] == _W_state_[52])) {abort();}
  if(!(_i_W_state_[52] == _W_state_[51])) {abort();}
  if(!(_i_W_state_[51] == _W_state_[50])) {abort();}
  if(!(_i_W_state_[50] == _W_state_[49])) {abort();}
  if(!(_i_W_state_[49] == _W_state_[48])) {abort();}
  if(!(_i_W_state_[48] == _W_state_[47])) {abort();}
  if(!(_i_W_state_[47] == _W_state_[46])) {abort();}
  if(!(_i_W_state_[46] == _W_state_[45])) {abort();}
  if(!(_i_W_state_[45] == _W_state_[44])) {abort();}
  if(!(_i_W_state_[44] == _W_state_[43])) {abort();}
  if(!(_i_W_state_[43] == _W_state_[42])) {abort();}
  if(!(_i_W_state_[42] == _W_state_[41])) {abort();}
  ...
  if(!(_i_R_state_[55] == _R_state_[54])) {abort();}
  if(!(_i_R_state_[54] == _R_state_[53])) {abort();}
  if(!(_i_R_state_[53] == _R_state_[52])) {abort();}
  if(!(_i_R_state_[52] == _R_state_[51])) {abort();}
  if(!(_i_R_state_[51] == _R_state_[50])) {abort();}
  if(!(_i_R_state_[50] == _R_state_[49])) {abort();}
  if(!(_i_R_state_[49] == _R_state_[48])) {abort();}
  if(!(_i_R_state_[48] == _R_state_[47])) {abort();}
  if(!(_i_R_state_[47] == _R_state_[46])) {abort();}
  if(!(_i_R_state_[46] == _R_state_[45])) {abort();}
  if(!(_i_R_state_[45] == _R_state_[44])) {abort();}
  if(!(_i_R_state_[44] == _R_state_[43])) {abort();}
  if(!(_i_R_state_[43] == _R_state_[42])) {abort();}
  if(!(_i_R_state_[42] == _R_state_[41])) {abort();}
  ...
  if(!(_i_threshold_[55] == _threshold_[54])) {abort();}
  if(!(_i_threshold_[54] == _threshold_[53])) {abort();}
  if(!(_i_threshold_[53] == _threshold_[52])) {abort();}
  if(!(_i_threshold_[52] == _threshold_[51])) {abort();}
  if(!(_i_threshold_[51] == _threshold_[50])) {abort();}
  if(!(_i_threshold_[50] == _threshold_[49])) {abort();}
  if(!(_i_threshold_[49] == _threshold_[48])) {abort();}
  if(!(_i_threshold_[48] == _threshold_[47])) {abort();}
  if(!(_i_threshold_[47] == _threshold_[46])) {abort();}
  if(!(_i_threshold_[46] == _threshold_[45])) {abort();}
  if(!(_i_threshold_[45] == _threshold_[44])) {abort();}
  if(!(_i_threshold_[44] == _threshold_[43])) {abort();}
  if(!(_i_threshold_[43] == _threshold_[42])) {abort();}
  if(!(_i_threshold_[42] == _threshold_[41])) {abort();}
  ...
  if(!(_i_need_to_run_nxtbg_[55] == _need_to_run_nxtbg_[54])) {abort();}
  if(!(_i_need_to_run_nxtbg_[54] == _need_to_run_nxtbg_[53])) {abort();}
  if(!(_i_need_to_run_nxtbg_[53] == _need_to_run_nxtbg_[52])) {abort();}
  if(!(_i_need_to_run_nxtbg_[52] == _need_to_run_nxtbg_[51])) {abort();}
  if(!(_i_need_to_run_nxtbg_[51] == _need_to_run_nxtbg_[50])) {abort();}
  if(!(_i_need_to_run_nxtbg_[50] == _need_to_run_nxtbg_[49])) {abort();}
  if(!(_i_need_to_run_nxtbg_[49] == _need_to_run_nxtbg_[48])) {abort();}
  if(!(_i_need_to_run_nxtbg_[48] == _need_to_run_nxtbg_[47])) {abort();}
  if(!(_i_need_to_run_nxtbg_[47] == _need_to_run_nxtbg_[46])) {abort();}
  if(!(_i_need_to_run_nxtbg_[46] == _need_to_run_nxtbg_[45])) {abort();}
  if(!(_i_need_to_run_nxtbg_[45] == _need_to_run_nxtbg_[44])) {abort();}
  if(!(_i_need_to_run_nxtbg_[44] == _need_to_run_nxtbg_[43])) {abort();}
  if(!(_i_need_to_run_nxtbg_[43] == _need_to_run_nxtbg_[42])) {abort();}
  if(!(_i_need_to_run_nxtbg_[42] == _need_to_run_nxtbg_[41])) {abort();}
  ...
  if(!(_i_need_to_read_[55] == _need_to_read_[54])) {abort();}
  if(!(_i_need_to_read_[54] == _need_to_read_[53])) {abort();}
  if(!(_i_need_to_read_[53] == _need_to_read_[52])) {abort();}
  if(!(_i_need_to_read_[52] == _need_to_read_[51])) {abort();}
  if(!(_i_need_to_read_[51] == _need_to_read_[50])) {abort();}
  if(!(_i_need_to_read_[50] == _need_to_read_[49])) {abort();}
  if(!(_i_need_to_read_[49] == _need_to_read_[48])) {abort();}
  if(!(_i_need_to_read_[48] == _need_to_read_[47])) {abort();}
  if(!(_i_need_to_read_[47] == _need_to_read_[46])) {abort();}
  if(!(_i_need_to_read_[46] == _need_to_read_[45])) {abort();}
  if(!(_i_need_to_read_[45] == _need_to_read_[44])) {abort();}
  if(!(_i_need_to_read_[44] == _need_to_read_[43])) {abort();}
  if(!(_i_need_to_read_[43] == _need_to_read_[42])) {abort();}
  if(!(_i_need_to_read_[42] == _need_to_read_[41])) {abort();}
  ...
  if(!(_i_dir_[55] == _dir_[54])) {abort();}
  if(!(_i_dir_[54] == _dir_[53])) {abort();}
  if(!(_i_dir_[53] == _dir_[52])) {abort();}
  if(!(_i_dir_[52] == _dir_[51])) {abort();}
  if(!(_i_dir_[51] == _dir_[50])) {abort();}
  if(!(_i_dir_[50] == _dir_[49])) {abort();}
  if(!(_i_dir_[49] == _dir_[48])) {abort();}
  if(!(_i_dir_[48] == _dir_[47])) {abort();}
  if(!(_i_dir_[47] == _dir_[46])) {abort();}
  if(!(_i_dir_[46] == _dir_[45])) {abort();}
  if(!(_i_dir_[45] == _dir_[44])) {abort();}
  if(!(_i_dir_[44] == _dir_[43])) {abort();}
  if(!(_i_dir_[43] == _dir_[42])) {abort();}
  if(!(_i_dir_[42] == _dir_[41])) {abort();}
  ...
  if(!(_i_output_[55] == _output_[54])) {abort();}
  if(!(_i_output_[54] == _output_[53])) {abort();}
  if(!(_i_output_[53] == _output_[52])) {abort();}
  if(!(_i_output_[52] == _output_[51])) {abort();}
  if(!(_i_output_[51] == _output_[50])) {abort();}
  if(!(_i_output_[50] == _output_[49])) {abort();}
  if(!(_i_output_[49] == _output_[48])) {abort();}
  if(!(_i_output_[48] == _output_[47])) {abort();}
  if(!(_i_output_[47] == _output_[46])) {abort();}
  if(!(_i_output_[46] == _output_[45])) {abort();}
  if(!(_i_output_[45] == _output_[44])) {abort();}
  if(!(_i_output_[44] == _output_[43])) {abort();}
  if(!(_i_output_[43] == _output_[42])) {abort();}
  if(!(_i_output_[42] == _output_[41])) {abort();}
  ...
  if(!(_i_input_[55] == _input_[54])) {abort();}
  if(!(_i_input_[54] == _input_[53])) {abort();}
  if(!(_i_input_[53] == _input_[52])) {abort();}
  if(!(_i_input_[52] == _input_[51])) {abort();}
  if(!(_i_input_[51] == _input_[50])) {abort();}
  if(!(_i_input_[50] == _input_[49])) {abort();}
  if(!(_i_input_[49] == _input_[48])) {abort();}
  if(!(_i_input_[48] == _input_[47])) {abort();}
  if(!(_i_input_[47] == _input_[46])) {abort();}
  if(!(_i_input_[46] == _input_[45])) {abort();}
  if(!(_i_input_[45] == _input_[44])) {abort();}
  if(!(_i_input_[44] == _input_[43])) {abort();}
  if(!(_i_input_[43] == _input_[42])) {abort();}
  if(!(_i_input_[42] == _input_[41])) {abort();}
  ...
  if(!(_i_nxtcolorsensor_mode_[55] == _nxtcolorsensor_mode_[54])) {abort();}
  if(!(_i_nxtcolorsensor_mode_[54] == _nxtcolorsensor_mode_[53])) {abort();}
  if(!(_i_nxtcolorsensor_mode_[53] == _nxtcolorsensor_mode_[52])) {abort();}
  if(!(_i_nxtcolorsensor_mode_[52] == _nxtcolorsensor_mode_[51])) {abort();}
  if(!(_i_nxtcolorsensor_mode_[51] == _nxtcolorsensor_mode_[50])) {abort();}
  if(!(_i_nxtcolorsensor_mode_[50] == _nxtcolorsensor_mode_[49])) {abort();}
  if(!(_i_nxtcolorsensor_mode_[49] == _nxtcolorsensor_mode_[48])) {abort();}
  if(!(_i_nxtcolorsensor_mode_[48] == _nxtcolorsensor_mode_[47])) {abort();}
  if(!(_i_nxtcolorsensor_mode_[47] == _nxtcolorsensor_mode_[46])) {abort();}
  if(!(_i_nxtcolorsensor_mode_[46] == _nxtcolorsensor_mode_[45])) {abort();}
  if(!(_i_nxtcolorsensor_mode_[45] == _nxtcolorsensor_mode_[44])) {abort();}
  if(!(_i_nxtcolorsensor_mode_[44] == _nxtcolorsensor_mode_[43])) {abort();}
  if(!(_i_nxtcolorsensor_mode_[43] == _nxtcolorsensor_mode_[42])) {abort();}
  if(!(_i_nxtcolorsensor_mode_[42] == _nxtcolorsensor_mode_[41])) {abort();}
  ...
  if(!(_i_nxtcolorsensor_data_mode_[55] == _nxtcolorsensor_data_mode_[54])) {abort();}
  if(!(_i_nxtcolorsensor_data_mode_[54] == _nxtcolorsensor_data_mode_[53])) {abort();}
  if(!(_i_nxtcolorsensor_data_mode_[53] == _nxtcolorsensor_data_mode_[52])) {abort();}
  if(!(_i_nxtcolorsensor_data_mode_[52] == _nxtcolorsensor_data_mode_[51])) {abort();}
  if(!(_i_nxtcolorsensor_data_mode_[51] == _nxtcolorsensor_data_mode_[50])) {abort();}
  if(!(_i_nxtcolorsensor_data_mode_[50] == _nxtcolorsensor_data_mode_[49])) {abort();}
  if(!(_i_nxtcolorsensor_data_mode_[49] == _nxtcolorsensor_data_mode_[48])) {abort();}
  if(!(_i_nxtcolorsensor_data_mode_[48] == _nxtcolorsensor_data_mode_[47])) {abort();}
  if(!(_i_nxtcolorsensor_data_mode_[47] == _nxtcolorsensor_data_mode_[46])) {abort();}
  if(!(_i_nxtcolorsensor_data_mode_[46] == _nxtcolorsensor_data_mode_[45])) {abort();}
  if(!(_i_nxtcolorsensor_data_mode_[45] == _nxtcolorsensor_data_mode_[44])) {abort();}
  if(!(_i_nxtcolorsensor_data_mode_[44] == _nxtcolorsensor_data_mode_[43])) {abort();}
  if(!(_i_nxtcolorsensor_data_mode_[43] == _nxtcolorsensor_data_mode_[42])) {abort();}
  if(!(_i_nxtcolorsensor_data_mode_[42] == _nxtcolorsensor_data_mode_[41])) {abort();}
  ...
  if(!(_i_T_speed_[55] == _T_speed_[54])) {abort();}
  if(!(_i_T_speed_[54] == _T_speed_[53])) {abort();}
  if(!(_i_T_speed_[53] == _T_speed_[52])) {abort();}
  if(!(_i_T_speed_[52] == _T_speed_[51])) {abort();}
  if(!(_i_T_speed_[51] == _T_speed_[50])) {abort();}
  if(!(_i_T_speed_[50] == _T_speed_[49])) {abort();}
  if(!(_i_T_speed_[49] == _T_speed_[48])) {abort();}
  if(!(_i_T_speed_[48] == _T_speed_[47])) {abort();}
  if(!(_i_T_speed_[47] == _T_speed_[46])) {abort();}
  if(!(_i_T_speed_[46] == _T_speed_[45])) {abort();}
  if(!(_i_T_speed_[45] == _T_speed_[44])) {abort();}
  if(!(_i_T_speed_[44] == _T_speed_[43])) {abort();}
  if(!(_i_T_speed_[43] == _T_speed_[42])) {abort();}
  if(!(_i_T_speed_[42] == _T_speed_[41])) {abort();}
  ...
  if(!(_i_T_count_[55] == _T_count_[54])) {abort();}
  if(!(_i_T_count_[54] == _T_count_[53])) {abort();}
  if(!(_i_T_count_[53] == _T_count_[52])) {abort();}
  if(!(_i_T_count_[52] == _T_count_[51])) {abort();}
  if(!(_i_T_count_[51] == _T_count_[50])) {abort();}
  if(!(_i_T_count_[50] == _T_count_[49])) {abort();}
  if(!(_i_T_count_[49] == _T_count_[48])) {abort();}
  if(!(_i_T_count_[48] == _T_count_[47])) {abort();}
  if(!(_i_T_count_[47] == _T_count_[46])) {abort();}
  if(!(_i_T_count_[46] == _T_count_[45])) {abort();}
  if(!(_i_T_count_[45] == _T_count_[44])) {abort();}
  if(!(_i_T_count_[44] == _T_count_[43])) {abort();}
  if(!(_i_T_count_[43] == _T_count_[42])) {abort();}
  if(!(_i_T_count_[42] == _T_count_[41])) {abort();}
  ...
  if(!(_i_W_speed_[55] == _W_speed_[54])) {abort();}
  if(!(_i_W_speed_[54] == _W_speed_[53])) {abort();}
  if(!(_i_W_speed_[53] == _W_speed_[52])) {abort();}
  if(!(_i_W_speed_[52] == _W_speed_[51])) {abort();}
  if(!(_i_W_speed_[51] == _W_speed_[50])) {abort();}
  if(!(_i_W_speed_[50] == _W_speed_[49])) {abort();}
  if(!(_i_W_speed_[49] == _W_speed_[48])) {abort();}
  if(!(_i_W_speed_[48] == _W_speed_[47])) {abort();}
  if(!(_i_W_speed_[47] == _W_speed_[46])) {abort();}
  if(!(_i_W_speed_[46] == _W_speed_[45])) {abort();}
  if(!(_i_W_speed_[45] == _W_speed_[44])) {abort();}
  if(!(_i_W_speed_[44] == _W_speed_[43])) {abort();}
  if(!(_i_W_speed_[43] == _W_speed_[42])) {abort();}
  if(!(_i_W_speed_[42] == _W_speed_[41])) {abort();}
  ...
  if(!(_i_W_count_[55] == _W_count_[54])) {abort();}
  if(!(_i_W_count_[54] == _W_count_[53])) {abort();}
  if(!(_i_W_count_[53] == _W_count_[52])) {abort();}
  if(!(_i_W_count_[52] == _W_count_[51])) {abort();}
  if(!(_i_W_count_[51] == _W_count_[50])) {abort();}
  if(!(_i_W_count_[50] == _W_count_[49])) {abort();}
  if(!(_i_W_count_[49] == _W_count_[48])) {abort();}
  if(!(_i_W_count_[48] == _W_count_[47])) {abort();}
  if(!(_i_W_count_[47] == _W_count_[46])) {abort();}
  if(!(_i_W_count_[46] == _W_count_[45])) {abort();}
  if(!(_i_W_count_[45] == _W_count_[44])) {abort();}
  if(!(_i_W_count_[44] == _W_count_[43])) {abort();}
  if(!(_i_W_count_[43] == _W_count_[42])) {abort();}
  if(!(_i_W_count_[42] == _W_count_[41])) {abort();}
  ...
  if(!(_i_R_speed_[55] == _R_speed_[54])) {abort();}
  if(!(_i_R_speed_[54] == _R_speed_[53])) {abort();}
  if(!(_i_R_speed_[53] == _R_speed_[52])) {abort();}
  if(!(_i_R_speed_[52] == _R_speed_[51])) {abort();}
  if(!(_i_R_speed_[51] == _R_speed_[50])) {abort();}
  if(!(_i_R_speed_[50] == _R_speed_[49])) {abort();}
  if(!(_i_R_speed_[49] == _R_speed_[48])) {abort();}
  if(!(_i_R_speed_[48] == _R_speed_[47])) {abort();}
  if(!(_i_R_speed_[47] == _R_speed_[46])) {abort();}
  if(!(_i_R_speed_[46] == _R_speed_[45])) {abort();}
  if(!(_i_R_speed_[45] == _R_speed_[44])) {abort();}
  if(!(_i_R_speed_[44] == _R_speed_[43])) {abort();}
  if(!(_i_R_speed_[43] == _R_speed_[42])) {abort();}
  if(!(_i_R_speed_[42] == _R_speed_[41])) {abort();}
  ...
  if(!(_i_R_count_[55] == _R_count_[54])) {abort();}
  if(!(_i_R_count_[54] == _R_count_[53])) {abort();}
  if(!(_i_R_count_[53] == _R_count_[52])) {abort();}
  if(!(_i_R_count_[52] == _R_count_[51])) {abort();}
  if(!(_i_R_count_[51] == _R_count_[50])) {abort();}
  if(!(_i_R_count_[50] == _R_count_[49])) {abort();}
  if(!(_i_R_count_[49] == _R_count_[48])) {abort();}
  if(!(_i_R_count_[48] == _R_count_[47])) {abort();}
  if(!(_i_R_count_[47] == _R_count_[46])) {abort();}
  if(!(_i_R_count_[46] == _R_count_[45])) {abort();}
  if(!(_i_R_count_[45] == _R_count_[44])) {abort();}
  if(!(_i_R_count_[44] == _R_count_[43])) {abort();}
  if(!(_i_R_count_[43] == _R_count_[42])) {abort();}
  if(!(_i_R_count_[42] == _R_count_[41])) {abort();}
