# 0 "c/term/seq-mthreaded-safe//rekcba_ctm.2-1.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "c/term/seq-mthreaded-safe//rekcba_ctm.2-1.c"
extern void abort(void);
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "rekcba_ctm.2-1.c", 3, "reach_error"); }
# 16 "c/term/seq-mthreaded-safe//rekcba_ctm.2-1.c"
