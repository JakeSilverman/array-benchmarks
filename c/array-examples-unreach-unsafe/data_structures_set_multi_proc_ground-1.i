...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "data_structures_set_multi_proc_ground-1.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
